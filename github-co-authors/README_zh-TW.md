...
<div align="right">
    <h6>
        ...
        <a href="https://github.com/ChinaGodMan/UserScripts/blob/main/github-co-authors/README.md">简体中文</a> |
        <a href="https://github.com/ChinaGodMan/UserScripts/blob/main/github-co-authors/README_en.md">English</a> |
        <a href="https://github.com/ChinaGodMan/UserScripts/blob/main/github-co-authors/README_ko.md">한국어</a> |
        <a href="https://github.com/ChinaGodMan/UserScripts/blob/main/github-co-authors/README_vi.md">Tiếng Việt</a> |
        <a href="https://github.com/ChinaGodMan/UserScripts/blob/main/github-co-authors/README_zh-TW.md">繁體中文</a>
    <br>
...
<center><div align="center">
    <h1>GitHub 共同協作者</h1>
    <p>「 在 GitHub PR中添加一個按鈕,以便在合併之前將所有 PR 參與者添加為共同作者. 」</p>
    ...
    <img src="https://img.shields.io/greasyfork/dt/537446?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=%E7%94%A8%E6%88%B6%E6%95%B8%E9%87%8F">
    <img src="https://img.shields.io/badge/dynamic/json?&label=%E6%AF%8F%E6%97%A5%E6%AA%A2%E6%9F%A5%E6%9B%B4%E6%96%B0%E6%AC%A1%E6%95%B8&query=$.537446&logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&url=https://github.com/ChinaGodMan/UserScriptsHistory/raw/main/daily_update_checks.json">
    <p>Download:<a href="https://github.com/ChinaGodMan/UserScripts/tree/main/github-co-authors">Github</a> | ⭐<a
            ...
            Fork</a></p>
    <img src="https://raw.githubusercontent.com/ChinaGodMan/UserScriptsHistory/main/stats/537446.png">
</div></center>
...
此腳本的功能是為 GitHub 的 Pull Request（PR）頁面添加一個按鈕，用於快速將 PR 的參與者添加為 co-author，從而簡化協作流程。  
修改了原始腳本,讓其能夠支持`TOKEN`訪問用於避免`API`訪問頻率限制

### 功能說明

1. **首次運行初始化**  
   當腳本首次運行時，會提示用戶輸入 GitHub 的 Token。Token 將被安全地存儲，用於後續調用 GitHub API。

2. **動態頁面加載支持**  
   腳本會監聽 GitHub 頁面上的導航事件（`turbo:render`），以確保在頁面切換時按鈕仍然可用。

3. **使用者介面**  
   在 PR 頁面中添加一個按鈕 "Add co-authors" 和狀態提示框，用戶可以通過該按鈕一鍵添加 co-author 資訊。

4. **自動獲取參與者**
    - 腳本會從當前 PR 的以下來源中提取參與者：
        - PR 評論
        - Review 評論
        - 審核記錄
    - 對每位參與者生成 `Co-authored-by` 格式的消息。

### 用法

1. 安裝腳本
2. 打開 GitHub PR 頁面。
3. 點擊腳本自動生成的 "Add co-authors" 按鈕。
4. 腳本會自動將參與者的 `Co-authored-by` 信息添加到提交消息中。
