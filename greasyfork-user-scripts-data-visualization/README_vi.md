...
<center><div align="center">
    ...
    <p>「 sử dụngChart.jsNhận và trực quan hóa dữ liệu tập lệnh người dùng，Và tạo biểu đồ trên trang chủ cá nhân của người dùng để hiển thị trạng thái cài đặt chi tiết bên dưới 」</p>
    ...
    <p>Download:<a href="https://github.com/ChinaGodMan/UserScripts/tree/main/greasyfork-user-scripts-data-visualization">Github</a> | ⭐<a
            ...
            Fork</a></p><details><summary>Cập nhật hồ sơ</summary><h1><strong>🛠️ GrreasyFork Trực quan hóa dữ liệu tập lệnh người dùng Cập nhật nhật ký</strong></h1>
