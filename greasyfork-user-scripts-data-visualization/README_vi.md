...
3. **Tải từ mạng hoặc từ trang hiện tại**: Tập lệnh cung cấp một cài đặt ở đầu mã,当vì`true`giờ,Nhận từ trang hiện tại,为`false`,Đối với GreasyFrok Tải xuống dữ liệu người dùng`JSON`
