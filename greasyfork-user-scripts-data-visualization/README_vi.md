...
<!--HISTORY-->
<center><div align="center">
    <h1>GreasyFork Trực quan hóa dữ liệu tập lệnh do người dùng xuất bản</h1>
    <p>「 sử dụngChart.jsLấy và hiển thị dữ liệu tập lệnh người dùng，Và tạo biểu đồ trên trang chủ cá nhân của người dùng để hiển thị trạng thái cài đặt chi tiết bên dưới. 」</p>
    ...
    <img src="https://img.shields.io/greasyfork/dt/508968?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=S%E1%BB%91%20l%C6%B0%E1%BB%A3ng%20ng%C6%B0%E1%BB%9Di%20d%C3%B9ng">
    <img src="https://img.shields.io/badge/dynamic/json?&label=C%E1%BA%ADp%20nh%E1%BA%ADt%20ki%E1%BB%83m%20tra%20h%C3%A0ng%20ng%C3%A0y&query=$.508968&logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&url=https://github.com/ChinaGodMan/UserScriptsHistory/raw/main/daily_update_checks.json">
    <p>Download:<a href="https://github.com/ChinaGodMan/UserScripts/tree/main/greasyfork-user-scripts-data-visualization">Github</a> | ⭐<a
            ...
            Fork</a></p><details><summary style="color:#FFD700">Cập nhật hồ sơ</summary><div align="right"><a href="https://github.com/ChinaGodMan/UserScripts/tree/main/greasyfork-user-scripts-data-visualization/CHANGELOG.md"><img src="https://img.shields.io/badge/-GitHub-3A3A3A?style=flat&logo=GitHub&logoColor=white"></a></div><h1><strong>🛠️ GrreasyFork Trực quan hóa dữ liệu tập lệnh người dùng Cập nhật nhật ký</strong></h1>
<h3><strong>📅 2024-09-20 07:46- Ver 1.1.1.1</strong></h3>
<p><strong>Mới</strong>: •Thêm một số chức năng nhỏ để sử dụng.<code>Bảng hiển thị ngày sáng tạo và cập nhật</code> <code>YGiá trị trục được tô sáng</code> <code>Nhấp vào biểu đồ thanh để nhảy vào tập lệnh tương ứng</code> Trong kịch bản<code>OPENLINK</code> vì<code>0</code>Đừng nhảy,<code>1</code>Có những lời khuyên trước khi nhảy,<code>2</code>Nhảy trực tiếp</p>
<table>
<thead>
<tr>
<th>Mới</th>
<th>Đã thêm một bản demo</th>
</tr>
</thead>
<tbody>
<tr>
...
<td><img alt="Nhảy.gif" src="https://s2.loli.net/2024/09/20/n1H26dzVfuBx7bN.gif" /></td>
</tr>
</tbody>
</table>
<hr />
<h3><strong>📅 2024-09-19 12:56:19- Ver 1.1.1.0</strong></h3>
<p><strong>Ôn lại</strong>: •Ôn lại<code>chart.js</code>Cho tải đầu tiên,Lưu nó sau khi tải<code>localStorage</code>Không cần tải lặp đi lặp lại</p>
<hr />
<h3><strong>📅 2024-09-19 08:25:19- Ver 1.1.0.0</strong></h3>
<p><strong>Sửa chữa</strong>: • Khắc phục một số vấn đề với biểu đồ.<br></p>
<table>
<thead>
<tr>
<th>Trước khi sửa đổi</th>
<th>Sau khi sửa đổi</th>
</tr>
</thead>
<tbody>
<tr>
...
<tr>
<td><img alt="Trước khi sửa đổi.png" src="https://s2.loli.net/2024/09/19/A6KoYdv5nbRkMCF.png" /></td>
<td><img alt="Sau khi sửa đổi.png" src="https://s2.loli.net/2024/09/19/2UCM18tuWXirgxB.png" /></td>
</tr>
<tr>
<td><img alt="Trước khi sửa đổi.gif" src="https://s2.loli.net/2024/09/19/khLXwEFQI58qjdZ.gif" /></td>
<td><img alt="Sau khi sửa đổi.gif" src="https://s2.loli.net/2024/09/19/azlGiIBEg2SAFPc.gif" /></td>
</tr>
</tbody>
</table>
<hr />
<h3><strong>📅 2024-09-18 11:01:32- Ver 1.0.0.0</strong></h3>
<p><strong>Tăng</strong>: •Đã thêm tác giả gốc<a href="https://greasyfork.org/zh-CN/users/1177387">138 Aspen</a>Kịch bản bổ sung<a href="https://greasyfork.org/zh-CN/scripts/482623">Displays the number of scripts published by the user, the total number of installations</a>Nhận dữ liệu người dùng từ trang web hiện tại,Bạn có thể đặt nó trong tập lệnh hoặc trong menu tập lệnhJSONDữ liệu thu thập dữ liệu hoặc dữ liệu tập lệnh từ mặc định trang hiện tại đếnGreasyFrokTải xuống dữ liệu người dùng<br>
<strong>Ôn lại</strong>: •~~Ôn lại<code>chart.js</code>vì@require trọng tải,Không cần tải lặp đi lặp lại~~GreasyforkKhông được phép các tập lệnh bên ngoài trái phép không được phép<br>
<strong>Ôn lại</strong>: •Sửa đổi khi lấy dữ liệu người dùng từ mạng,Sắp xếp từ cao đến thấp theo tổng khối lượng cài đặt<br>
<strong>Ôn lại</strong>: •Sửa đổi để tìm người dùngIDBiểu thức là<code>/(\d+)/</code>,tương thích<a href="https://greasyfork.org/zh-CN/scripts/497346">Greasyfork Dán nhà sản xuất giàn khoan</a><code>Liên kết rõ ràng chức năng ký tự vô dụng</code><br></p>
<hr /></details>
...
# GrreasyFork Trực quan hóa dữ liệu tập lệnh người dùng

<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">

## mô tả

Tập lệnh người dùng này sử dụng Chart.js Thư viện từ GreasyFork Trích xuất và trực quan hóa dữ liệu tập lệnh từ trang tập lệnh người dùng。Nó cung cấp các chức năng sau：

-   **Khai thác dữ liệu**: Trích xuất dữ liệu cài đặt từ trang tập lệnh của người dùng，Bao gồm tổng thời gian cài đặt và thời gian cài đặt hàng ngày。
-   **Trực quan hóa dữ liệu**: Sử dụng biểu đồ（Biểu đồ thanh）Hiển thị tổng số cài đặt và cài đặt hàng ngày cho mỗi tập lệnh。
-   **Hiển thị dữ liệu**: Hiển thị tổng số cài đặt bên dưới biểu đồ、Tổng số cài đặt hàng ngày và số lượng các tập lệnh được xuất bản。

<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">

## Chức năng

1. **Nhận dữ liệu người dùng**: Trích xuất dữ liệu liên quan từ trang tập lệnh người dùng。
2. **Trực quan hóa dữ liệu**: sử dụng Chart.js Vẽ biểu đồ để hiển thị dữ liệu cài đặt của tập lệnh。
3. **Hiển thị số liệu thống kê**: Hiển thị tổng số cài đặt hàng ngày bên dưới biểu đồ、Tổng số cài đặt và số lượng các tập lệnh được xuất bản。

<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">

## Cài đặt

1. **Cài đặt Greasemonkey hoặc Tampermonkey Plugin**: Vui lòng đảm bảo trình duyệt của bạn được cài đặt Greasemonkey hoặc Tampermonkey Plugin。
2. **Thêm tập lệnh**:
    - Nhấp vào nút cài đặt màu xanh lá cây ở trên để cài đặt

<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">

## sử dụng

1. **truy cập GreasyFork Trang tập lệnh người dùng**: Mở bất kỳ trang tập lệnh nào của người dùng，Ví dụ [https://greasyfork.org/users/1169082](https://greasyfork.org/users/1169082)。
2. **Xem biểu đồ và số liệu thống kê**: Tập lệnh sẽ tự động tạo và hiển thị biểu đồ và số liệu thống kê dữ liệu sau khi trang cá nhân của người dùng được tải.。
3. **Tải từ mạng hoặc từ trang hiện tại**: Tập lệnh cung cấp một cài đặt ở đầu mã,khivì`true`giờ,Nhận từ trang hiện tại,vì`false`,Đối với GreasyFrok Tải xuống dữ liệu người dùng`JSON`

<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">

## ủng hộ

Nếu bạn gặp sự cố hoặc cần hỗ trợ，Vui lòng truy cập [GitHub Trang câu hỏi](https://github.com/ChinaGodMan/UserScripts/issues) Gửi một câu hỏi。

## đóng góp

Tập lệnh này được sửa đổi từ[138 Aspen](https://greasyfork.org/zh-CN/users/1177387)Các kịch bản được xuất bản[GrreasyFork User Script Data Visualization](https://greasyfork.org/zh-CN/scripts/499755)
Hướng dẫn sửa đổi:<br>
**Tăng**: •Đã thêm tác giả gốc[138 Aspen](https://greasyfork.org/zh-CN/users/1177387)Kịch bản bổ sung[Displays the number of scripts published by the user, the total number of installations](https://greasyfork.org/zh-CN/scripts/482623)Nhận dữ liệu người dùng từ trang web hiện tại,Bạn có thể đặt nó trong tập lệnh hoặc trong menu tập lệnh JSON Thu thập dữ liệu hoặc dữ liệu tập lệnh từ trang hiện tại<br>
**Ôn lại**: •~~Ôn lại`chart.js`vì@require trọng tải,Không cần tải lặp đi lặp lại~~Greasyfork Không được phép các tập lệnh bên ngoài trái phép không được phép.....<br>
**Ôn lại**: •Sửa đổi khi lấy dữ liệu người dùng từ mạng,Sắp xếp từ cao đến thấp theo tổng khối lượng cài đặt<br>
**Ôn lại**: •Sửa đổi để tìm người dùng ID Biểu thức là`/(\d+)/`,tương thích[Greasyfork Dán nhà sản xuất giàn khoan](https://greasyfork.org/zh-CN/scripts/497346)`Liên kết rõ ràng chức năng ký tự vô dụng`<br>

Chào mừng bạn đến để đóng góp và cải thiện kịch bản！Vui lòng truy cập [GitHub Nhà kho](https://github.com/ChinaGodMan/UserScripts) Gửi yêu cầu kéo hoặc báo cáo một vấn đề。

## Ủy quyền

Kịch bản này theo sau MIT giấy phép。Để biết thêm thông tin，Vui lòng kiểm tra [LICENSE](https://github.com/ChinaGodMan/UserScripts/blob/main/LICENSE) tài liệu。

**Đã sửa lỗi số liệu thống kê cài đặt hàng ngày ở bên phải,Chuyển tổng số cài đặt/Các vấn đề với màn hình hiển thị trục biểu đồ trong quá trình cài đặt hàng ngày**

| Trước khi sửa đổi                                                            | Sau khi sửa đổi                                                            |
| ----------------------------------------------------------------- | ----------------------------------------------------------------- |
|                                                                   |
| ![Trước khi sửa đổi.png](https://s2.loli.net/2024/09/19/A6KoYdv5nbRkMCF.png) | ![Sau khi sửa đổi.png](https://s2.loli.net/2024/09/19/2UCM18tuWXirgxB.png) |
| ![Trước khi sửa đổi.gif](https://s2.loli.net/2024/09/19/khLXwEFQI58qjdZ.gif) | ![Sau khi sửa đổi.gif](https://s2.loli.net/2024/09/19/azlGiIBEg2SAFPc.gif) |
