...
<h5><a href="https://github.com/ChinaGodMan/UserScripts/tree/main/docs/zh-TW#-%E8%85%B3%E6%9C%AC%E5%88%97%E8%A1%A8" target="_blank"><ruby>GitHub查看勤務員的腳本<rt>Github:@ChinaGodMan</rt></ruby></a><br><a href="https://greasyfork.org/zh-CN/scripts?by=1169082&sort=created" target="_blank">GreasyFork查看勤務員的腳本</a><br><a href="#:~:text=查看所有發布腳本">當前頁面查看勤務員的腳本</a></h5>
...
<!--HISTORY-->
<center><div align="center">
    <h1>GreasyFork 用戶發布的腳本資料視覺化</h1>
    <p>「 使用Chart.js獲取和可視化獲取用戶腳本數據，並在使用者個人主頁產生圖表在下方顯示詳細安裝情況 」</p>
    ...
    <img src="https://img.shields.io/greasyfork/dt/508968?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=%E7%94%A8%E6%88%B6%E6%95%B8%E9%87%8F">
    <img src="https://img.shields.io/badge/dynamic/json?&label=%E6%AF%8F%E6%97%A5%E6%AA%A2%E6%9F%A5%E6%9B%B4%E6%96%B0%E6%AC%A1%E6%95%B8&query=$.508968&logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&url=https://github.com/ChinaGodMan/UserScriptsHistory/raw/main/daily_update_checks.json">
    <p>Download:<a href="https://github.com/ChinaGodMan/UserScripts/tree/main/greasyfork-user-scripts-data-visualization">Github</a> | ⭐<a
            ...
            Fork</a></p><details><summary style="color:#FFD700">更新記錄</summary><div align="right"><a href="https://github.com/ChinaGodMan/UserScripts/tree/main/greasyfork-user-scripts-data-visualization/CHANGELOG.md"><img src="https://img.shields.io/badge/-GitHub-3A3A3A?style=flat&logo=GitHub&logoColor=white"></a></div><h1><strong>🛠️ GrreasyFork 用戶腳本數據可視化 更新日誌</strong></h1>
<h3><strong>📅 2024-09-20 07:46- Ver 1.1.1.1</strong></h3>
<p><strong>新增</strong>: •增加自己使用的一些小功能.<code>表格顯示創建與更新日期</code> <code>Y軸數值高亮</code> <code>點擊柱狀圖跳轉對應腳本</code> 腳本中的<code>OPENLINK</code> 為<code>0</code>不跳轉,<code>1</code>跳轉前有提示,<code>2</code>直接跳轉</p>
<table>
<thead>
<tr>
<th>新增</th>
...
<td><img alt="跳轉.gif" src="https://s2.loli.net/2024/09/20/n1H26dzVfuBx7bN.gif" /></td>
</tr>
</tbody>
</table>
<hr />
<h3><strong>📅 2024-09-19 12:56:19- Ver 1.1.1.0</strong></h3>
<p><strong>修改</strong>: •修改<code>chart.js</code>為首次加載,加載完成後保存在<code>localStorage</code>無需每次重複加載</p>
<hr />
<h3><strong>📅 2024-09-19 08:25:19- Ver 1.1.0.0</strong></h3>
<p><strong>修復</strong>: • 修復圖表一些問題.<br></p>
<table>
<thead>
<tr>
<th>修改前</th>
...
<td><img alt="修改後.png" src="https://s2.loli.net/2024/09/19/2UCM18tuWXirgxB.png" /></td>
</tr>
<tr>
<td><img alt="修改前.gif" src="https://s2.loli.net/2024/09/19/khLXwEFQI58qjdZ.gif" /></td>
<td><img alt="修改後.gif" src="https://s2.loli.net/2024/09/19/azlGiIBEg2SAFPc.gif" /></td>
</tr>
</tbody>
</table>
<hr />
<h3><strong>📅 2024-09-18 11:01:32- Ver 1.0.0.0</strong></h3>
<p><strong>增加</strong>: •增加了原作者<a href="https://greasyfork.org/zh-CN/users/1177387">138 Aspen</a>另外腳本<a href="https://greasyfork.org/zh-CN/scripts/482623">Displays the number of scripts published by the user, the total number of installations</a>裡面的從當前網頁獲取用戶數據,可以在腳本內或者腳本菜單中設置從JSON數據獲取還是從當前頁面獲取腳本數據默認向GreasyFrok下載用戶數據<br>
<strong>修改</strong>: •~~修改<code>chart.js</code>為@require 載入,無需每次重複加載~~Greasyfork不允許使用未經批准的外部腳本<br>
<strong>修改</strong>: •修改從網絡獲取用戶數據時,按照總安裝量由高到低排序<br>
<strong>修改</strong>: •修改尋找用戶ID的表達式為<code>/(\d+)/</code>,兼容<a href="https://greasyfork.org/zh-CN/scripts/497346">Greasyfork 糊裱匠</a><code>清除鏈接無用字符功能</code><br></p>
<hr /></details>
...
# GrreasyFork 用戶腳本數據可視化

<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">

## 描述

該用戶腳本使用 Chart.js 庫從 GreasyFork 上的用戶腳本頁面中提取和可視化腳本數據。它提供了以下功能：

-   **數據提取**: 從用戶的腳本頁面中提取安裝次數數據，包括總安裝次數和每日安裝次數。
-   **數據可視化**: 使用圖表（條形圖）展示每個腳本的總安裝次數和每日安裝次數。
-   **數據展示**: 在圖表下方顯示總安裝次數、每日安裝總數以及已發布腳本的數量。

<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">

## 功能

1. **獲取用戶數據**: 從用戶腳本頁面中提取相關數據。
2. **數據可視化**: 使用 Chart.js 繪製圖表來展示腳本的安裝數據。
3. **展示統計信息**: 在圖表下方顯示總的每日安裝次數、總安裝次數和已發布腳本的數量。

<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">

## 安裝

1. **安裝 Greasemonkey 或 Tampermonkey 插件**: 請確保您的瀏覽器已安裝 Greasemonkey 或 Tampermonkey 插件。
2. **添加腳本**:
    - 點擊上方綠色安裝按鈕進行安裝
...
1. **訪問 GreasyFork 用戶腳本頁面**: 打開任意用戶的腳本頁面，例如 [https://greasyfork.org/users/1169082](https://greasyfork.org/users/1169082)。
2. **查看圖表和統計數據**: 腳本將在用戶的個人頁面加載後自動生成並展示數據圖表和統計信息。
3. **從網絡或者從當前頁面加載**: 腳本在代碼頂端提供了一個設置,当為`true`時,從當前網頁獲取,為`false`,向 GreasyFrok 下載用戶數據`JSON`

<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">

## 支持

如遇到問題或需要支持，請訪問 [GitHub 問題頁面](https://github.com/ChinaGodMan/UserScripts/issues) 提交問題。

## 貢獻

此腳本修改自[138 Aspen](https://greasyfork.org/zh-CN/users/1177387)發布的腳本[GrreasyFork User Script Data Visualization](https://greasyfork.org/zh-CN/scripts/499755)
修改說明:<br>
**增加**: •增加了原作者[138 Aspen](https://greasyfork.org/zh-CN/users/1177387)另外腳本[Displays the number of scripts published by the user, the total number of installations](https://greasyfork.org/zh-CN/scripts/482623)裡面的從當前網頁獲取用戶數據,可以在腳本內或者腳本菜單中設置從 JSON 數據獲取還是從當前頁面獲取腳本數據<br>
**修改**: •~~修改`chart.js`為@require 載入,無需每次重複加載~~Greasyfork 不允許使用未經批准的外部腳本.....<br>
**修改**: •修改從網絡獲取用戶數據時,按照總安裝量由高到低排序<br>
**修改**: •修改尋找用戶 ID 的表達式為`/(\d+)/`,兼容[Greasyfork 糊裱匠](https://greasyfork.org/zh-CN/scripts/497346)`清除鏈接無用字符功能`<br>

歡迎貢獻和改進腳本！請訪問 [GitHub 倉庫](https://github.com/ChinaGodMan/UserScripts) 提交拉取請求或報告問題。

## 授權

該腳本遵循 MIT 許可證。有關詳細信息，請查看 [LICENSE](https://github.com/ChinaGodMan/UserScripts/blob/main/LICENSE) 文件。

**修正每日安裝統計在右邊,切換總安裝/日安裝時圖表軸顯示問題**

| 修改前                                                            | 修改後                                                            |
| ----------------------------------------------------------------- | ----------------------------------------------------------------- |
|                                                                   |
| ![修改前.png](https://s2.loli.net/2024/09/19/A6KoYdv5nbRkMCF.png) | ![修改後.png](https://s2.loli.net/2024/09/19/2UCM18tuWXirgxB.png) |
| ![修改前.gif](https://s2.loli.net/2024/09/19/khLXwEFQI58qjdZ.gif) | ![修改後.gif](https://s2.loli.net/2024/09/19/azlGiIBEg2SAFPc.gif) |
