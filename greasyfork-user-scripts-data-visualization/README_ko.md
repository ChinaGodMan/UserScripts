...
<!--HISTORY-->
<center><div align="center">
    <h1>GreasyFork 사용자 게시 스크립트 데이터 시각화</h1>
    <p>「 사용Chart.js사용자 스크립트 데이터 획득 및 시각화，그리고 사용자의 개인 홈페이지에 차트를 생성하여 아래와 같이 자세한 설치 현황을 표시합니다. 」</p>
    ...
    <img src="https://img.shields.io/greasyfork/dt/508968?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=%EC%82%AC%EC%9A%A9%EC%9E%90%20%EC%88%98">
    <img src="https://img.shields.io/badge/dynamic/json?&label=%EB%A7%A4%EC%9D%BC%20%ED%99%95%EC%9D%B8%20%EC%97%85%EB%8D%B0%EC%9D%B4%ED%8A%B8&query=$.508968&logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&url=https://github.com/ChinaGodMan/UserScriptsHistory/raw/main/daily_update_checks.json">
    <p>Download:<a href="https://github.com/ChinaGodMan/UserScripts/tree/main/greasyfork-user-scripts-data-visualization">Github</a> | ⭐<a
            ...
            Fork</a></p><details><summary style="color:#FFD700">레코드 업데이트</summary><div align="right"><a href="https://github.com/ChinaGodMan/UserScripts/tree/main/greasyfork-user-scripts-data-visualization/CHANGELOG.md"><img src="https://img.shields.io/badge/-GitHub-3A3A3A?style=flat&logo=GitHub&logoColor=white"></a></div><h1><strong>🛠️ GrreasyFork 사용자 스크립트 데이터 시각화 로그 업데이트</strong></h1>
<h3><strong>📅 2024-09-20 07:46- Ver 1.1.1.1</strong></h3>
<p><strong>새로운</strong>: •사용할 작은 기능을 추가하십시오.<code>테이블에는 생성 및 업데이트 날짜가 표시됩니다</code> <code>Y축 값이 강조 표시됩니다</code> <code>막대 차트를 클릭하여 해당 스크립트로 이동하십시오.</code> 대본에서<code>OPENLINK</code> ~을 위한<code>0</code>점프하지 마십시오,<code>1</code>점프하기 전에 팁이 있습니다,<code>2</code>직접 점프하십시오</p>
<table>
<thead>
<tr>
<th>새로운</th>
...
<td><img alt="도약.gif" src="https://s2.loli.net/2024/09/20/n1H26dzVfuBx7bN.gif" /></td>
</tr>
</tbody>
</table>
<hr />
<h3><strong>📅 2024-09-19 12:56:19- Ver 1.1.1.0</strong></h3>
<p><strong>개정하다</strong>: •개정하다<code>chart.js</code>첫 번째 부하,로드 후 저장하십시오<code>localStorage</code>반복적 인 하중이 필요하지 않습니다</p>
<hr />
<h3><strong>📅 2024-09-19 08:25:19- Ver 1.1.0.0</strong></h3>
<p><strong>수리하다</strong>: • 차트에 몇 가지 문제를 해결하십시오.<br></p>
<table>
<thead>
<tr>
<th>수정 전</th>
...
<tr>
<td><img alt="수정 전.png" src="https://s2.loli.net/2024/09/19/A6KoYdv5nbRkMCF.png" /></td>
<td><img alt="수정 후.png" src="https://s2.loli.net/2024/09/19/2UCM18tuWXirgxB.png" /></td>
</tr>
<tr>
<td><img alt="수정 전.gif" src="https://s2.loli.net/2024/09/19/khLXwEFQI58qjdZ.gif" /></td>
<td><img alt="수정 후.gif" src="https://s2.loli.net/2024/09/19/azlGiIBEg2SAFPc.gif" /></td>
</tr>
</tbody>
</table>
<hr />
<h3><strong>📅 2024-09-18 11:01:32- Ver 1.0.0.0</strong></h3>
<p><strong>증가하다</strong>: •원래 저자가 추가되었습니다<a href="https://greasyfork.org/zh-CN/users/1177387">138 Aspen</a>추가 스크립트<a href="https://greasyfork.org/zh-CN/scripts/482623">Displays the number of scripts published by the user, the total number of installations</a>현재 웹 페이지에서 사용자 데이터를 가져옵니다,스크립트 또는 스크립트 메뉴에서 설정할 수 있습니다.JSON현재 페이지 기본값에서 데이터 수집 또는 스크립트 데이터GreasyFrok사용자 데이터를 다운로드하십시오<br>
<strong>개정하다</strong>: •~~개정하다<code>chart.js</code>~을 위한@require 짐,반복적 인 하중이 필요하지 않습니다~~Greasyfork무단 외부 스크립트는 허용되지 않습니다<br>
<strong>개정하다</strong>: •네트워크에서 사용자 데이터를 얻을 때 수정하십시오,총 설치량에 따라 높음에서 낮음 정렬<br>
<strong>개정하다</strong>: •사용자를 찾도록 수정하십시오ID표현은<code>/(\d+)/</code>,호환 가능<a href="https://greasyfork.org/zh-CN/scripts/497346">Greasyfork 리깅 메이커를 붙여 넣으십시오</a><code>링크 쓸모없는 문자 기능을 명확하게합니다</code><br></p>
<hr /></details>
...
# GrreasyFork 사용자 스크립트 데이터 시각화

<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">

## 설명하다

이 사용자 스크립트가 사용됩니다 Chart.js 도서관 GreasyFork 사용자 스크립트 페이지에서 스크립트 데이터 추출 및 시각화。다음 기능을 제공합니다：

-   **데이터 추출**: 사용자 스크립트 페이지에서 설치 데이터를 추출합니다，총 설치 시간과 일일 설치 시간이 포함됩니다。
-   **데이터 시각화**: 차트 사용（막대 차트）각 스크립트에 대한 총 설치 수 및 일일 설치를 보여줍니다.。
-   **데이터 표시**: 차트 아래에 총 설치를 표시하십시오、일일 설치 총 수 및 게시 된 스크립트 수。

<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">

## 기능

1. **사용자 데이터를 얻습니다**: 사용자 스크립트 페이지에서 관련 데이터를 추출합니다。
2. **데이터 시각화**: 사용 Chart.js 스크립트의 설치 데이터를 표시하려면 차트를 그립니다。
3. **통계 표시**: 차트 아래에 총 설치를 표시하십시오、총 설치 수 및 게시 된 스크립트 수。

<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">

## 설치하다

1. **설치하다 Greasemonkey 또는 Tampermonkey 플러그인**: 브라우저가 설치되어 있는지 확인하십시오 Greasemonkey 또는 Tampermonkey 플러그인。
2. **스크립트를 추가하십시오**:
    - 위의 녹색 설치 버튼을 클릭하여 설치하십시오

<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">

## 사용

1. **입장 GreasyFork 사용자 스크립트 페이지**: 사용자의 스크립트 페이지를 엽니 다，예를 들어 [https://greasyfork.org/users/1169082](https://greasyfork.org/users/1169082)。
2. **차트 및 통계를 봅니다**: 스크립트는 사용자의 개인 페이지가로드 된 후 데이터 차트 및 통계를 자동으로 생성하고 표시합니다.。
3. **네트워크 나 현재 페이지에서로드하십시오**: 스크립트는 코드 상단의 설정을 제공합니다.,언제~을 위한`true`시간,현재 페이지에서 얻으십시오,~을 위한`false`,쪽으로 GreasyFrok 사용자 데이터를 다운로드하십시오`JSON`

<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">

## 지원하다

문제가 발생하거나 지원이 필요한 경우，방문하십시오 [GitHub 질문 페이지](https://github.com/ChinaGodMan/UserScripts/issues) 질문을 제출하십시오。

## 기여하다

이 스크립트는 수정되었습니다[138 Aspen](https://greasyfork.org/zh-CN/users/1177387)게시 된 스크립트[GrreasyFork User Script Data Visualization](https://greasyfork.org/zh-CN/scripts/499755)
수정 지침:<br>
**증가하다**: •원래 저자가 추가되었습니다[138 Aspen](https://greasyfork.org/zh-CN/users/1177387)추가 스크립트[Displays the number of scripts published by the user, the total number of installations](https://greasyfork.org/zh-CN/scripts/482623)현재 웹 페이지에서 사용자 데이터를 가져옵니다,스크립트 또는 스크립트 메뉴에서 설정할 수 있습니다. JSON 현재 페이지의 데이터 수집 또는 스크립트 데이터<br>
**개정하다**: •~~개정하다`chart.js`~을 위한@require 짐,반복적 인 하중이 필요하지 않습니다~~Greasyfork 무단 외부 스크립트는 허용되지 않습니다.....<br>
**개정하다**: •네트워크에서 사용자 데이터를 얻을 때 수정하십시오,총 설치량에 따라 높음에서 낮음 정렬<br>
**개정하다**: •사용자를 찾도록 수정하십시오 ID 표현은`/(\d+)/`,호환 가능[Greasyfork 리깅 메이커를 붙여 넣으십시오](https://greasyfork.org/zh-CN/scripts/497346)`링크 쓸모없는 문자 기능을 명확하게합니다`<br>

스크립트를 기여하고 개선하는 데 오신 것을 환영합니다！방문하십시오 [GitHub 창고](https://github.com/ChinaGodMan/UserScripts) 풀 요청을 제출하거나 문제를보고하십시오。

## 권한 부여

이 스크립트는 다음과 같습니다 MIT 특허。자세한 정보，확인하십시오 [LICENSE](https://github.com/ChinaGodMan/UserScripts/blob/main/LICENSE) 문서。

**오른쪽의 일일 설치 통계를 수정했습니다,총 설치를 전환하십시오/매일 설치하는 동안 차트 축을 표시하는 문제**

| 수정 전                                                            | 수정 후                                                            |
| ----------------------------------------------------------------- | ----------------------------------------------------------------- |
|                                                                   |
| ![수정 전.png](https://s2.loli.net/2024/09/19/A6KoYdv5nbRkMCF.png) | ![수정 후.png](https://s2.loli.net/2024/09/19/2UCM18tuWXirgxB.png) |
| ![수정 전.gif](https://s2.loli.net/2024/09/19/khLXwEFQI58qjdZ.gif) | ![수정 후.gif](https://s2.loli.net/2024/09/19/azlGiIBEg2SAFPc.gif) |
