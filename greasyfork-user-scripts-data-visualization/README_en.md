...
<center><div align="center">
    <h1>GreasyFork User-published script data visualization</h1>
...
<p><strong>Increase</strong>: •Added original author<a href="https://greasyfork.org/zh-CN/users/1177387">138 Aspen</a>Additional script<a href="https://greasyfork.org/zh-CN/scripts/482623">Displays the number of scripts published by the user, the total number of installations</a>Get user data from the current web page,You can set it in the script or in the script menuJSONData fetch or script data from the current page default toGreasyFrokDownload user data<br>
