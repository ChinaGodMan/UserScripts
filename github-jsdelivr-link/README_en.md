...
>
> -   [**Greasy forkScript pages are suitable for URL enhancement**](https://greasyfork.org/scripts/497317): Script details page is suitable for search without default URL redirection Turn to a clickable text link and pop up the prompt
