...
<div align="right">
    <h6>
        ...
        <a href="https://github.com/ChinaGodMan/UserScripts/blob/main/github-folder-downloader/README_ko.md">한국어</a> |
        <a href="https://github.com/ChinaGodMan/UserScripts/blob/main/github-folder-downloader/README_vi.md">Tiếng Việt</a> |
        <a href="https://github.com/ChinaGodMan/UserScripts/blob/main/github-folder-downloader/README_zh-TW.md">繁體中文</a>
    <br>
...
<!--HISTORY-->
<center><div align="center">
    <h1>GitHub trình tải xuống thư mục</h1>
    <p>「 Thêm nút tải xuống，Cho phép dễ dàng tải xuống cụ thể GitHub thư mục。 」</p>
    ...
    <img src="https://img.shields.io/greasyfork/dt/505496?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=S%E1%BB%91%20l%C6%B0%E1%BB%A3ng%20ng%C6%B0%E1%BB%9Di%20d%C3%B9ng">
    <img src="https://img.shields.io/badge/dynamic/json?&label=C%E1%BA%ADp%20nh%E1%BA%ADt%20ki%E1%BB%83m%20tra%20h%C3%A0ng%20ng%C3%A0y&query=$.505496&logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&url=https://github.com/ChinaGodMan/UserScriptsHistory/raw/main/daily_update_checks.json">
    <p>Download:<a href="https://github.com/ChinaGodMan/UserScripts/tree/main/github-folder-downloader">Github</a> | ⭐<a
            href="https://greasyfork.org/scripts/505496">Greasy
            Fork</a></p><details><summary style="color:#FFD700">Cập nhật hồ sơ</summary><div align="right"><a href="https://github.com/ChinaGodMan/UserScripts/tree/main/github-folder-downloader/CHANGELOG.md"><img src="https://img.shields.io/badge/-GitHub-3A3A3A?style=flat&logo=GitHub&logoColor=white"></a></div><h1><strong>🛠️ GitHub Tải xuống thư mục Cập nhật nhật ký</strong></h1>
<h3><strong>📅 2024/8/28 09:46 - Ver 0.7.0.2</strong></h3>
<p><strong>tối ưu hóa</strong>: Xóa trình nghe có liên kết phát hiện thay đổi trong tập lệnh gốc，Thêm trình nghe mới để hỗ trợ hiển thị các nút khi trang chủ kho lưu trữ nhảy vào thư mục</p>
<hr />
<h3><strong>📅 2024/8/28 04:21 - Ver 0.7</strong></h3>
<p><strong>Sửa chữa</strong>: Thay thế các bộ chọn không thành công</p>
<hr /></details>
    <img src="https://raw.githubusercontent.com/ChinaGodMan/UserScriptsHistory/main/stats/505496.png">
</div></center>
...
GitHub Trình tải xuống thư mục là GitHub Một nút tải xuống đã được thêm vào thư mục，Giúp người dùng dễ dàng tải xuống các thư mục cụ thể từ kho lưu trữ。Nút tích hợp hai công cụ bên ngoài：download-directory Và DownGit，Cho phép người dùng tải xuống các thư mục chỉ bằng một cú nhấp chuột。

<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">

### Chức năng

-   vì GitHub Thêm một thư mục để tải xuống nút。
-   Cung cấp sử dụng [download-directory](https://download-directory.github.io) Và [DownGit](https://downgit.github.io) Các tùy chọn để tải xuống các thư mục。

<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">

### Cách sử dụng

1. Điều hướng đến a GitHub Nhà kho。
2. Mở một thư mục trong kho lưu trữ。
3. Nhấp“Tải xuống thư mục”Cái nút，Để xem các tùy chọn để tải xuống các thư mục。
...
Sửa đổi từ người dùng[Eric Kwok](https://greasyfork.org/zh-CN/users/220259) Kịch bản [GitHub Tải xuống thư mục](https://greasyfork.org/scripts/434592)
