...
<!--HISTORY-->
<center><div align="center">
    <h1>Video bộ sưu tập sao lưu missav</h1>
    <p>「 Nhận tệp hình ảnh và thông tin video từ trang Missav hiện tại và cung cấp tệp trang web đã tải xuống sau khi hợp nhất kết quả. 」</p>
    ...
    <img src="https://img.shields.io/greasyfork/dt/497682?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=S%E1%BB%91%20l%C6%B0%E1%BB%A3ng%20ng%C6%B0%E1%BB%9Di%20d%C3%B9ng">
    <img src="https://img.shields.io/badge/dynamic/json?&label=C%E1%BA%ADp%20nh%E1%BA%ADt%20ki%E1%BB%83m%20tra%20h%C3%A0ng%20ng%C3%A0y&query=$.497682&logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&url=https://github.com/ChinaGodMan/UserScriptsHistory/raw/main/daily_update_checks.json">
    <p>Download:<a href="https://github.com/ChinaGodMan/UserScripts/tree/main/missav-explorer">Github</a> | ⭐<a
            ...
            Fork</a></p><details><summary style="color:#FFD700">Cập nhật hồ sơ</summary><div align="right"><a href="https://github.com/ChinaGodMan/UserScripts/tree/main/missav-explorer/CHANGELOG.md"><img src="https://img.shields.io/badge/-GitHub-3A3A3A?style=flat&logo=GitHub&logoColor=white"></a></div><h1><strong>🛠️ MissAV Bộ sưu tập video sao lưu hàng loạt Cập nhật nhật ký</strong></h1>
<h3><strong>📅 2025.04.27.1347</strong></h3>
<p><strong>Sửa chữa</strong>: • Thêm một tên miền<code>missav.live</code>Ủng hộ<br>
<strong>Mới</strong>: • Vì tên miền thay đổi thường xuyên,Không phải URL mã hóa cứng,Thay vào đó, trích xuất tên miền từ trang hiện tại</p>
<hr /></details>
...
# Missav Trích xuất lô

<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">

## Giới thiệu

Missav Trích xuất hàng loạt là một công cụ để sao lưu các mục yêu thích và trích xuất nội dung video。Nó có thể thu thập dữ liệu tất cả các video ngoại trừ trang chủ，Nó cũng cung cấp các chức năng đặt tên và tốc độ trích xuất tùy chỉnh。Sau khi tải xuống hoàn tất，Tạo một bức tranh chứa `img` Thư mục và một `Lưu tên tệp.html` Tên tệp web，Được sử dụng để xem thông tin video thu được。

<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">

## Chức năng

-   **Thu thập video**：Có thể thu thập dữ liệu tất cả các video ngoại trừ trang chủ，Trang phát lại video chưa được kiểm tra。
-   **Tạo nút**：Tạo một nút ở góc trên bên phải của trang，Được sử dụng để bắt đầu hoạt động trích xuất。
-   **Tốc độ chiết xuất tùy chỉnh**：Bạn có thể quay video với tốc độ bạn muốn。
-   **Tạo tệp sau khi tải xuống**：
    -   **img Thư mục hình ảnh**：Lưu trữ hình thu nhỏ video。
    -   **jsonindex Tệp trang web**：Bao gồm thông tin video，Bao gồm xem trước hình ảnh，Nhấp vào hình ảnh để xem video xem trước，Nhấp vào tiêu đề để nhảy đến Missav Tùy chỉnh trang Turn và Hiển thị các trang。
-   **Tải xuống hàng loạt**：Hỗ trợ hợp nhất tất cả các tờ để tải xuống hàng loạt。
-   **Hoạt động hàng loạt**：Hỗ trợ trích xuất hàng loạt video từ nhiều danh sách phim。
-   **Tên tệp tùy chỉnh**：Hỗ trợ tên tệp lưu tùy chỉnh。
-   **Tốc độ chiết xuất tùy chỉnh**：Bạn có thể đặt tốc độ trích xuất video。
-   **HTML phát ragiao diện**：Hỗ trợ nhận hình ảnh từ mạng và tạo chúng HTML giao diện。
-   **Tải xuống hình ảnh lớn độ nét cao**：Hỗ trợ tải xuống hình ảnh lớn độ nét cao。
-   **ủng hộWebDAVHỗ trợ**：Lưu đếnwebdav。
...
-   **Tải xuống hàng loạt và hợp nhất tất cả các tờ**：Hỗ trợ hợp nhất tất cả các tờ để tải xuống hàng loạt。
-   **Trích xuất tất cả các video ngoại trừ giao diện phát lại video**：Trích xuất tất cả các video ngoại trừ giao diện phát lại video。
-   **Chọn trang tính theo đợt cho các hoạt động hàng loạt**：Hỗ trợ lựa chọn lô cho hoạt động。
-   **Tháo hộp đầu vào bật lên**：Đã loại bỏ các hộp đầu vào không cần thiết。
-   **Tải xuống tùy chỉnh Lưu tên tệp**：Hỗ trợ tên tệp được tải xuống tùy chỉnh。
-   **Tốc độ chiết xuất tùy chỉnh**：Có thể đặt tốc độ trích xuất。
-   **HTML Tạo raGiao diện hỗ trợ nhận hình ảnh từ mạng**：Tạo ra HTML Giao diện có thể lấy hình ảnh từ mạng。
-   **Tải xuống hình ảnh lớn độ nét cao**：Hỗ trợ tải xuống hình ảnh lớn độ nét cao。
...
-   **Sau khi trang cuối cùng được truy xuất, nó được nhắc để có được thông tin vượt quá trang tối đa.**：Tôi sẽ không thực sự nhận được nó。

<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">

## Hướng dẫn sử dụng

1. **Sử dụng trong trang chủ theo phân loại video**：Mở trang chủ của trang phân loại video。
2. **Nhấp vào nút ở góc trên bên phải**：Bắt đầu hoạt động trích xuất。
3. **Đặt tốc độ trích xuất**：Điều chỉnh tốc độ chiết khi cần thiết。
4. **Tải xuống video và hình ảnh**：Sau khi trích xuất hoàn tất, các tập tin và hình ảnh sẽ được tạo。
5. **Kiểm tra `jsonindex` Tệp trang web**：Xem thông tin video，Nhấp vào hình ảnh để xem bản xem trước，Nhấp vào tiêu đề để nhảy đến Missav trang。
