...
<center><div align="center">
    ...
    <img src="https://img.shields.io/greasyfork/dt/529125?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=%EC%82%AC%EC%9A%A9%EC%9E%90%20%EC%88%98">
    <img src="https://img.shields.io/badge/dynamic/json?&label=%EB%A7%A4%EC%9D%BC%20%ED%99%95%EC%9D%B8%20%EC%97%85%EB%8D%B0%EC%9D%B4%ED%8A%B8&query=$.529125&logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&url=https://github.com/ChinaGodMan/UserScriptsHistory/raw/main/daily_update_checks.json">
    <p>Download:<a href="https://github.com/ChinaGodMan/UserScripts/tree/main/missav-enhancer">Github</a> | ⭐<a
            ...
            Fork</a></p><details><summary style="color:#FFD700">레코드 업데이트</summary><div align="right"><a href="https://github.com/ChinaGodMan/UserScripts/tree/main/missav-enhancer/CHANGELOG.md"><img src="https://img.shields.io/badge/-GitHub-3A3A3A?style=flat&logo=GitHub&logoColor=white"></a></div><h1><strong>🛠️ MissAV 강화 된 비서 로그 업데이트</strong></h1>
<h3><strong>📅 2025.04.27.1345</strong></h3>
<p><strong>새로운</strong>: 새로운 도메인 이름을 지원합니다<code>missav.live</code> <br></p>
<h3><strong>📅 2025.03.11.0544</strong></h3>
<p><strong>새로운</strong>: •놀이 페이지에는 여배우 정보가 표시됩니다 <br>
<strong>스크린 샷</strong>: <img alt="missav.png" src="https://s2.loli.net/2025/03/11/i4R6aDeNUSwuABK.png" /></p>
<hr />
...
1. 이 스크립트는 영화 시청 효과를 향상시키는 데 중점을 둡니다，집에서 필수 아이템。
2. 이 스크립트는 간단하고 강력합니다 `MissAV` 비디오 플러그인！

## 기능

_다음은 스크립트에서 설정할 수 있습니다_

-   🙅 모든 광고를 삭제합니다
-   🙅 재생 전에 페이지를 삭제하십시오
-   🔇 `autoMutePlay` 자동 사운드는 재생을 비활성화합니다
-   🔄 `autoPauseDisable` 백그라운드에서 자동 일시 중지 모드는 금지됩니다 `0` 기본 모드를 나타냅니다，동일한 탭 세트 내에서 태그를 전환 할 때 재생이 일시 중지됩니다.；`1` 그것은 모든 일시 정지가 금지되어 있음을 의미합니다，태그를 전환하더라도 일시 중지되지 않습니다。
-   🔁 `playCtrlEnable` 플레이 페이지는 플레이어에게 한 번의 클릭을 표시합니다
-   `minute` ⏪ 가장 긴 빨리 전달/후퇴 시간
-   📥 비디오 세부 정보를 확장하십시오,대신에`더 보여주십시오`
-   📥 비디오는 전체 제목을 표시합니다
-   📥 비디오 카테고리 제목을 클릭 할 수 있습니다
-   📥 `missav.com`&`thisav.com`리디렉션=>`missav.ws`

## 사람들의 종들은 다음 스크립트에서 수정되었습니다

[@iSwfe](https://greasyfork.org/zh-CN/users/208142)=>[MISSAV 비디오 제어 바 향상](https://greasyfork.org/zh-CN/scripts/493932)
[@mrhydra](https://greasyfork.org/zh-CN/users/1114760)=>[missav 페이지를 수정하십시오](https://greasyfork.org/zh-CN/scripts/488770)
[@track no](https://greasyfork.org/zh-CN/users/1325707)=>[missav 영원히 플레이하십시오+광고가 없습니다](https://greasyfork.org/zh-CN/scripts/499213)
[@DonkeyBea](https://greasyfork.org/zh-CN/users/912884)=>[MissAV 미니 향상 가방](https://greasyfork.org/zh-CN/scripts/470539)
