...
<center><div align="center">
    ...
    <img src="https://img.shields.io/greasyfork/dt/529125?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=S%E1%BB%91%20l%C6%B0%E1%BB%A3ng%20ng%C6%B0%E1%BB%9Di%20d%C3%B9ng">
    <img src="https://img.shields.io/badge/dynamic/json?&label=C%E1%BA%ADp%20nh%E1%BA%ADt%20ki%E1%BB%83m%20tra%20h%C3%A0ng%20ng%C3%A0y&query=$.529125&logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&url=https://github.com/ChinaGodMan/UserScriptsHistory/raw/main/daily_update_checks.json">
    <p>Download:<a href="https://github.com/ChinaGodMan/UserScripts/tree/main/missav-enhancer">Github</a> | ⭐<a
            ...
            Fork</a></p><details><summary style="color:#FFD700">Cập nhật hồ sơ</summary><div align="right"><a href="https://github.com/ChinaGodMan/UserScripts/tree/main/missav-enhancer/CHANGELOG.md"><img src="https://img.shields.io/badge/-GitHub-3A3A3A?style=flat&logo=GitHub&logoColor=white"></a></div><h1><strong>🛠️ MissAV Trợ lý nâng cao Cập nhật nhật ký</strong></h1>
...
# 🔞 MissAV Trợ lý nâng cao

1. Kịch bản này tập trung vào việc cải thiện hiệu ứng xem phim，Một vật phẩm phải có ở nhà。
2. Kịch bản này là một đơn giản và mạnh mẽ `MissAV` Video cắm！

## Chức năng

_Phần sau có thể được đặt trong tập lệnh_

-   🙅 Xóa tất cả các quảng cáo
-   🙅 Xóa trang trước khi phát lại
-   🔇 `autoMutePlay` Tự động vô hiệu hóa âm thanh vô hiệu hóa
-   🔄 `autoPauseDisable` Chế độ tạm dừng tự động bị cấm trong nền `0` Cho biết chế độ mặc định，Phát lại sẽ bị tạm dừng khi chuyển đổi thẻ trong cùng một bộ tab；`1` Nó có nghĩa là tất cả các tạm dừng đều bị cấm，Ngay cả khi bạn chuyển thẻ, nó sẽ không tạm dừng。
-   🔁 `playCtrlEnable` Trang phát hiển thị một lần nhấp vào người chơi
-   `minute` ⏪ Nhanh nhất về phía trước nhanh nhất/Thời gian rút lui
-   📥 Mở rộng chi tiết video,Thay vì`Hiển thị nhiều hơn`
-   📥 Video hiển thị tiêu đề đầy đủ
-   📥 Có thể nhấp vào Tiêu đề danh mục Video
-   📥 `missav.com`&`thisav.com`Chuyển hướng=>`missav.ws`

## Người hầu của mọi người được sửa đổi từ kịch bản sau

[@iSwfe](https://greasyfork.org/zh-CN/users/208142)=>[MISSAV Tăng cường thanh điều khiển video](https://greasyfork.org/zh-CN/scripts/493932)
[@mrhydra](https://greasyfork.org/zh-CN/users/1114760)=>[missav Sửa đổi trang](https://greasyfork.org/zh-CN/scripts/488770)
[@track no](https://greasyfork.org/zh-CN/users/1325707)=>[missav Chơi mãi mãi+Không có quảng cáo](https://greasyfork.org/zh-CN/scripts/499213)
[@DonkeyBea](https://greasyfork.org/zh-CN/users/912884)=>[MissAV Túi tăng cường mini](https://greasyfork.org/zh-CN/scripts/470539)
