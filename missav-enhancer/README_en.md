...
<center><div align="center">
    ...
    <p>Download:<a href="https://github.com/ChinaGodMan/UserScripts/tree/main/missav-enhancer">Github</a> | ⭐<a
            ...
            Fork</a></p><details><summary>Update records</summary><div align="right"><a href="https://github.com/ChinaGodMan/UserScripts/tree/main/missav-enhancer/CHANGELOG.md"><img src="https://img.shields.io/badge/-GitHub-3A3A3A?style=flat&logo=GitHub&logoColor=white"></a></div><h1><strong>🛠️ MissAV Enhanced Assistant Update log</strong></h1>
<h3><strong>📅 2025.04.27.1345</strong></h3>
<p><strong>New</strong>: Support new domain names<code>missav.live</code> <br></p>
<h3><strong>📅 2025.03.11.0544</strong></h3>
<p><strong>New</strong>: •The play page shows the actress information <br>
<strong>screenshot</strong>: <img alt="missav.png" src="https://s2.loli.net/2025/03/11/i4R6aDeNUSwuABK.png" /></p>
<hr />
...
# 🔞 MissAV Enhanced Assistant

1. This script focuses on improving the movie viewing effect，A must-have item at home。
2. This script is a simple and powerful `MissAV` Video plug-in！

## Function

_The following can be set in the script_

-   🙅 Delete all ads
-   🙅 Delete the page before playback
-   🔇 `autoMutePlay` Automatic sound disable playback
-   🔄 `autoPauseDisable` Automatic pause mode is prohibited in the background `0` Indicates the default mode，Playback will be paused when switching tags within the same set of tabs；`1` It means that all pauses are prohibited，Even if you switch the tag, it won’t pause。
-   🔁 `playCtrlEnable` The play page displays one-click back to the player
-   `minute` ⏪ Longest fast forward/Retreat time
-   📥 Expand the video details,Instead`Show more`
-   📥 Video displays full title
-   📥 Video category title can be clicked
-   📥 `missav.com`&`thisav.com`Redirect=>`missav.ws`

## People’s servants modified from the following script

[@iSwfe](https://greasyfork.org/zh-CN/users/208142)=>[MISSAV Video control bar enhancement](https://greasyfork.org/zh-CN/scripts/493932)
[@mrhydra](https://greasyfork.org/zh-CN/users/1114760)=>[missav Modify the page](https://greasyfork.org/zh-CN/scripts/488770)
[@track no](https://greasyfork.org/zh-CN/users/1325707)=>[missav Play forever+No advertising](https://greasyfork.org/zh-CN/scripts/499213)
[@DonkeyBea](https://greasyfork.org/zh-CN/users/912884)=>[MissAV Mini enhancement bag](https://greasyfork.org/zh-CN/scripts/470539)
