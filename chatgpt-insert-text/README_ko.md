...
<!--HISTORY-->
<center><div align="center">
    <h1>chatgpt 삽입 프롬프트 단어</h1>
    <p>「 키 조합을 통해 ChatGpt 입력 상자에 명령을 삽입하십시오. 」</p>
    ...
    <img src="https://img.shields.io/greasyfork/dt/537647?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=%EC%82%AC%EC%9A%A9%EC%9E%90%20%EC%88%98">
    <img src="https://img.shields.io/badge/dynamic/json?&label=%EB%A7%A4%EC%9D%BC%20%ED%99%95%EC%9D%B8%20%EC%97%85%EB%8D%B0%EC%9D%B4%ED%8A%B8&query=$.537647&logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&url=https://github.com/ChinaGodMan/UserScriptsHistory/raw/main/daily_update_checks.json">
...
ChatGPT 입력 상자、텍스트 영역 또는 편집 가능한 콘텐츠 영역，프리셋 바로 가기 키로 특정 텍스트를 신속하게 삽입하십시오，입력 효율성 및 편집 경험을 향상시킵니다。

## 주요 기능

- **바로 가기 키 매핑**

    키를 결합하여（좋다 `Control+Alt+Period`、`Alt+Shift+Comma` 기다리다）사전 정의 된 텍스트 스 니펫을 삽입하십시오。


## 바로 가기 키 예제

| 바로 가기 키 | 텍스트 내용을 삽입하십시오 |
...
| Control + Shift + Equal | 끼워 넣다 Markdown 코드 블록 마킹 ` ``` ` |

（스크립트의 전체 바로 가기 키 매핑을 참조하십시오 `keyMap` 물체）
