...
<!--HISTORY-->
<center><div align="center">
    <h1>ChatGPT Insert Prompt Word</h1>
    <p>「 Insert the command into the ChatGPT input box via key combination 」</p>
    ...
    <img src="https://img.shields.io/greasyfork/dt/537647?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=Number%20of%20users">
    <img src="https://img.shields.io/badge/dynamic/json?&label=Daily%20check%20updates&query=$.537647&logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&url=https://github.com/ChinaGodMan/UserScriptsHistory/raw/main/daily_update_checks.json">
...
ChatGPT Input box、Text area or editable content area，Quickly insert specific text with preset shortcut keys，Improve input efficiency and editing experience。

## Main functions

- **Shortcut key mapping**

    By combining keys（like `Control+Alt+Period`、`Alt+Shift+Comma` wait）Insert predefined text snippets。


## Shortcut key example

| shortcut key | Insert text content |
...
| Control + Shift + Equal | insert Markdown Code block marking ` ``` ` |

（See the complete shortcut key mapping in the script `keyMap` Object）
