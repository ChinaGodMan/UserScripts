...
<div align="right">
    <h6>
        ...
        <a href="https://github.com/ChinaGodMan/UserScripts/blob/main/chatgpt-insert-text/README.md">简体中文</a> |
        <a href="https://github.com/ChinaGodMan/UserScripts/blob/main/chatgpt-insert-text/README_en.md">English</a> |
        <a href="https://github.com/ChinaGodMan/UserScripts/blob/main/chatgpt-insert-text/README_ko.md">한국어</a> |
        <a href="https://github.com/ChinaGodMan/UserScripts/blob/main/chatgpt-insert-text/README_vi.md">Tiếng Việt</a> |
        <a href="https://github.com/ChinaGodMan/UserScripts/blob/main/chatgpt-insert-text/README_zh-TW.md">繁體中文</a>
    <br>
...
<center><div align="center">
    <h1>ChatGPT 插入提示詞</h1>
    <p>「 通過組合鍵將指令插入 ChatGPT 輸入框 」</p>
    <img src="https://views.whatilearened.today/views/github/537647/hmjz100.svg" alt="Views">
    <img src="https://img.shields.io/github/size/ChinaGodMan/UserScripts/chatgpt-insert-text/chatgpt-insert-text.user.js?color=%23990000">
    <img src="https://img.shields.io/greasyfork/dt/537647?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=%E7%94%A8%E6%88%B6%E6%95%B8%E9%87%8F">
    <img src="https://img.shields.io/badge/dynamic/json?&label=%E6%AF%8F%E6%97%A5%E6%AA%A2%E6%9F%A5%E6%9B%B4%E6%96%B0%E6%AC%A1%E6%95%B8&query=$.537647&logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&url=https://github.com/ChinaGodMan/UserScriptsHistory/raw/main/daily_update_checks.json">
    <p>Download:<a href="https://github.com/ChinaGodMan/UserScripts/tree/main/chatgpt-insert-text">Github</a> | ⭐<a
            href="https://greasyfork.org/scripts/537647">Greasy
            Fork</a></p>
    <img src="https://raw.githubusercontent.com/ChinaGodMan/UserScriptsHistory/main/stats/537647.png">
</div></center>

<!--HISTORY-END-->
<!--TEXT-->

ChatGPT 輸入框、文本區域或可編輯內容區域，通過預設的快捷鍵快速插入特定文本，提升輸入效率和編輯體驗。

## 主要功能

- **快捷鍵映射**

    通過組合鍵（如 `Control+Alt+Period`、`Alt+Shift+Comma` 等）插入預定義的文本片段。
...
| Control + Shift + Equal | 插入 Markdown 代碼塊標記 ` ``` ` |

（完整快捷鍵映射見腳本中的 `keyMap` 對象）
