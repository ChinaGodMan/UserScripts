...
<center><div align="center">
    <h1>화려한 그라디언트는 웹 페이지 테이블을 아름답게합니다</h1>
    <p>「 테이블의 모든 열에 색상 그라디언트를 자동으로 적용하여 아름답게 」</p>
    ...
    <p>Download:<a href="https://github.com/ChinaGodMan/UserScripts/tree/main/colorful-table">Github</a> | ⭐<a
            ...
            Fork</a></p><details><summary>레코드 업데이트</summary><h1><strong>🛠️ 화려한 그라디언트는 웹 페이지 테이블을 아름답게합니다 로그 업데이트</strong></h1>
