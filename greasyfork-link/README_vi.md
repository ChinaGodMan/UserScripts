...
<center><div align="center">
    <h1>Greasy forkTrang kịch bản phù hợp để tăng cường URL</h1>
    <p>「 Trang chi tiết tập lệnh phù hợp cho các tìm kiếm mà không cần chuyển hướng mặc định Chuyển sang liên kết văn bản có thể nhấp và bật lên lời nhắc 」</p>
...
<h1>
    <div style="background-color: rgb(255, 0, 0); color: yellow;">
        Kịch bản tồn tại<b>BUG</b>, Đề nghị sử dụng
        <a href="/zh-CN/scripts/497346" target="_blank" style="color: blue;">【Greasyfork Dán nhà sản xuất giàn khoan】</a>
        <a href="https://update.greasyfork.org/scripts/497346.user.js" target="_blank" style="color: blue;">【Nhấp vào tôi để cài đặt】</a>
        <div>
            Tích hợp đa chức năng, Và chức năng nâng cao của tập lệnh mới đã được kiểm tra và không cóBUG
        </div>
    </div>
</h1>
...
Trang chi tiết tập lệnh"Áp dụng cho"Xóa tìm kiếm diễn đàn nhảy mặc định dưới URL，Thay đổi thành liên kết văn bản có thể được nhấp vào。Một lời nhắc bật lên khi nhấp vào：

-   Nhấp"Chắc chắn"Tìm kiếm nhảy
-   Nhấp"Hủy bỏ"Nhảy trực tiếp vào trang web
...
~~Cung cấp một menu để sửa đổi giá trị và nhấp để có hiệu lực~~

-   0=Dấu nhắc bật lên
-   1=Mở URL
-   2=Tìm kiếm trong diễn đàn

<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">

### 0.6 Phiên bản

Đã thêm một hộp lựa chọn để thay đổi phương thức nhảy bên dưới trang chi tiết tập lệnh。

<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">

### 0.7 Phiên bản

Đã thêm nĩa của người lớn

<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">

### 0.8 Phiên bản（2024 Năm 06 mặt trăng 09 ngày 06:17:02）

-   Xóa dấu nhắc bật lên，Thay đổi thành cửa sổ hiển thị，có“Nhảy，tìm kiếm，sao chép”Ba hoạt động
-   Một lời nhắc bật lên khi thay đổi hành vi nhấp chuột，Thay đổi thành toast thông báo
-   Thêm tùy chọn mở cửa sổ liên kết mới，Mặc định là bước nhảy trang hiện tại
