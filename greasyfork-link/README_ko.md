...
<h1>
    <div style="background-color: rgb(255, 0, 0); color: yellow;">
        스크립트가 존재합니다<b>BUG</b>, 사용하는 것이 좋습니다
        <a href="/zh-CN/scripts/497346" target="_blank" style="color: blue;">【Greasyfork 리깅 메이커를 붙여 넣으십시오】</a>
        <a href="https://update.greasyfork.org/scripts/497346.user.js" target="_blank" style="color: blue;">【설치하려면 나를 클릭하십시오】</a>
        <div>
            내장 다중 기능, 그리고 새로운 스크립트의 향상된 기능은 테스트되었으며BUG
        </div>
    </div>
</h1>
...
스크립트 세부 정보 페이지"적용 가능"URL에서 기본 점프 포럼 검색을 제거하십시오，클릭 할 수있는 텍스트 링크로 변경하십시오。클릭하면 프롬프트가 나타납니다：

-   딸깍 하는 소리"확신하는"점프 검색
-   딸깍 하는 소리"취소"웹 사이트로 직접 이동하십시오
...
스크립트 세부 사항 페이지 아래의 점프 메소드를 변경하기 위해 선택 상자를 추가했습니다.。
...
### 0.8 버전（2024 년도 06 달 09 낮 06:17:02）

-   팝업 프롬프트를 제거하십시오，디스플레이 창으로 변경，가지다“도약，찾다，복사”세 가지 작업
-   클릭 행동을 변경하면 프롬프트가 나타납니다.，변경 toast 알림
-   링크 새 창 시작 옵션을 추가합니다，기본값은 현재 페이지 점프입니다
