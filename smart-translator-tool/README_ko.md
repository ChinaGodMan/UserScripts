...
<!--HISTORY-->
<center><div align="center">
    <h1>번역 위젯 |. 모든 언어 번역</h1>
    <p>「 모든 언어의 번역은 원하는 텍스트를 선택하십시오 」</p>
    ...
    <img src="https://img.shields.io/greasyfork/dt/530406?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=%EC%82%AC%EC%9A%A9%EC%9E%90%20%EC%88%98">
    <img src="https://img.shields.io/badge/dynamic/json?&label=%EB%A7%A4%EC%9D%BC%20%ED%99%95%EC%9D%B8%20%EC%97%85%EB%8D%B0%EC%9D%B4%ED%8A%B8&query=$.530406&logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&url=https://github.com/ChinaGodMan/UserScriptsHistory/raw/main/daily_update_checks.json">
...
## 결정된 Google 번역 실패 문제，이제 Google을 사용하여 정상적으로 번역 할 수 있습니다

### 💡 사용 방법（매우 쉽습니다，사진을 참조하십시오！😊）[](#사용 방법（매우 쉽습니다，사진을 참조하십시오！）)

![Snipaste_2024-06-25_16-43-35.webp](https://img.xwyue.com/i/2024/06/25/667a850940f98.webp)

### 💡🎇 번역 기기（플로팅 페이지，뒤로 인용문을 두 번 클릭하십시오(\`\`)소환되거나 숨겨 질 수 있습니다）[](<#번역 기기（플로팅 페이지，뒤로 인용문을 두 번 클릭하십시오(``)소환되거나 숨겨 질 수 있습니다）>)
...
-   번역을 클립 보드에 즉시 복사하십시오 ✔️
-   한 번의 클릭 사본 기능 ✔️

# \--------------------------------------------[](#-)

📖 최적화에 대한 아이디어 나 사용중인 새로운 기능이 있으면 사용하거나 Email 피드백 커뮤니케이션～～ 😄
