...
<center><div align="center">
    <h1>Tiện ích dịch |</h1>
    <p>「 Bản dịch của bất kỳ ngôn ngữ nào của Ngôn ngữ bạn muốn | 」</p>
    ...
    <img src="https://img.shields.io/greasyfork/dt/530406?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=S%E1%BB%91%20l%C6%B0%E1%BB%A3ng%20ng%C6%B0%E1%BB%9Di%20d%C3%B9ng">
    <img src="https://img.shields.io/badge/dynamic/json?&label=C%E1%BA%ADp%20nh%E1%BA%ADt%20ki%E1%BB%83m%20tra%20h%C3%A0ng%20ng%C3%A0y&query=$.530406&logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&url=https://github.com/ChinaGodMan/UserScriptsHistory/raw/main/daily_update_checks.json">
    <p>Download:<a href="https://github.com/ChinaGodMan/UserScripts/tree/main/smart-translator-tool">Github</a> | ⭐<a
            ...
            Fork</a></p><details><summary style="color:#FFD700">Cập nhật hồ sơ</summary><div align="right"><a href="https://github.com/ChinaGodMan/UserScripts/tree/main/smart-translator-tool/CHANGELOG.md"><img src="https://img.shields.io/badge/-GitHub-3A3A3A?style=flat&logo=GitHub&logoColor=white"></a></div><h1><strong>🛠️ Tiện ích dịch | Dịch bất kỳ ngôn ngữ Cập nhật nhật ký</strong></h1>
<h3><strong>📅 2025.03.21.1227</strong></h3>
<p><strong>Sửa chữa</strong>: Sử dụng Google Dịch để sử dụng miễn phí API</p>
<hr /></details>
...
## Đã sửa Google Vấn đề lỗi dịch，Bây giờ bạn có thể sử dụng Google để dịch bình thường

### 💡 Cách sử dụng（Rất dễ dàng，Vui lòng xem hình ảnh！😊）[](#Cách sử dụng（Rất dễ dàng，Vui lòng xem hình ảnh！）)

![Snipaste_2024-06-25_16-43-35.webp](https://img.xwyue.com/i/2024/06/25/667a850940f98.webp)

### 💡🎇 Tiện ích dịch（Trang nổi，Nhấp vào báo giá quay lại hai lần(\`\`)Có thể được triệu tập hoặc ẩn）[](<#Tiện ích dịch（Trang nổi，Nhấp vào báo giá quay lại hai lần(``)Có thể được triệu tập hoặc ẩn）>)
...
-   Sao chép bản dịch vào bảng tạm ngay lập tức ✔️
-   Chức năng sao chép một lần ✔️

# \--------------------------------------------[](#-)

📖 Nếu bạn có một số ý tưởng để tối ưu hóa hoặc các tính năng mới được sử dụng, bạn có thể sử dụng nó hoặc Email Truyền thông phản hồi～～ 😄

😊 Sẽ có những tối ưu hóa bất thường trong tương lai~
