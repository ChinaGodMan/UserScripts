...
<!--HISTORY-->
<center><div align="center">
    <h1>Translation widget | Translate any language</h1>
...
## Fixed Google Translation failure problem，Now you can use Google to translate normally

### 💡 How to use（Very easy，Please see the picture！😊）[](#How to use（Very easy，Please see the picture！）)
...
-   Copy the translation to the clipboard instantly ✔️
-   One-click copy function ✔️

# \--------------------------------------------[](#-)

📖 If you have some ideas for optimization or new features in use, you are welcome to use it or Email Feedback Communication～～ 😄

😊 There will be irregular optimizations in the future~
...
[🧑‍💻 **@hdshing**](https://greasyfork.org/users/1288991) ⇒ 📜 _[Translation gadget | One-click translation of any language | Selected translation | You can expand the original translation comparison | Simple and effective](https://greasyfork.org/scripts/495393)_
<!--AUTHORS-END-->
<!--SCREENSHOT-->
