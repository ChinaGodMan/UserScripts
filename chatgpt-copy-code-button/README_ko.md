...
<center><div align="center">
    <h1>ChatGPT 채팅 사본 코드 및 내보내기 코드 버튼</h1>
    <p>「 존재하다 chatgpt.com 코드 블록의 오른쪽 하단에 애니메이션 추가“코드를 복사하십시오”버튼과 하나 ChatGPT 응답의 코드 블록에 내보내기 버튼 추가，사용자에게 코드 블록의 클래스 이름에서 감지 된 프로그래밍 언어를 기반으로 코드를 파일로 저장하라는 메시지가 표시됩니다.。 」</p>
    ...
    <p>Download:<a href="https://github.com/ChinaGodMan/UserScripts/tree/main/chatgpt-copy-code-button">Github</a> | ⭐<a
            ...
            Fork</a></p><details><summary>레코드 업데이트</summary><h1><strong>🛠️ ChatGPT 채팅 사본 코드 버튼 로그 업데이트</strong></h1>
<h3><strong>📅 2024-09-23 08:58:07- Ver 1.2.0.0</strong></h3>
<p><strong>수리하다</strong>: • 새로 보낸 콘텐츠는 버튼을 잘못 추가합니다,추가 할 때 요소에 다음 하위 요소가 존재하는지 확인하십시오.<code>querySelector('div.flex.items-center.text-token-text-secondary')</code>
...
<p><strong>새로운</strong>: •내보내기 코드에 버튼을 추가하십시오,새 코드는 스크립트에서 나옵니다 →<a href="https://greasyfork.org/zh-CN/scripts/499627"><strong>ChatGPT Code Export Button</strong></a></p>
<hr />
<h3><strong>📅 2024-09-22 07:06:07- Ver 1.0.0.0</strong></h3>
<p><strong>새로운</strong>: •새 버전과 호환됩니다 ChatGPT 공식 웹 사이트</p>
<hr /></details>
...
# ChatGPT Chat Copy Code Button 사용자 스크립트

## 소개하다

사용자 스크립트입니다 [chatgpt.com](https://chatgpt.com) 그리고 [share.nezhagpt.cloud](https://share.nezhagpt.cloud) 페이지에 코드 블록을 추가하십시오“코드를 복사하십시오”단추。버튼은 코드 블록의 오른쪽 하단에 있습니다.，애니메이션 효과로，사용자는 버튼을 쉽게 클릭하여 코드를 클립 보드에 복사 할 수 있습니다.。

## 기능

-   오른쪽 하단에 코드 블록을 추가하십시오“코드를 복사하십시오”단추
-   버튼을 클릭 한 후，코드는 클립 보드에 복사됩니다
-   버튼을 클릭 한 후 피드백 애니메이션이 있습니다，버튼이 표시됩니다“Copied!”힌트
-   마우스가 호버링 될 때 버튼 색상이 변경됩니다

## 시나리오를 사용하십시오

-   개발자는 코드 스 니펫을 쉽게 복사 할 수 있습니다
-   코드를 볼 때 학습자는 더 편리합니다
-   새로로드 된 코드 블록에 자동으로 사본 버튼을 관찰하고 추가합니다.

## 설치 단계

1. 사용자 스크립트를 지원하는 브라우저 확장자를 설치하십시오，예를 들어 [Tampermonkey](https://www.tampermonkey.net/) 또는 [Violentmonkey](https://violentmonkey.github.io/)。
2. 위의 녹색 버튼을 클릭하여 설치하십시오。

## 호환성

-   지원하다 Chrome、Firefox、Edge、Opera 그리고 Safari 주류 브라우저처럼

## 프로젝트 갤러리

-   [GitHub 프로젝트 갤러리](https://github.com/ChinaGodMan/UserScripts)
-   YodaBets

## 피드백 주소

-   질문이나 제안이있는 경우，다음 링크를 통해 피드백을 제공하십시오：[GitHub 피드백 주소](https://github.com/ChinaGodMan/UserScripts/issues)

## 기고자

-   [**YodaBets**](https://greasyfork.org/zh-CN/users/1052550) [OpenAI Chat Copy Code Button](https://greasyfork.org/zh-CN/scripts/463493) 이 스크립트를 수정했습니다
-   [**Muffin Productions**](https://greasyfork.org/zh-CN/users/1327919) [ChatGPT Code Export Button](https://greasyfork.org/zh-CN/scripts/499627) 이 스크립트 내로 내보내기 코드를 참조하십시오.
-   [**人民的勤务员**](https://greasyfork.org/zh-CN/users/1169082)

## 권한 부여

-   이 스크립트는 다음과 같습니다 MIT 라이센스 오픈 소스
