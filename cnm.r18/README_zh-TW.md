...
<div align="right">
    <h6>
        ...
        <a href="https://github.com/ChinaGodMan/UserScripts/blob/main/cnm.r18/README.md">简体中文</a> |
        <a href="https://github.com/ChinaGodMan/UserScripts/blob/main/cnm.r18/README_en.md">English</a> |
        <a href="https://github.com/ChinaGodMan/UserScripts/blob/main/cnm.r18/README_ko.md">한국어</a> |
        <a href="https://github.com/ChinaGodMan/UserScripts/blob/main/cnm.r18/README_vi.md">Tiếng Việt</a> |
        <a href="https://github.com/ChinaGodMan/UserScripts/blob/main/cnm.r18/README_zh-TW.md">繁體中文</a>
    <br>
...
<center><div align="center">
    <h1>剛滿 18 歲</h1>
    <p>「 因為我剛滿 18 歲,所以我可以看成人內容 」</p>
    <img src="https://views.whatilearened.today/views/github/537679/hmjz100.svg" alt="Views">
    <img src="https://img.shields.io/github/size/ChinaGodMan/UserScripts/cnm.r18/cnm.r18.user.js?color=%23990000">
    <img src="https://img.shields.io/greasyfork/dt/537679?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=%E7%94%A8%E6%88%B6%E6%95%B8%E9%87%8F">
    <img src="https://img.shields.io/badge/dynamic/json?&label=%E6%AF%8F%E6%97%A5%E6%AA%A2%E6%9F%A5%E6%9B%B4%E6%96%B0%E6%AC%A1%E6%95%B8&query=$.537679&logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&url=https://github.com/ChinaGodMan/UserScriptsHistory/raw/main/daily_update_checks.json">
    <p>Download:<a href="https://github.com/ChinaGodMan/UserScripts/tree/main/cnm.r18">Github</a> | ⭐<a
            href="https://greasyfork.org/scripts/537679">Greasy
            Fork</a></p><details><summary style="color:#FFD700">更新記錄</summary><div align="right"><a href="https://github.com/ChinaGodMan/UserScripts/tree/main/cnm.r18/CHANGELOG.md"><img src="https://img.shields.io/badge/-GitHub-3A3A3A?style=flat&logo=GitHub&logoColor=white"></a></div><h1><strong>🛠️ cnm.r18 更新日誌</strong></h1>
<h3><strong>📅 2025.6.2.1</strong></h3>
<p><strong>新增</strong>: •初始版本</p>
<hr /></details>
    <img src="https://raw.githubusercontent.com/ChinaGodMan/UserScriptsHistory/main/stats/537679.png">
</div></center>
...
用於自動處理需要年齡驗證的網站，通過點擊頁面上的驗證按鈕或自動添加必要的 URL 參數，幫助用戶無縫通過年齡驗證頁面，提升瀏覽體驗。

---

## 功能

### 1. 驗證按鈕點擊（`verifyButton`）

通過匹配網站域名和特定的 CSS 選擇器，自動點擊頁面上的年齡驗證按鈕。

#### 核心功能

- **配置規則**
    - 使用 `config` 對象定義支持的網站域名及其對應的按鈕選擇器。
    - 支持特定網站的動態處理（如 DLsite 和 animate-onlineshop.jp）。
- **多次驗證處理**

    - 針對部分需要每次訪問都驗證的網站（如 DLsite 的移動端版本），不保存驗證狀態。
