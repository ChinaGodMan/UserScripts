...
<!--HISTORY-->
<center><div align="center">
    <h1>Vừa mới 18 tuổi</h1>
    <p>「 Vì tôi mới tròn 18 tuổi, tôi có thể xem nội dung người lớn 」</p>
    ...
    <img src="https://img.shields.io/greasyfork/dt/537679?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=S%E1%BB%91%20l%C6%B0%E1%BB%A3ng%20ng%C6%B0%E1%BB%9Di%20d%C3%B9ng">
    <img src="https://img.shields.io/badge/dynamic/json?&label=C%E1%BA%ADp%20nh%E1%BA%ADt%20ki%E1%BB%83m%20tra%20h%C3%A0ng%20ng%C3%A0y&query=$.537679&logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&url=https://github.com/ChinaGodMan/UserScriptsHistory/raw/main/daily_update_checks.json">
    <p>Download:<a href="https://github.com/ChinaGodMan/UserScripts/tree/main/cnm.r18">Github</a> | ⭐<a
            ...
            Fork</a></p><details><summary style="color:#FFD700">Cập nhật hồ sơ</summary><div align="right"><a href="https://github.com/ChinaGodMan/UserScripts/tree/main/cnm.r18/CHANGELOG.md"><img src="https://img.shields.io/badge/-GitHub-3A3A3A?style=flat&logo=GitHub&logoColor=white"></a></div><h1><strong>🛠️ cnm.r18 Cập nhật nhật ký</strong></h1>
...
Được sử dụng để tự động xử lý các trang web yêu cầu xác minh tuổi，Bằng cách nhấp vào nút Xác minh trên trang hoặc tự động thêm cần thiết URL tham số，Giúp người dùng liên tục vượt qua trang xác minh tuổi，Cải thiện trải nghiệm duyệt web。

---

## Chức năng

### 1. Nhấp vào nút Xác minh（`verifyButton`）

Bằng cách khớp tên miền trang web và cụ thể CSS Người chọn，Tự động nhấp vào nút Xác minh tuổi trên trang。

#### Chức năng cốt lõi

- **Quy tắc cấu hình**
    - sử dụng `config` Định nghĩa đối tượng hỗ trợ tên miền trang web và bộ chọn nút tương ứng của chúng。
    - Hỗ trợ xử lý động các trang web cụ thể（giống DLsite Và animate-onlineshop.jp）。
- **Xử lý nhiều xác minh**

    - Đối với một số trang web cần được xác minh mỗi khi họ truy cập（giống DLsite Phiên bản di động），Không lưu trạng thái xác minh。

- **Tự động nhấp vào logic**
    - Khớp tên miền và đường dẫn của trang web hiện tại。
    - Tìm bộ chọn tương ứng dựa trên kết quả phù hợp và tự động nhấp vào。
