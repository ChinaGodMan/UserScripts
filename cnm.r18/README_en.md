...
<!--HISTORY-->
<center><div align="center">
    <h1>Just turned 18 years old</h1>
    <p>「 Since I just turned 18, I can watch adult content 」</p>
    ...
    <img src="https://img.shields.io/greasyfork/dt/537679?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=Number%20of%20users">
    <img src="https://img.shields.io/badge/dynamic/json?&label=Daily%20check%20updates&query=$.537679&logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&url=https://github.com/ChinaGodMan/UserScriptsHistory/raw/main/daily_update_checks.json">
    <p>Download:<a href="https://github.com/ChinaGodMan/UserScripts/tree/main/cnm.r18">Github</a> | ⭐<a
            ...
            Fork</a></p><details><summary style="color:#FFD700">Update records</summary><div align="right"><a href="https://github.com/ChinaGodMan/UserScripts/tree/main/cnm.r18/CHANGELOG.md"><img src="https://img.shields.io/badge/-GitHub-3A3A3A?style=flat&logo=GitHub&logoColor=white"></a></div><h1><strong>🛠️ cnm.r18 Update log</strong></h1>
...
Used to automatically process websites that require age verification，By clicking the Verification button on the page or automatically adding the necessary URL parameter，Help users seamlessly pass the age verification page，Improve browsing experience。

---

## Function

### 1. Click on the verification button（`verifyButton`）

By matching the website domain name and specific CSS Selector，Automatically click on the age verification button on the page。

#### Core functions

- **Configuration rules**
    - use `config` Object definition supports website domain names and their corresponding button selectors。
    - Support dynamic processing of specific websites（like DLsite and animate-onlineshop.jp）。
- **Multiple verification processing**

    - For some websites that need to be verified every time they visit（like DLsite Mobile version），No verification status saved。

- **Automatic click logic**
    - Match the domain name and path of the current website。
    - Find the corresponding selector based on the matching result and click automatically。
