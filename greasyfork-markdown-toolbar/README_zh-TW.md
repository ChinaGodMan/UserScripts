...
<center><div align="center">
    ...
    <img src="https://img.shields.io/greasyfork/dt/505164?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=%E7%94%A8%E6%88%B6%E6%95%B8%E9%87%8F">
    <img src="https://img.shields.io/badge/dynamic/json?&label=%E6%AF%8F%E6%97%A5%E6%AA%A2%E6%9F%A5%E6%9B%B4%E6%96%B0%E6%AC%A1%E6%95%B8&query=$.505164&logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&url=https://github.com/ChinaGodMan/UserScriptsHistory/raw/main/daily_update_checks.json">
...
<p><strong>新增</strong>: 谷歌快速翻譯選中的文本到英格里斯<br>可在腳本設置翻譯到語言:<code>var translate = "en"</code>.</p>
...
<ul>
<li><code>DOMContentLoaded</code> 有時會與其他腳本衝突，導致監聽失敗。已更改為 <code>load</code></li>
</ul>
<hr /></details>
...
該腳本是[此腳本](https://greasyfork.org/en/scripts/6779-markdown-toolbar-for-gf-and-uso/code?version=179573)的分支，由 wOxxOm 編寫，適用於新的 GreasyFork 佈局。  
感謝他製作瞭如此重要的腳本。

-   常用格式按鈕（僅 Markdown）
-   (論壇) HTML 和 Markdown 格式幫助鏈接
-   CODE 按鈕：在選中文本前後添加 `` 或 ```（多行文本時）
-   新評論默認使用 MARKDOWN 格式 - 也可以在您的個人資料設置中進行更改。

原始 Tampermonkey 和 Violentmonkey 上測試通過。  
不支持任何版本的 Greasemonkey（腳本可能會運行，但未測試）。

**注意事項：**

-   如果您遇到腳本問題，請在[倉庫](https://github.com/darkred/Userscripts/issues)報告，始終歡迎 PR。
-   請注意，我不是腳本的原作者：  
    我的目標是讓該腳本在新的 GF 佈局上恢復功能。這就是全部。
-   `.markup_choice` 單選按鈕是網站的元素，而不是腳本的！  
    ![markup_choice](https://i.imgur.com/fUkqf9I.jpg)
-   已知問題：
    -   目前用於切換到預覽標籤時隱藏工具欄的方法有缺陷：  
        有時工具欄可能不會隱藏，也可能在切換回時無法恢復。  
        工具欄的隱藏時間也早於預期：在點擊預覽時立即隱藏，而不是在預覽標籤獲得焦點時。

**修改內容：**
[GreasyFork markdown](https://greasyfork.org/scripts/422887)

-   2024-08-04T08:59:11 `DOMContentLoaded` 有時與其他腳本衝突，導致監聽器失效。更改為 `load`。

**截圖：**（見附件）

如果您有任何 bug、修復建議或想法，請在我的 [GitHub 倉庫](https://github.com/darkred/Userscripts)報告

![tl.gif](https://s2.loli.net/2024/10/02/oI7mw3JLyzKCDRc.gif)  
![截圖1](https://greasyfork.s3.us-east-2.amazonaws.com/mjjezdy220vguyllvmpsgpfjqpz8)  
![截圖2](https://greasyfork.s3.us-east-2.amazonaws.com/asth9x7akm7goqddr5u0f7uia92k)  
![截圖3](https://greasyfork.s3.us-east-2.amazonaws.com/0imd0nxmpd0jztoqhgionebw4jfi)  
![截圖4](https://greasyfork.s3.us-east-2.amazonaws.com/u3fgy6vyn01419tqb3zvd9h96bue)
