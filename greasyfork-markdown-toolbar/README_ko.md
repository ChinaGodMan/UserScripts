...
<center><div align="center">
    ...
    <p>Download:<a href="https://github.com/ChinaGodMan/UserScripts/tree/main/greasyfork-markdown-toolbar">Github</a> | ⭐<a
            ...
            Fork</a></p><details><summary>레코드 업데이트</summary><div align="right"><a href="https://github.com/ChinaGodMan/UserScripts/tree/main/greasyfork-markdown-toolbar/CHANGELOG.md"><img height="32" src="https://github.githubassets.com/pinned-octocat.svg"></a></div><h1><strong>🛠️ GreasyFork Markdown Toobar 로그 업데이트</strong></h1>
...
<p><strong>새로운</strong>: <kbd>Ctrl</kbd>+<kbd>Q</kbd>선택한 텍스트의 빠른 번역<br></p>
<hr />
<h3><strong>📅 2024-10-02 - Ver: 2.0.5</strong></h3>
<p><strong>새로운</strong>: Google Quick은 선택한 텍스트를 Ingris로 번역합니다<br>언어로 번역은 스크립트로 설정할 수 있습니다:<code>var translate = "en"</code>.</p>
<p><img alt="tl.gif" src="https://s2.loli.net/2024/10/02/oI7mw3JLyzKCDRc.gif" /></p>
<hr />
<h3><strong>📅 2024-08-04 - Ver: 2.0.4</strong></h3>
<p><strong>개정하다</strong>: <a href="https://greasyfork.org/zh-CN/scripts/422887">GreasyFork markdown</a></p>
<ul>
<li><code>DOMContentLoaded</code> 때로는 다른 스크립트와 충돌합니다，청취 실패를 유발합니다。변경되었습니다 <code>load</code></li>
</ul>
<hr /></details>
...
스크립트입니다[이 스크립트](https://greasyfork.org/en/scripts/6779-markdown-toolbar-for-gf-and-uso/code?version=179573)지점，의존합니다 wOxxOm 쓰다，신규에 적합합니다 GreasyFork 공들여 나열한 것。  
그런 중요한 대본을 만들어 주셔서 감사합니다。

-   일반적인 형식 버튼（오직 Markdown）
-   (법정) HTML 그리고 Markdown 형식 헬프 링크
-   CODE 단추：텍스트를 선택하기 전후에 추가하십시오 `` 또는 ```（여러 줄의 텍스트 일 ​​때）
-   새로운 주석은 기본적으로 사용됩니다 MARKDOWN 체재 - 프로필 설정을 변경할 수도 있습니다。

스크립트입니다 Tampermonkey 그리고 Violentmonkey 테스트를 통과했습니다。  
버전은 지원되지 않습니다 Greasemonkey（스크립트가 실행될 수 있습니다，그러나 테스트되지 않았습니다）。

**주목해야 할 것：**

-   스크립트 문제가있는 경우，제발[창고](https://github.com/darkred/Userscripts/issues)보고서，항상 환영합니다 PR。
-   참고하십시오，나는 대본의 원래 저자가 아닙니다：  
    내 목표는 새로운 대본을 얻는 것입니다. GF 레이아웃시 복구 기능。이것이 전부입니다。
-   `.markup_choice` 라디오 버튼은 웹 사이트의 요소입니다，스크립트가 아닙니다！  
    ![markup_choice](https://i.imgur.com/fUkqf9I.jpg)
-   알려진 문제：
    -   현재 미리보기 탭으로 전환 할 때 툴바를 숨기는 데 현재 사용됩니다.：  
        때로는 도구 모음이 숨겨져 있지 않을 수 있습니다，뒤로 전환 할 때 회복 할 수 없을 수도 있습니다.。  
        도구 모음은 예상보다 일찍 숨겨져 있습니다：미리보기를 클릭하면 즉시 숨기십시오，미리보기 태그에 집중하는 대신。

**컨텐츠를 수정하십시오：**
[GreasyFork markdown](https://greasyfork.org/scripts/422887)

-   2024-08-04T08:59:11 `DOMContentLoaded` 때로는 다른 스크립트와 충돌합니다，청취자가 실패하게합니다。변경 `load`。

**스크린 샷：**（첨부 파일을 참조하십시오）

당신이있는 경우 bug、제안 또는 아이디어를 수리하십시오，제발 제발 [GitHub 창고](https://github.com/darkred/Userscripts)보고서

![tl.gif](https://s2.loli.net/2024/10/02/oI7mw3JLyzKCDRc.gif)  
![스크린 샷1](https://greasyfork.s3.us-east-2.amazonaws.com/mjjezdy220vguyllvmpsgpfjqpz8)  
![스크린 샷2](https://greasyfork.s3.us-east-2.amazonaws.com/asth9x7akm7goqddr5u0f7uia92k)  
![스크린 샷3](https://greasyfork.s3.us-east-2.amazonaws.com/0imd0nxmpd0jztoqhgionebw4jfi)  
![스크린 샷4](https://greasyfork.s3.us-east-2.amazonaws.com/u3fgy6vyn01419tqb3zvd9h96bue)
