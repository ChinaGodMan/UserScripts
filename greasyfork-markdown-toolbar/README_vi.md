...
<center><div align="center">
    ...
    <img src="https://img.shields.io/greasyfork/dt/505164?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=S%E1%BB%91%20l%C6%B0%E1%BB%A3ng%20ng%C6%B0%E1%BB%9Di%20d%C3%B9ng">
    <img src="https://img.shields.io/badge/dynamic/json?&label=C%E1%BA%ADp%20nh%E1%BA%ADt%20ki%E1%BB%83m%20tra%20h%C3%A0ng%20ng%C3%A0y&query=$.505164&logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&url=https://github.com/ChinaGodMan/UserScriptsHistory/raw/main/daily_update_checks.json">
...
<p><strong>Mới</strong>: Google nhanh chóng dịch văn bản đã chọn sang Ingris<br>Dịch sang ngôn ngữ có thể được đặt trong tập lệnh:<code>var translate = "en"</code>.</p>
<p><img alt="tl.gif" src="https://s2.loli.net/2024/10/02/oI7mw3JLyzKCDRc.gif" /></p>
<hr />
<h3><strong>📅 2024-08-04 - Ver: 2.0.4</strong></h3>
<p><strong>Ôn lại</strong>: <a href="https://greasyfork.org/zh-CN/scripts/422887">GreasyFork markdown</a></p>
<ul>
<li><code>DOMContentLoaded</code> Đôi khi nó xung đột với các tập lệnh khác，Gây ra thất bại nghe。Đổi thành <code>load</code></li>
</ul>
<hr /></details>
...
Kịch bản là[Kịch bản này](https://greasyfork.org/en/scripts/6779-markdown-toolbar-for-gf-and-uso/code?version=179573)nhánh của，Phụ thuộc vào wOxxOm viết，Thích hợp cho mới GreasyFork cách trình bày。  
Cảm ơn vì đã tạo ra một kịch bản quan trọng như vậy。

-   Các nút định dạng phổ biến（chỉ một Markdown）
-   (Diễn đàn) HTML Và Markdown Định dạng liên kết trợ giúp
-   CODE Cái nút：Thêm trước và sau khi chọn văn bản `` hoặc ```（Khi nhiều dòng văn bản）
-   Nhận xét mới được sử dụng theo mặc định MARKDOWN Định dạng - Bạn cũng có thể thực hiện các thay đổi trong cài đặt hồ sơ của mình。

Kịch bản là Tampermonkey Và Violentmonkey Đã vượt qua bài kiểm tra。  
Không có phiên bản nào được hỗ trợ Greasemonkey（Tập lệnh có thể chạy，Nhưng không được kiểm tra）。

**Những điều cần lưu ý：**

-   Nếu bạn gặp sự cố tập lệnh，Vui lòng[Nhà kho](https://github.com/darkred/Userscripts/issues)Báo cáo，Luôn luôn được chào đón PR。
-   Xin lưu ý，Tôi không phải là tác giả gốc của kịch bản：  
    Mục tiêu của tôi là có được kịch bản trong GF Chức năng phục hồi trên bố cục。Đây là tất cả。
-   `.markup_choice` Các nút radio là các yếu tố của trang web，Không có kịch bản！  
    ![markup_choice](https://i.imgur.com/fUkqf9I.jpg)
-   Các vấn đề đã biết：
    -   Hiện được sử dụng để ẩn thanh công cụ khi chuyển sang tab xem trước bị thiếu sót：  
        Đôi khi thanh công cụ có thể không bị ẩn，Nó cũng có thể không thể phục hồi khi chuyển đổi lại。  
        Thanh công cụ cũng được ẩn sớm hơn dự kiến：Ẩn ngay khi nhấp vào Xem trước，Thay vì tập trung vào thẻ xem trước。

**Sửa đổi nội dung：**
[GreasyFork markdown](https://greasyfork.org/scripts/422887)

-   2024-08-04T08:59:11 `DOMContentLoaded` Đôi khi xung đột với các tập lệnh khác，Khiến người nghe thất bại。Thay đổi thành `load`。

**Ảnh chụp màn hình：**（Xem tệp đính kèm）

Nếu bạn có bất kỳ bug、Đề xuất hoặc ý tưởng sửa chữa，Xin vui lòng trong của tôi [GitHub Nhà kho](https://github.com/darkred/Userscripts)Báo cáo

![tl.gif](https://s2.loli.net/2024/10/02/oI7mw3JLyzKCDRc.gif)  
![Ảnh chụp màn hình1](https://greasyfork.s3.us-east-2.amazonaws.com/mjjezdy220vguyllvmpsgpfjqpz8)  
![Ảnh chụp màn hình2](https://greasyfork.s3.us-east-2.amazonaws.com/asth9x7akm7goqddr5u0f7uia92k)  
![Ảnh chụp màn hình3](https://greasyfork.s3.us-east-2.amazonaws.com/0imd0nxmpd0jztoqhgionebw4jfi)  
![Ảnh chụp màn hình4](https://greasyfork.s3.us-east-2.amazonaws.com/u3fgy6vyn01419tqb3zvd9h96bue)
