...
<center><div align="center">
    <h1>網頁高亮關鍵字</h1>
    <p>「 對網頁上的文字進行高亮顯示，如果對你有幫助，可以隨意修改使用 」</p>
    ...
    <img src="https://img.shields.io/greasyfork/dt/498906?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=%E7%94%A8%E6%88%B6%E6%95%B8%E9%87%8F">
    <img src="https://img.shields.io/badge/dynamic/json?&label=%E6%AF%8F%E6%97%A5%E6%AA%A2%E6%9F%A5%E6%9B%B4%E6%96%B0%E6%AC%A1%E6%95%B8&query=$.498906&logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&url=https://github.com/ChinaGodMan/UserScriptsHistory/raw/main/daily_update_checks.json">
...
# 原作者發布頁[ mabangde](https://greasyfork.org/zh-CN/scripts/465200)

<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">

## 腳本功能

對網頁上的文字進行高亮顯示，如果對你有幫助，可以隨意修改使用。
<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">

## UI 說明

1. **第一欄：網頁限制**
    - 可以指定在哪些網頁上起作用，比如 `bilibili`, `baidu`, `bilibili.com`
    - 輸入網址的一部分或者全部。每一個網址用空格隔開
    - 如果什麼都不輸入，那麼就會作用到所有網站上
2. **第二欄：分類信息**
    - 鼠標移動到對應的關鍵字上會顯示你輸入的內容
3. **第三欄：關鍵字欄**
    - 輸入你想要高亮的詞，空格隔開
      <img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">
