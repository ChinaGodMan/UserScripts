...
<center><div align="center">
    <h1>Đánh dấu các từ khóa trên web</h1>
    <p>「 Đánh dấu văn bản trên trang web，Nếu nó giúp bạn，Có thể được sửa đổi và sử dụng theo ý muốn 」</p>
...
# Trang phát hành gốc của tác giả[ mabangde](https://greasyfork.org/zh-CN/scripts/465200)

<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">

## Chức năng kịch bản

Đánh dấu văn bản trên trang web，Nếu nó giúp bạn，Có thể được sửa đổi và sử dụng theo ý muốn。
<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">

## UI minh họa

1. **Cột 1：Hạn chế trang web**
    - Bạn có thể chỉ định trang web nào hoạt động，Ví dụ `bilibili`, `baidu`, `bilibili.com`
    - Nhập phần hoặc tất cả các URL。Mỗi URL được phân tách bằng khoảng trắng
    - Nếu bạn không gõ bất cứ thứ gì，Sau đó, nó sẽ hoạt động trên tất cả các trang web
2. **Cột 2：Thông tin phân loại**
    - Di chuyển chuột đến từ khóa tương ứng và hiển thị nội dung bạn đã nhập.
3. **Cột 3：Thanh từ khóa**
    - Nhập các từ bạn muốn làm nổi bật，Không gian tách biệt
      <img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">
...
Cài đặt đầu tiên sẽ thêm một số thử nghiệm quy tắc theo mặc định，Có thể bị xóa。
...
### 2024 Năm 6 mặt trăng 26 ngày

-   Đảm bảo rằng màn hình có thể được điều chỉnh trên các thiết bị di động
-   Đã thêm hỗ trợ để thiết lập màu văn bản（Bộ chọn màu thứ hai）
