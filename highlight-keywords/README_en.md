...
<center><div align="center">
    ...
    <img src="https://img.shields.io/greasyfork/dt/498906?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=Number%20of%20users">
...
# Original author’s release page[ mabangde](https://greasyfork.org/zh-CN/scripts/465200)

<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">

## Scripting functions

Highlight text on the web page，If it helps you，Can be modified and used at will。
<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">

## UI illustrate

1. **Column 1：Web page restrictions**
    - You can specify which web pages work on，for example `bilibili`, `baidu`, `bilibili.com`
    - Enter part or all of the URL。Each URL is separated by spaces
    - If you don’t type anything，Then it will work on all websites
2. **Column 2：Classified information**
    - Move the mouse to the corresponding keyword and display the content you entered.
3. **Column 3：Keyword bar**
    - Enter the words you want to highlight，Spaces separated
      <img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">
...
The first installation will add some rules tests by default，Can be deleted。
...
### 2024 Year 6 moon 26 day

-   Ensure that the screen can be adapted to on mobile devices
-   Added support for setting text color（The second color selector）
