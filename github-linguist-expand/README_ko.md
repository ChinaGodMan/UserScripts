...
<!--HISTORY-->
<center><div align="center">
    <h1>Github 코드 언어 목록 모두 표시</h1>
    <p>「 확장하다 Github 저장소의 언어 목록，각 언어 표시，작은 부품을 숨기는 것보다“다른”아래에 」</p>
    ...
    <img src="https://img.shields.io/greasyfork/dt/509889?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=%EC%82%AC%EC%9A%A9%EC%9E%90%20%EC%88%98">
    <img src="https://img.shields.io/badge/dynamic/json?&label=%EB%A7%A4%EC%9D%BC%20%ED%99%95%EC%9D%B8%20%EC%97%85%EB%8D%B0%EC%9D%B4%ED%8A%B8&query=$.509889&logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&url=https://github.com/ChinaGodMan/UserScriptsHistory/raw/main/daily_update_checks.json">
    <p>Download:<a href="https://github.com/ChinaGodMan/UserScripts/tree/main/github-linguist-expand">Github</a> | ⭐<a
            ...
            Fork</a></p><details><summary style="color:#FFD700">레코드 업데이트</summary><div align="right"><a href="https://github.com/ChinaGodMan/UserScripts/tree/main/github-linguist-expand/CHANGELOG.md"><img src="https://img.shields.io/badge/-GitHub-3A3A3A?style=flat&logo=GitHub&logoColor=white"></a></div><h1><strong>🛠️ Github 코드 언어 목록이 모두 표시됩니다 로그 업데이트</strong></h1>
<h3><strong>📅 2024-10-19 07:36:03- Ver 1.1.0.0</strong></h3>
<p><strong>수리하다</strong>: •같은 창고를 전환하십시오<code>꼬리표</code>이어<code>URL</code>변화,반복 된 추가<br></p>
<h3><strong>📅 2024-09-24 04:33:03- Ver 1.0.0.0</strong></h3>
<p><strong>수리하다</strong>: •요소 실패 문제를 해결하십시오<br>
<strong>새로운</strong>: •설정을 허용합니다 Token 자신의 개인 창고를 방문하십시오<br>
<strong>새로운</strong>: •다른 저장소로 점프 할 수 있습니다,자동으로 추가합니다.<br></p>
<hr /></details>
...
## Github 코드 언어 목록에는 모든 스크립트가 표시됩니다

이 스크립트는 확장하는 데 사용됩니다 Github 코드 언어 목록，모든 언어를 보여주십시오，작은 부품을 숨기는 대신“다른”아래에。사용자는 코드 기반에 사용 된 모든 언어와 해당 비율을 볼 수 있습니다.，설정을 제공합니다 GitHub Token 개인 라이브러리에 액세스하는 기능。

### 설치 단계

**설정 Github Token**：

-   자신의 개인 저장소에 액세스 해야하는 경우,입력 할 수 있습니다 GitHub 개인 액세스 토큰（Personal Access Token）。
-   그렇지 않다면 Token，가십시오 [GitHub Token 페이지를 생성하십시오](https://github.com/settings/tokens/new?description=GitHub-Linguist-Expand-UserScript&scopes=repo) 새로운 것을 만듭니다 Token，그리고 그것을 확인하십시오“repo”권한。

    **사용 방법**：

-   설치 후，하나를 입력하십시오 GitHub 창고 페이지，스크립트는 사용 된 모든 언어와 페이지에 비율을 자동으로 표시합니다.。
-   언어 표시 줄에서 언어 이름을 클릭하십시오，언어의 해당 코드 섹션을 볼 수 있습니다.。

### 스크립팅 기능

-   **모든 언어를 보여줍니다**：  
    기본적으로，GitHub 주요 언어 만 보여줍니다，소량의 언어를 그대로 분류합니다“다른”。이 스크립트는이 제한을 제거합니다，사용 된 각 언어와 해당 비율을 표시하십시오。

-   **언어 색상 로고**：  
    각 언어에는 해당 색상 로고가 있습니다，스크립트가 통과되었습니다 GitHub 공식적인 [언어 색상 테이블](https://github.com/github/linguist) 언어의 색상을 결정합니다，페이지에 표시하십시오。

-   **다국어를 지원합니다**：  
    스크립트는 여러 언어를 지원합니다，중국어 포함、영어、독일 사람、스페인어 등，인터페이스 컨텐츠는 사용자의 브라우저 언어에 따라 자동으로 전환됩니다.。

### 예

코드 기본 페이지에서，다음 디스플레이를 볼 수 있습니다：

-   완전한 언어 막대 차트，각 언어의 비율을 보여줍니다。
-   각 언어에 대한 화려한 로고，언어 이름을 클릭하여 언어 코드를 직접 검색하십시오.。

### 프로젝트 갤러리

-   [Github 사용자 스크립트 저장소](https://github.com/ChinaGodMan/UserScripts)
-   이 스크립트의 문제를보고하거나 새로운 기능을 제안하려면，제발[여기](https://github.com/ChinaGodMan/UserScripts/issues)새로운 질문을 만드십시오

### 기고자

-   [Davoleo](https://greasyfork.org/zh-CN/users/857225) [Linguist Expand](https://greasyfork.org/scripts/442856) 대본의 초기 제작자.

### 기술적 인 세부 사항

-   **API 사용**：  
    스크립트가 통과됩니다 GitHub API 창고의 언어 정보를 얻으십시오，언어 막대 차트 및 언어 태그를 동적으로 렌더링합니다。
-   **호환성**：  
    이 스크립트는 주류 브라우저와 호환됩니다，포함하다 Chrome、Firefox、Edge、Opera 그리고 Safari。
