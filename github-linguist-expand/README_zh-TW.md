...
<center><div align="center">
    ...
    <img src="https://img.shields.io/greasyfork/dt/509889?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=%E7%94%A8%E6%88%B6%E6%95%B8%E9%87%8F">
...
<p><strong>修復</strong>: •修復元素失效問題<br>
<strong>新增</strong>: •允許設置 Token 訪問自己的私人倉庫<br>
<strong>新增</strong>: •允許在跳轉其他倉庫時,自動添加.<br></p>
<hr /></details>
...
該腳本用於擴展 Github 上的代碼語言列表，展示每一種語言，而不是將小部分隱藏在“其他”下方。它允許用戶查看代碼庫中所有使用的語言及其對應的百分比，並提供設置 GitHub Token 以訪問私有庫的功能。

### 安裝步驟

**環境 Github Token**：

-   如果你需要訪問自己的私人倉庫,可以輸入 GitHub 的個人訪問令牌（Personal Access Token）。
-   如果你沒有 Token，請前往 [GitHub Token 生成頁面](https://github.com/settings/tokens/new?description=GitHub-Linguist-Expand-UserScript&scopes=repo) 創建一個新的 Token，並確保勾選“repo”權限。

    **使用方法**：

-   安裝後，進入任意一個 GitHub 倉庫頁面，腳本會自動在頁面上顯示所有使用的語言和它們的百分比。
-   在語言欄中點擊任意語言名稱，即可查看該語言對應的代碼部分。

### 腳本功能

-   **展示所有語言**：  
    默認情況下，GitHub 只顯示主要的語言，並將小比例的語言歸類為“其他”。該腳本會取消這種限制，顯示每個使用的語言以及其對應的百分比。

-   **語言顏色標識**：  
    每種語言都有一個對應的顏色標識，腳本通過 GitHub 官方的 [語言顏色表](https://github.com/github/linguist) 來確定語言的顏色，並在頁面上顯示。

-   **支持多語言**：  
    腳本支持多種語言，包括中文、英語、德文、西班牙文等，界面內容會根據用戶的瀏覽器語言自動切換。
...
-   一個完整的語言條形圖，顯示各語言的佔比。
-   每種語言的彩色標識，點擊語言名稱可以直接搜索該語言的代碼。

### 項目地址

-   [Github 用戶腳本倉庫](https://github.com/ChinaGodMan/UserScripts)
-   如果您想報告此腳本的問題或建議新功能，請在[此處](https://github.com/ChinaGodMan/UserScripts/issues)創建新問題

### 貢獻者

-   [Davoleo](https://greasyfork.org/zh-CN/users/857225) [Linguist Expand](https://greasyfork.org/scripts/442856) 腳本的初始創建者.

### 技術細節

-   **API 使用**：  
    該腳本通過 GitHub API 來獲取倉庫的語言信息，並動態渲染語言條形圖和語言標籤。
-   **相容性**：  
    該腳本兼容主流瀏覽器，包括 Chrome、Firefox、Edge、Opera 和 Safari。
