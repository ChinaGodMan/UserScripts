[English](/en/scripts/497346 "Greasyfork Utility Toolkit") | **Tiếng Trung giản thể** | [truyền thống Trung Quốc](/zh-TW/scripts/497346 "Greasyfork Utility Toolkit") | [tiếng Nhật](/ja/scripts/497346 "Greasyfork Utility Toolkit") | [한국어](/ko/scripts/497346 "Greasyfork Utility Toolkit")

# [![Gmail](https://img.shields.io/badge/Contact-Gmail-yellow?svg&)](mailto:toniaiwanowskiskr47@gmail.com)Người dân/UserScripts
...
![star](https://img.shields.io/github/forks/10086100886/UserScripts?svg&style=flat-square&label=Fork&color=4285dd&logo=github" "Số lượng nhân rộng")
![COM](https://img.shields.io/badge/CopyRight-Người dân-4285dd" "Người dân为人民服务")
...
vì Greasyfork Cung cấp các chức năng sử dụng khác nhau，Thời gian tuyệt đối，Màn hình chiều rộng web，Kịch bản nâng cao trang，Tải xuống và mở rộng，Một loạt các hoạt động như sửa chữa bảng điều khiển。Kịch bản được thu thập từ trang web。
...
![Greasy Fork Version](https://img.shields.io/greasyfork/v/497346?color=%23990000)
  ...
  <p><a href="#:~:text=Cập nhật thông tin">Kiểm traGreasyfork Bản ghi bản cập nhật phiên bản của Pasters</a></p>

---

<details>
    <summary><mark style="background-color: rgb(17, 0, 255); color: rgb(122, 11, 39);">Người dân góc của hội đồng</mark></summary>
    <table>
        <thead>
            <tr>
                <th>Tên tập lệnh</th>
        ...
        <tbody>
            <tr>
                <td><a href="/zh-CN/scripts/497346" target="_blank"><strong>Greasyfork Khảm</strong></a></td>
                <td>Nâng caogreasyfork,Sao chép mã，Tải xuống tập lệnh，Thời gian chính xác đến giây，Làm sạch trang chủ，Thảo luận về một báo cáo，Danh sách tập lệnh mã nhảy thêm tải xuống 美化查看代码显示代码引用文件，显示脚本图标，Nhảy vào tập lệnh dành cho người lớn và các hoạt động khác</td>
                <td><a
            ...
            <tr>
                ...
                <td>禁止网页向剪辑版拉屎，绿色为放行，Màu đỏ，Hướng dẫn tạm thời màu cam</td>
                <td><a
            ...
            <tr>
                ...
                <td><a href="/zh-CN/scripts/497317" target="_blank"><strong>GreasyforkChi tiết phù hợp để mở</strong></a></td>
                <td>Chi tiết kịch bản Tăng trang phù hợp để tăng liên kết.，点击复制</td>
                <td><a
            ...
            <tr>
                ...
                <td><a href="/zh-CN/scripts/497682" target="_blank"><strong>MissavTrợ lý sao lưu</strong></a></td>
...
- 2024/7/13 2.2.0.5
  ...
  - Khắc phục trạng thái cài đặt của tập lệnh trên danh sách hiển thị
  - Cải thiện sự hỗ trợ cho đa ngôn ngữ


---

<p><a href="https://github.com/10086100886/UserScripts"><strong>Nhiều tập lệnh người dùng hơn</strong></a> /
<a href="#">Quay lại đầu↑</a></p>
