...
### Chinese (Simplified) / ĉinoj（Simpligita）
Ĉi tiu uzantskripto forigas ligilojn en ĉiuj retejoj，kaj pritrakti novajn ligilojn dinamike。Ĝi certigas pli puran kaj videre allogan retumadan sperton。

### Chinese (Traditional) / ĉinoj（Tradicia ĉino）
Ĉi tiu uzantskripto forigas ligilsubtekstojn de ĉiuj retejoj，kaj dinamike trakti novajn ligilojn。Ĝi certigas pli puran kaj videre allogan retumadan sperton。
...
### Japanese / Japanoj
このユーザースクリプトは、arbitraのWebサイトsuperaのすべてのリンクのeksterreteをforigiし、novaしいリンクをmoveblaにprocezoします。これにより、よりクリーンでvidaにĈarmoなブラウジングspertoがgarantioされます。
...
## Author
servantoj de la popolo (Servant of the People) & ChatGPT
