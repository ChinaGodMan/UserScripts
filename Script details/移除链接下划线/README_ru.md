...
Этот пользовательский скрипт удаляет подчеркивание ссылок на всех веб-сайтах.，и динамически обрабатывать новые ссылки。Это обеспечивает более чистый и визуально привлекательный просмотр.。

### Chinese (Traditional) / Китайский（Традиционный китайский）
Этот пользовательский скрипт удаляет субтитры ссылок со всех сайтов.，и динамически обрабатывать новые ссылки。Это обеспечивает более чистый и визуально привлекательный просмотр.。
...
### Japanese / Японский
このユーザースクリプトは、произвольныйのWebサイトначальствоのすべてのリンクのне в сетиをудалитьし、новыйしいリンクをподвижныйにпроцессします。これにより、よりクリーンでвизуальныйにОчарованиеなブラウジングопытがгарантияされます。
...
## Author
слуги народа (Servant of the People) & ChatGPT
