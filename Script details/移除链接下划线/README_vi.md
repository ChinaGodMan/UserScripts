...
### Chinese (Simplified) / người Trung Quốc（giản thể）
Userscript này loại bỏ gạch chân liên kết trên tất cả các trang web，và xử lý các liên kết mới một cách linh hoạt。Nó đảm bảo trải nghiệm duyệt web sạch hơn và hấp dẫn hơn。

### Chinese (Traditional) / người Trung Quốc（Truyền thống Trung Quốc）
Tập lệnh người dùng này xóa phụ đề liên kết khỏi tất cả các trang web，và xử lý động các liên kết mới。Nó đảm bảo trải nghiệm duyệt web sạch hơn và hấp dẫn hơn。
...
### Japanese / tiếng Nhật
このユーザースクリプトは、Bất kỳのWebサイトthượng đẳngのすべてのリンクのngoại tuyếnをxóa bỏし、mớiしいリンクをcó thể di chuyểnにquá trìnhします。これにより、よりクリーンでthị giácにQuyến rũなブラウジングkinh nghiệmがbảo đảmされます。
...
## Author
đầy tớ của nhân dân (Servant of the People) & ChatGPT
