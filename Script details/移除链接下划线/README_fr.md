...
Ce script utilisateur supprime les liens soulignés sur tous les sites Web，et gérer les nouveaux liens de manière dynamique。Il garantit une expérience de navigation plus propre et plus attrayante visuellement。

### Chinese (Traditional) / Chinois（Chinois traditionnel）
Ce script utilisateur supprime les sous-titres des liens de tous les sites，et gérer dynamiquement les nouveaux liens。Il garantit une expérience de navigation plus propre et plus attrayante visuellement。
...
### Japanese / Japonais
このユーザースクリプトは、arbitraireのWebサイトsupérieurのすべてのリンクのhors ligneをsupprimerし、nouveauしいリンクをmobileにprocessusします。これにより、よりクリーンでvisuelにCharmeなブラウジングexpérienceがgarantieされます。
...
## Author
serviteurs du peuple (Servant of the People) & ChatGPT
