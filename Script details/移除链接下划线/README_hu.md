...
Ez a felhasználói szkript eltávolítja a hivatkozás aláhúzásokat minden webhelyről，és dinamikusan kezeli az új hivatkozásokat。Tisztább és látványosabb böngészési élményt biztosít。

### Chinese (Traditional) / kínai（Tradicionális kínai）
Ez a felhasználói szkript eltávolítja a link-feliratokat az összes webhelyről，és dinamikusan kezeli az új hivatkozásokat。Tisztább és látványosabb böngészési élményt biztosít。
...
### Japanese / japán
このユーザースクリプトは、tetszőlegesのWebサイトkiválóのすべてのリンクのoffline módbanをtörölし、újしいリンクをmozgathatóにfolyamatします。これにより、よりクリーンでvizuálisにBájなブラウジングtapasztalatがgaranciaされます。
...
## Author
a nép szolgái (Servant of the People) & ChatGPT
