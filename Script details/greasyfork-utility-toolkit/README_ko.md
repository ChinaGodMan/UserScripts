...
<center><div align="center"><sub>⭐<a href="https://github.com/ChinaGodMan/UserScripts" target="_blank" style="color: #556B2F; background-color: pink;">스크립트가 도움이 된다면,별을 밝히기 위해 빛을 낼 수 있다d장려하다</a>⭐</sub></div></center>
</div></center>
...
> ### GreasyFork관련 스크립트
> - [**GreasyFork향상에 적합**](https://greasyfork.org/scripts/497317): 스크립트 세부정보 페이지가 추가되어 링크 추가에 적합합니다. 클릭하면 웹페이지가 열립니다.，웹페이지 복사,타이어 검색
