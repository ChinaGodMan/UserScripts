...
3. **Load from the network or from the current page**: The script provides a setting at the top of the code,当for`true`hour,Get from current web page,为`false`,TowardsGreasyFrokDownload user data`JSON`
...
> ### ⬇️you may be looking forGreasyForkRelated scripts
