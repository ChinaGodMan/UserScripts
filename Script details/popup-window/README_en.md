...
• 开启 <code>Record window position</code> hour，Automatically record current domain name configuration。<br />
...
> - [**Small window preview**](https://greasyfork.org/scripts/504880): Open link in popup window when dragging link，and provide a preview before opening，use Edge pre-reading technology。同时在小窗口打开时在背后添加亚克力效果。
...
> - [**GitHubSubmit information displayHTML**](https://greasyfork.org/scripts/505830): This script will GitHub The submission information on HTML view，以更清晰地查看提交详情。It will automatically submit the information list、The commit header and latest commit information are converted to HTML Format，Provide better visual effects and user experience。
...
> - [**GreasyFork Markdown toobar**](https://greasyfork.org/scripts/505164): Used by default in forums Markdown Format，添加格式帮助链接及 Markdown Toolbar introduction
...
> - [**TissAVAutomatic login**](https://greasyfork.org/scripts/506528): 检测 TissAV state，and automatically log in when not logged in
