...
## Adott webhelyek letiltása a Google Keresésből

- **Segítsen a felhasználóknak a nem kívánt keresési eredmények kiszűrésében**
- **Egyéni bevitelt blokkoló webhely**
- **Formátum** `"-zhihu" "-baidu"` A Google keresési tartalom blokkolására szolgál
