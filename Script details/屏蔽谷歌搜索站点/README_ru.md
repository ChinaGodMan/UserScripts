...
## Блокировать определенные сайты в Google Поиске

- **Помогите пользователям отфильтровать нежелательные результаты поиска.**
- **Пользовательский сайт блокировки ввода**
- **Формат** `"-zhihu" "-baidu"` Используется для блокировки контента поиска Google.
