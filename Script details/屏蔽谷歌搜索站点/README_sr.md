...
## Блокирајте одређене сајтове из Гоогле претраге

- **Помозите корисницима да филтрирају нежељене резултате претраге**
- **Прилагођени сајт за блокирање уноса**
- **Формат** `"-zhihu" "-baidu"` Користи се за блокирање садржаја Гоогле претраге
