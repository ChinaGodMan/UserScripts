...
<!--HISTORY-->
<center><div align="center">
    <h1>Twitter/x ẩn các bài viết chuyển tiếp</h1>
    <p>「 Tự động ẩn nội dung được chuyển tiếp và ẩn nội dung được chuyển tiếp khi tải đầu tiên để xóa quảng cáo gây phiền nhiễu 」</p>
    ...
    <img src="https://img.shields.io/greasyfork/dt/529450?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=S%E1%BB%91%20l%C6%B0%E1%BB%A3ng%20ng%C6%B0%E1%BB%9Di%20d%C3%B9ng">
    <img src="https://img.shields.io/badge/dynamic/json?&label=C%E1%BA%ADp%20nh%E1%BA%ADt%20ki%E1%BB%83m%20tra%20h%C3%A0ng%20ng%C3%A0y&query=$.529450&logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&url=https://github.com/ChinaGodMan/UserScriptsHistory/raw/main/daily_update_checks.json">
    <p>Download:<a href="https://github.com/ChinaGodMan/UserScripts/tree/main/twitter-hide-reposts">Github</a> | ⭐<a
            ...
            Fork</a></p><details><summary style="color:#FFD700">Cập nhật hồ sơ</summary><div align="right"><a href="https://github.com/ChinaGodMan/UserScripts/tree/main/twitter-hide-reposts/CHANGELOG.md"><img src="https://img.shields.io/badge/-GitHub-3A3A3A?style=flat&logo=GitHub&logoColor=white"></a></div><h1><strong>🛠️ Twitter/X Ẩn các bài viết đăng lại Cập nhật nhật ký</strong></h1>
<h3><strong>📅 2025.03.11.0654</strong></h3>
<h2><strong>Mới</strong>: •Thêm các bài đăng được ẩn tự động khi trang web đang tải，Để ngăn tin nhắn chuyển tiếp ngay khi chúng được mở</h2></details>
...
## Giới thiệu
Tập lệnh này được thiết kế để giúp bạn ẩn tự động Twitter/X Đăng lại nội dung trên nền tảng。Cho dù đó là lần đầu tiên trang đang tải hay trong quá trình cuộn，Tất cả các tập lệnh có thể phát hiện và ẩn những nội dung này một cách thông minh，Làm sạch dòng thời gian，Cải thiện trải nghiệm duyệt web。

---

## Chức năng
- **Tự động ẩn nội dung chuyển tiếp**：Tự động phát hiện và ẩn các bài đăng được đăng lại trong lần tải và cuộn đầu tiên。
- **Tương thích với nhiều trình duyệt**：Hỗ trợ các trình duyệt chính như Chrome、Firefox、Edge、Safari Chờ đợi。
- **Chức năng vô hiệu hóa tùy chọn**：Thông qua các mục menu，Chức năng ẩn có thể bị vô hiệu hóa trên trang hiện tại。
- **Hỗ trợ không đóng khung**：Hỗ trợ chế độ không khung。
- **Quảng cáo làm sạch**：Tự động xóa quảng cáo gây phiền nhiễu。

---

## Các bước cài đặt
1. **Tải xuống tập lệnh**：
   Nhấp vào liên kết bên dưới để cài đặt：
   [Bấm để tải xuống tập lệnh](https://raw.githubusercontent.com/ChinaGodMan/UserScripts/main/twitter-hide-reposts/twitter-hide-reposts.user.js)
2. **Cài đặt Plug-in Oil Monkey**：
   Đảm bảo trình duyệt của bạn đã cài đặt hỗ trợ UserScripts Plugin，giống Tampermonkey、Violentmonkey Chờ đợi。
3. **Bật các tập lệnh**：
   Mở Twitter/X，Đảm bảo tập lệnh chạy bình thường，Nội dung được chuyển tiếp sẽ được ẩn tự động。
...
## Tùy chỉnh menu
- `Tắt tập lệnh（Trang này chỉ là）`：Chức năng ẩn script có thể bị tắt tạm thời thông qua các mục menu。

---

## Thông tin phát triển
- **Tác giả gốc**:Owyn(Xem bên dưới để biết chi tiết)
- **Sửa đổi**：人民的勤务员 (ChinaGodMan)
- **Thư**：[china.qinwuyuan@gmail.com](mailto:china.qinwuyuan@gmail.com)
- **Trang chủ**：[GitHub Trang chủ dự án](https://github.com/ChinaGodMan/UserScripts)
...
[@Owyn](https://greasyfork.org/users/47) ---- [Hide Reposts on Twitter](https://greasyfork.org/scripts/487531)
<!--AUTHORS-END-->

---

## Cập nhật nhật ký
- **Phiên bản**：2025.03.11.0654
- **Ngày sáng tạo**：2025-03-11
- **Sửa đổi lần cuối**：2025-03-11

---

## Mã nguồn tập lệnh
Xem chi tiết [GitHub Phòng trưng bày dự án](https://github.com/ChinaGodMan/UserScripts)。
...
![pg](https://s2.loli.net/2025/03/11/lLQNYkoq3dajZKJ.jpg)

## Trước khi sử dụng

![jpg](https://s2.loli.net/2025/03/11/SOyvpVtJxfEdR2X.jpg)
<!--SCREENSHOT-END-->
<!--Khu vực văn bản-END-->
