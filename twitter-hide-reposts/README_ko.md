...
<!--HISTORY-->
<center><div align="center">
    <h1>Twitter/x는 리트 윗 된 게시물을 숨 깁니다</h1>
    <p>「 성가신 광고를 제거하기 위해 첫 번째로드시 전달 된 컨텐츠를 자동으로 숨기고 전달 된 컨텐츠를 숨 깁니다. 」</p>
    ...
    <img src="https://img.shields.io/greasyfork/dt/529450?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=%EC%82%AC%EC%9A%A9%EC%9E%90%20%EC%88%98">
    <img src="https://img.shields.io/badge/dynamic/json?&label=%EB%A7%A4%EC%9D%BC%20%ED%99%95%EC%9D%B8%20%EC%97%85%EB%8D%B0%EC%9D%B4%ED%8A%B8&query=$.529450&logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&url=https://github.com/ChinaGodMan/UserScriptsHistory/raw/main/daily_update_checks.json">
...
## 소개
이 스크립트는 자동으로 숨기는 데 도움이되도록 설계되었습니다 Twitter/X 플랫폼에서 컨텐츠를 다시 게시했습니다。페이지가 처음로드 중이든 스크롤 중에든，모든 스크립트는 이러한 내용을 지능적으로 감지하고 숨길 수 있습니다，타임 라인을 정리하십시오，탐색 경험을 향상시킵니다。

---

## 기능
- **전달 된 콘텐츠를 자동으로 숨 깁니다**：첫 번째로드 및 스크롤 중에 다시 게시 된 게시물을 자동으로 감지 및 숨기고 있습니다.。
- **여러 브라우저와 호환됩니다**：다음과 같은 주류 브라우저를 지원합니다 Chrome、Firefox、Edge、Safari 기다리다。
- **선택적 비활성화 기능**：메뉴 항목을 통해，현재 페이지에서 숨겨진 기능을 비활성화 할 수 있습니다.。
- **프레임이없는 지원**：프레임리스 모드를 지원합니다。
- **광고 청소**：성가신 광고를 자동으로 제거하십시오。
...
1. **스크립트를 다운로드하십시오**：
   아래 링크를 클릭하여 설치하십시오：
   [스크립트를 다운로드하려면 클릭하십시오](https://raw.githubusercontent.com/ChinaGodMan/UserScripts/main/twitter-hide-reposts/twitter-hide-reposts.user.js)
2. **오일 원숭이 플러그인을 설치하십시오**：
   브라우저에 지원이 설치되어 있는지 확인하십시오 UserScripts 플러그인，좋다 Tampermonkey、Violentmonkey 기다리다。
3. **스크립트를 활성화합니다**：
   열려 있는 Twitter/X，스크립트가 정상적으로 실행되는지 확인하십시오，전달 된 컨텐츠는 자동으로 숨겨집니다。
...
## 메뉴를 사용자 정의하십시오
- `스크립트를 비활성화합니다（이 페이지는 전용입니다）`：스크립트 숨기기 기능은 메뉴 항목을 통해 일시적으로 비활성화 할 수 있습니다.。

---

## 개발 정보
- **오리지널 저자**:Owyn(자세한 내용은 아래를 참조하십시오)
- **수정**：人民的勤务员 (ChinaGodMan)
- **우편**：[china.qinwuyuan@gmail.com](mailto:china.qinwuyuan@gmail.com)
- **홈페이지**：[GitHub 프로젝트 홈페이지](https://github.com/ChinaGodMan/UserScripts)
- **특허**：MIT License
...
## 스크립트 소스 코드
세부 사항을 참조하십시오 [GitHub 프로젝트 갤러리](https://github.com/ChinaGodMan/UserScripts)。
