...
<!--HISTORY-->
<center><div align="center">
    <h1>Twitter/X 隱藏轉發的帖子</h1>
    <p>「 自動隱藏轉發轉發內容,並且在首次加載時隱藏轉發內容,移除煩人的廣告 」</p>
    ...
    <img src="https://img.shields.io/greasyfork/dt/529450?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=%E7%94%A8%E6%88%B6%E6%95%B8%E9%87%8F">
    <img src="https://img.shields.io/badge/dynamic/json?&label=%E6%AF%8F%E6%97%A5%E6%AA%A2%E6%9F%A5%E6%9B%B4%E6%96%B0%E6%AC%A1%E6%95%B8&query=$.529450&logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&url=https://github.com/ChinaGodMan/UserScriptsHistory/raw/main/daily_update_checks.json">
...
## 簡介
本腳本旨在幫助您自動隱藏 Twitter/X 平台上的轉發內容。無論是頁面初次加載還是在滾動過程中，腳本都能智能檢測並隱藏這些內容，清理時間線，提升瀏覽體驗。

---

## 功能
- **自動隱藏轉發內容**：在首次加載和滾動過程中自動檢測並隱藏轉發的帖子。
- **兼容多種瀏覽器**：支持主流瀏覽器如 Chrome、Firefox、Edge、Safari 等。
- **可選禁用功能**：通過菜單項，可以在當前頁面禁用隱藏功能。
- **無框架支持**：支持無框架模式。
- **廣告清理**：自動移除煩人的廣告。
...
1. **下載腳本**：
   點擊以下鏈接安裝：
   [點擊下載腳本](https://raw.githubusercontent.com/ChinaGodMan/UserScripts/main/twitter-hide-reposts/twitter-hide-reposts.user.js)
2. **安裝油猴插件**：
   確保您的瀏覽器已安裝支持 UserScripts 的插件，如 Tampermonkey、Violentmonkey 等。
3. **啟用腳本**：
   打開 Twitter/X，確保腳本正常運行，轉發內容將被自動隱藏。
...
## 自定義菜單
- `禁用腳本（僅本次頁面）`：可通過菜單項臨時禁用腳本隱藏功能。

---

## 開發信息
- **原始作者**:Owyn(詳情見下方)
- **修改者**：人民的勤务员 (ChinaGodMan)
