...
<!--HISTORY-->
<center><div align="center">
    <h1>chatgpt 코드가 강조되었습니다</h1>
    <p>「 ChatGpt에 대한 모든 언어 코드 추가 」</p>
    ...
    <img src="https://img.shields.io/greasyfork/dt/527255?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=%EC%82%AC%EC%9A%A9%EC%9E%90%20%EC%88%98">
    <img src="https://img.shields.io/badge/dynamic/json?&label=%EB%A7%A4%EC%9D%BC%20%ED%99%95%EC%9D%B8%20%EC%97%85%EB%8D%B0%EC%9D%B4%ED%8A%B8&query=$.527255&logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&url=https://github.com/ChinaGodMan/UserScriptsHistory/raw/main/daily_update_checks.json">
...
## **人民的勤务员**코드를 강조하지 않는 문제를 수정했습니다

~을 위한 ChatGPT 작성된 모든 언어 코드에 강조 표시를 추가하십시오。
지원하다 [Highlight.js](https://highlightjs.org/) 모두 192 하나의 언어，그리고 ChatGPT 주제를 일관성있게 유지하십시오。

![preview](https://raw.githubusercontent.com/Dreace/ChatGPTCodeHighlight/master/preview.png)

## GitHub

-   주소：[https://github.com/Dreace/ChatGPTCodeHighlight](https://github.com/Dreace/ChatGPTCodeHighlight)

## 설치하다

-   Chrome 권장 확장：「[Tampermonkey](https://chrome.google.com/webstore/detail/dhdgffkkebhmkfjojejmpbldmpobfkfo)」
-   Firefox 권장 확장：「[Greasemonkey](https://addons.mozilla.org/en-US/firefox/addon/greasemonkey/)」
-   스크립트 주소：[https://greasyfork.org/zh-CN/scripts/496646-chatgpt-code-highlight](https://greasyfork.org/zh-CN/scripts/496646-chatgpt-code-highlight)

## 사용

1. 사용「설치하다」언급 된 모든 플러그인 설치 스크립트
2. 열려 있는 [https://chatgpt.com/](https://chatgpt.com/) 대화를 나누십시오
3. 코드 강조 표시 효과를 봅니다
