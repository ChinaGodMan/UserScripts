...
<!--HISTORY-->
<center><div align="center">
    <h1>Làm sạch bài viết trên blog</h1>
    <p>「 Hủy bỏ thanh bên khó chịu, khối bình luận, quảng cáo, và nhiều hơn nữa. 」</p>
    ...
    <img src="https://img.shields.io/greasyfork/dt/537643?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=S%E1%BB%91%20l%C6%B0%E1%BB%A3ng%20ng%C6%B0%E1%BB%9Di%20d%C3%B9ng">
    <img src="https://img.shields.io/badge/dynamic/json?&label=C%E1%BA%ADp%20nh%E1%BA%ADt%20ki%E1%BB%83m%20tra%20h%C3%A0ng%20ng%C3%A0y&query=$.537643&logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&url=https://github.com/ChinaGodMan/UserScriptsHistory/raw/main/daily_update_checks.json">
...
- Xóa quảng cáo và các yếu tố gây mất tập trung trong trang。
- Điều chỉnh bố cục trang，Làm cho nội dung tập trung hơn。
- Hỗ trợ nhiều nền tảng，bao gồm CSDN、Công viên blog、Reddit、Cốm、Zhihu、Baeldung、Medium Và Stack Overflow。
- Chức năng sao chép tùy chỉnh（Nếu bạn cho phép khả năng truy cập để sao chép văn bản）。
- Tự động điều chỉnh bố cục cho các thiết bị màn hình rộng và màn hình dọc。

## Nền tảng được hỗ trợ

- **CSDN**：Xóa dấu nhắc đăng nhập、Thanh bên、Thanh công cụ, v.v.。
- **Công viên blog**：Ẩn biểu mẫu bình luận、Thanh bên, v.v.，Tối ưu hóa hiển thị nội dung。
- **Reddit**：Ẩn các liên kết quảng cáo và thanh bên，Hiển thị nội dung chính theo cách tập trung。
- **Cốm**：Xóa khu vực khuyến nghị、Các yếu tố can thiệp như phần bình luận。
- **Zhihu**：Tối ưu hóa kiểu màu，Ẩn thanh bên phải、Quảng cáo, v.v.。
- **Baeldung**：Ẩn quảng cáo hàng đầu、Thanh bên, v.v.。
- **Medium**：Ẩn bài khuyến mại thành viên，Tối ưu hóa hiển thị khối mã。
- **Stack Overflow**：Loại bỏ thanh bên và chân trang dưới cùng。
