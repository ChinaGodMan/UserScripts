...
<div align="right">
    <h6>
        ...
        <a href="https://github.com/ChinaGodMan/UserScripts/blob/main/github-email-finder/README.md">简体中文</a> |
        <a href="https://github.com/ChinaGodMan/UserScripts/blob/main/github-email-finder/README_en.md">English</a> |
        <a href="https://github.com/ChinaGodMan/UserScripts/blob/main/github-email-finder/README_ko.md">한국어</a> |
        <a href="https://github.com/ChinaGodMan/UserScripts/blob/main/github-email-finder/README_vi.md">Tiếng Việt</a> |
        <a href="https://github.com/ChinaGodMan/UserScripts/blob/main/github-email-finder/README_zh-TW.md">繁體中文</a>
    <br>
...
<!--HISTORY-->
<center><div align="center">
    <h1>Công cụ tìm địa chỉ email GitHub</h1>
    <p>「 Sử dụng dữ liệu sự kiện công cộng (ví dụ: một bản gửi được đẩy đến cơ sở mã công cộng), lấy địa chỉ email gửi của người dùng và hiển thị nó trên trang hồ sơ. Ngoài ra, nó cũng thêm một nút "Sao chép vào bảng tạm" thuận tiện để sao chép dễ dàng. 」</p>
    ...
    <img src="https://img.shields.io/greasyfork/dt/537309?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=S%E1%BB%91%20l%C6%B0%E1%BB%A3ng%20ng%C6%B0%E1%BB%9Di%20d%C3%B9ng">
    <img src="https://img.shields.io/badge/dynamic/json?&label=C%E1%BA%ADp%20nh%E1%BA%ADt%20ki%E1%BB%83m%20tra%20h%C3%A0ng%20ng%C3%A0y&query=$.537309&logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&url=https://github.com/ChinaGodMan/UserScriptsHistory/raw/main/daily_update_checks.json">
    <p>Download:<a href="https://github.com/ChinaGodMan/UserScripts/tree/main/github-email-finder">Github</a> | ⭐<a
            ...
            Fork</a></p>
    <img src="https://raw.githubusercontent.com/ChinaGodMan/UserScriptsHistory/main/stats/537309.png">
</div></center>
...
Kịch bản này được sử dụng trong GitHub Trang chủ của người dùng tự động trích xuất bài nộp công khai của người dùng（PushEvent）Địa chỉ email trong(Nếu không có địa chỉ email công khai,)，Và chèn thông tin email vào trang，Nó cũng cung cấp chức năng sao chép email vào bảng tạm chỉ bằng một cú nhấp chuột。

## Tổng quan về chức năng

-   Kiểm tra xem thông tin email có được hiển thị trên trang hiện tại không。
-   Nếu không，từ GitHub API Có được dữ liệu sự kiện công khai của người dùng，Trích xuất gần đây nhất PushEvent Gửi email vào。
-   Chèn email được trích xuất vào khu vực thông tin liên hệ của trang hồ sơ người dùng。
-   Chèn biểu tượng Clipboard bên cạnh hộp thư，Bấm để sao chép email vào bảng tạm。
-   Sau khi sao chép thành công，Biểu tượng clipboard sẽ được thay thế bằng biểu tượng đánh dấu，Nhanh chóng sao chép thành công。

## Hướng dẫn sử dụng

1. Đảm bảo cấu hình là hợp lệ GitHub Mã thông báo truy cập cá nhân（`GITHUB_TOKEN`）[Đây](https://github.com/settings/tokens/new?description=Github%20Email%20Finder&scopes=repo)Tạo mã thông báo mới，Để tránh API Yêu cầu hạn chế。

## Để ý

-   Tập lệnh này không có được địa chỉ email chính xác，Nó là địa chỉ email của người gửi，Có lẽ không phải email đăng ký của người dùng。(Ví dụ: địa chỉ email trong yêu cầu hợp nhất,Sau đó, địa chỉ email được hiển thị là địa chỉ email của người khởi tạo yêu cầu hợp nhất)
-   Kịch bản này hiện đang được thử nghiệm，Có một số vấn đề。
