...
<!--HISTORY-->
<center><div align="center">
    <h1>GitHub Email Address Finder</h1>
...
1. Make sure the configuration is valid GitHub Personal access token（`GITHUB_TOKEN`）[Here](https://github.com/settings/tokens/new?description=Github%20Email%20Finder&scopes=repo)Generate a new token，To avoid API Request restrictions。
