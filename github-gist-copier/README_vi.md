...
<!--HISTORY-->
<center><div align="center">
    <h1>Github Gist Code Snippet Sao chép và tải xuống</h1>
    <p>「 Thêm một nút sao chép vào tệp GIST để dễ dàng sao chép mã. | 」</p>
    ...
    <img src="https://img.shields.io/greasyfork/dt/529534?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=S%E1%BB%91%20l%C6%B0%E1%BB%A3ng%20ng%C6%B0%E1%BB%9Di%20d%C3%B9ng">
    <img src="https://img.shields.io/badge/dynamic/json?&label=C%E1%BA%ADp%20nh%E1%BA%ADt%20ki%E1%BB%83m%20tra%20h%C3%A0ng%20ng%C3%A0y&query=$.529534&logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&url=https://github.com/ChinaGodMan/UserScriptsHistory/raw/main/daily_update_checks.json">
...
<p><strong>Sửa chữa</strong>: •Đã khắc phục sự cố không thể sao chép<br>
<strong>Mới</strong>: •Đã thêm chức năng tải xuống các tệp vào cục bộ<br></p>
<hr /></details>
...
👍 `GitHub Gist Copier & Downloader` hiện hữu GitHub Gist Thêm nút trên trang，Thuận tiện cho người dùng sao chép nhanh chóng Gist Nội dung tệp vào bảng tạm。 <br>
👍 `GitHub Gist Copier & Downloader` hiện hữu GitHub Gist Thêm nút trên trang，Thuận tiện cho người dùng để tải xuống nhanh chóng Gist Nội dung tập tin đến cục bộ。

## Chức năng

-   💯 Mở bất kỳ GitHub Gist trang。
-   📄 Trong mỗi Gist Thêm nút sao chép vào thanh hành động của tệp。
-   🎱 Sau khi nhấp vào nút sao chép，Nội dung tệp sẽ được sao chép vào bảng tạm，Và hiển thị biểu tượng nhắc nhở thành công。
-   📁 Trong mỗi Gist Thêm nút tải xuống vào thanh hành động của tệp,Sau khi nhấp vào nút tải xuống，Nội dung tệp sẽ được tải xuống cục bộ。
-   🎱 Nhấp vào nút Tải xuống，Nội dung tệp sẽ được tải xuống cục bộ，Và hiển thị biểu tượng nhắc nhở thành công。
