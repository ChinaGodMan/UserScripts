...
<!--HISTORY-->
<center><div align="center">
    <h1>GitHub Gist code snippet copy and downloader</h1>
    <p>「 Add a copy button to the Gist file to make the code easily copied. | Add a download button to the Gist file to easily download the code. 」</p>
    ...
    <img src="https://img.shields.io/greasyfork/dt/529534?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=Number%20of%20users">
    <img src="https://img.shields.io/badge/dynamic/json?&label=Daily%20check%20updates&query=$.529534&logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&url=https://github.com/ChinaGodMan/UserScriptsHistory/raw/main/daily_update_checks.json">
...
👍 `GitHub Gist Copier & Downloader` exist GitHub Gist Add buttons on the page，Convenient to users to copy quickly Gist File contents to clipboard。 <br>
👍 `GitHub Gist Copier & Downloader` exist GitHub Gist Add buttons on the page，Convenient to users to download quickly Gist File contents to local。

## Function

-   💯 Open any GitHub Gist page。
-   📄 In each Gist Add a copy button to the action bar of the file。
-   🎱 After clicking the copy button，The file content will be copied to the clipboard，And display a success prompt icon。
-   📁 In each Gist Add a download button to the action bar of the file,After clicking the download button，The file content will be downloaded locally。
