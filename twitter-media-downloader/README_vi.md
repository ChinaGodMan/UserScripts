...
<center><div align="center">
    <h1>Tải xuống phương tiện truyền thông Twitter</h1>
    <p>「 Tải xuống video/hình ảnh chỉ bằng một cú nhấp chuột | 」</p>
    ...
    <p>Download:<a href="https://github.com/ChinaGodMan/UserScripts/tree/main/twitter-media-downloader">Github</a> | ⭐<a
            ...
            Fork</a></p><details><summary>Cập nhật hồ sơ</summary><h1><strong>🛠️tTwitter Tải xuống phương tiện truyền thông Cập nhật nhật ký</strong></h1>
...
# Twitter/X Trình tải xuống phương tiện

## Giới thiệu
Kịch bản này giúp bạn tải xuống nhanh chóng Twitter/X Hình ảnh và video trên nền tảng，支持一键下载单个tài liệu，Nó cũng có thể được đóng gói tự động như ZIP 文件，Quản lý và lưu trữ thuận tiện。

---

## Chức năng
- **Bấm để tải xuống**：Tải xuống hình ảnh và video một cách dễ dàng，Không cần công cụ của bên thứ ba。
- **Bao bì số lượng lớn**：Khi tải xuống theo đợt，自动将tài liệu打包为一个 ZIP 文件。
- **Đặt tên tập tin tùy chỉnh**：Định dạng tên tệp là `twitter_{user-name}(@{user-id})_{date-time}_{status-id}_{file-type}`，Dễ dàng phân loại。
- **Hỗ trợ nội dung quyền riêng tư**：Có thể đặt xem có hiển thị và tải xuống nội dung nhạy cảm。
...
1. **Tải xuống tập lệnh**：
   ...
   [Bấm để tải xuống tập lệnh](https://raw.githubusercontent.com/ChinaGodMan/UserScripts/main/twitter-media-downloader/twitter-media-downloader.user.js)
...
3. **Bật các tập lệnh**：
   Mở Twitter/X，Bấm vào hình ảnh hoặc video，Bắt đầu tải xuống！
...
## Tùy chỉnh menu
- **cài đặt**：Menu tập lệnh có thể được truy cập vào trang Cài đặt，Sửa đổi ngôn ngữ hoặc hiển thị nội dung nhạy cảm。

---

## Thông tin phát triển
- **Tác giả gốc**: Tianyin、Tiande(Xem bên dưới để biết chi tiết)
- **Sửa đổi lần cuối**：人民的勤务员 (ChinaGodMan)
...
- 文件命名规则包括người dùng名、用户 ID、Thời gian phát hành、tình trạng ID và các loại tệp。

---

## Cập nhật nhật ký
- **Phiên bản**：2025.03.11.0811
...
1. Tải xuống trực tiếp một tệp duy nhất:

![x-d_1.png](https://s2.loli.net/2025/03/11/SB6tQzo8bijgy7p.png)

2. Nhiều tệp được đóng gói và tải xuống:
