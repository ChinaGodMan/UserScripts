...
<center><div align="center">
    ...
    <img src="https://img.shields.io/greasyfork/dt/529453?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=%E7%94%A8%E6%88%B6%E6%95%B8%E9%87%8F">
    <img src="https://img.shields.io/badge/dynamic/json?&label=%E6%AF%8F%E6%97%A5%E6%AA%A2%E6%9F%A5%E6%9B%B4%E6%96%B0%E6%AC%A1%E6%95%B8&query=$.529453&logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&url=https://github.com/ChinaGodMan/UserScriptsHistory/raw/main/daily_update_checks.json">
    <p>Download:<a href="https://github.com/ChinaGodMan/UserScripts/tree/main/twitter-media-downloader">Github</a> | ⭐<a
            ...
            Fork</a></p><details><summary style="color:#FFD700">更新記錄</summary><div align="right"><a href="https://github.com/ChinaGodMan/UserScripts/tree/main/twitter-media-downloader/CHANGELOG.md"><img src="https://img.shields.io/badge/-GitHub-3A3A3A?style=flat&logo=GitHub&logoColor=white"></a></div><h1><strong>🛠️Twitter 媒體下載 更新日誌</strong></h1>
<h3><strong>📅 2025.04.28.1719</strong></h3>
<p><strong>新增</strong>: 導出下載歷史為 <code>MarkDown</code>,代碼來自 GreasyFork 用戶<a href="https://greasyfork.org/users/1462808">SteveSun</a>發佈於<a href="https://greasyfork.org/scripts/495368/discussions/296680#comment-589869">#296680</a><br>
<strong>截圖</strong>: <img alt="2025.04.28" src="https://s2.loli.net/2025/04/28/qZDoaHuUF7gK1XI.png" /></p>
<hr />
<h3><strong>📅 2025.04.28.1503</strong></h3>
<p><strong>修復</strong>: 2025.04.28,修復了<code>Api</code>在失效後後無法正常下載媒體的問題<br>
<strong>修復</strong>: 修復代碼來自 GreasyFork 用戶<a href="https://greasyfork.org/users/1462596">goemon2017</a>發布的<a href="https://greasyfork.org/scripts/423001/discussions/296626#comment-589742">#296626-589742</a><br></p>
<hr />
...
## 簡介
此腳本幫助您快速下載 Twitter/X 平台上的圖片和視頻，支持一鍵下載單個文件，也可以在批量下載時自動打包為 ZIP 文件，方便管理和保存。

---

## 功能
- **單擊下載**：輕鬆下載圖片和視頻，無需第三方工具。
- **批量打包**：在批量下載時，自動將文件打包為一個 ZIP 文件。
- **自定義文件命名**：文件命名格式為 `twitter_{user-name}(@{user-id})_{date-time}_{status-id}_{file-type}`，便於分類。
- **支持隱私內容**：可設置是否顯示並下載敏感內容。
...
1. **下載腳本**：
   點擊以下鏈接安裝：
   [點擊下載腳本](https://raw.githubusercontent.com/ChinaGodMan/UserScripts/main/twitter-media-downloader/twitter-media-downloader.user.js)
2. **安裝油猴插件**：
   確保您的瀏覽器已安裝支持 UserScripts 的插件，如 Tampermonkey、Violentmonkey 等。
3. **啟用腳本**：
   打開 Twitter/X，點擊圖片或視頻，開始下載！
...
## 開發信息
- **原始作者**: 天音、Tiande(詳情見下方)
- **最後修改者**：人民的勤务员 (ChinaGodMan)
- **郵箱**：[china.qinwuyuan@gmail.com](mailto:china.qinwuyuan@gmail.com)
- **主頁**：[GitHub 項目主頁](https://github.com/ChinaGodMan/UserScripts)
- **許可**：MIT License
...
[@天音](https://greasyfork.org/users/164321) ---- [Twitter Media Downloader](https://greasyfork.org/scripts/423001)
<!--AUTHORS-END-->
...
## 腳本源碼
詳見 [GitHub 項目地址](https://github.com/ChinaGodMan/UserScripts)。
...
![x-d_1.png](https://s2.loli.net/2025/03/11/SB6tQzo8bijgy7p.png)
