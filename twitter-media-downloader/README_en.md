...
<center><div align="center">
    ...
    <p>Download:<a href="https://github.com/ChinaGodMan/UserScripts/tree/main/twitter-media-downloader">Github</a> | ⭐<a
            ...
            Fork</a></p><details><summary>Update records</summary><h1><strong>🛠️tTwitter Media Download Update log</strong></h1>
...
1. **Download script**：
   ...
   [Click to download the script](https://raw.githubusercontent.com/ChinaGodMan/UserScripts/main/twitter-media-downloader/twitter-media-downloader.user.js)
...
3. **Enable scripts**：
   Open Twitter/X，Click on the picture or video，Start downloading！
...
## Customize menu
- **set up**：The script menu can be accessed to the settings page，Modify language or display sensitive content。

---

## Development information
- **Original author**: Tianyin、Tiande(See below for details)
- **Last modified**：人民的勤务员 (ChinaGodMan)
...
1. Download a single file directly:

![x-d_1.png](https://s2.loli.net/2025/03/11/SB6tQzo8bijgy7p.png)

2. Multiple files are packaged and downloaded:
