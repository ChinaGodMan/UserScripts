...
<center><div align="center">
    <h1>網頁寫入剪輯版授權管理員</h1>
    <p>「 管理網頁對剪貼簿的寫入行為防止未經授權的自動複製和停用音視頻內容預載及自動播放。 」</p>
    ...
    <img src="https://img.shields.io/greasyfork/dt/497403?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=%E7%94%A8%E6%88%B6%E6%95%B8%E9%87%8F">
    <img src="https://img.shields.io/badge/dynamic/json?&label=%E6%AF%8F%E6%97%A5%E6%AA%A2%E6%9F%A5%E6%9B%B4%E6%96%B0%E6%AC%A1%E6%95%B8&query=$.497403&logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&url=https://github.com/ChinaGodMan/UserScriptsHistory/raw/main/daily_update_checks.json">
    <p>Download:<a href="https://github.com/ChinaGodMan/UserScripts/tree/main/clipboard-manager">Github</a> | ⭐<a
            ...
            Fork</a></p><details><summary style="color:#FFD700">更新記錄</summary><div align="right"><a href="https://github.com/ChinaGodMan/UserScripts/tree/main/clipboard-manager/CHANGELOG.md"><img src="https://img.shields.io/badge/-GitHub-3A3A3A?style=flat&logo=GitHub&logoColor=white"></a></div><h1><strong>🛠️ 網頁寫入剪輯版授權管理器 更新日誌</strong></h1>
<h3><strong>📅 2024-09-28 08:21- Ver 1.2.3.1</strong></h3>
<p><strong>修復</strong>: •複製函數 <code>pc</code> 不為 red 時且來源於為 <code>window.navigator.clipboard.writeText</code> ,需要手動複製到剪輯版.@90
<strong>修復</strong>: •邏輯錯誤 ↠ 按下快捷键复制后只有指示器為 red 時候重置，为 green 不重置@161</p>
<hr />
<h3><strong>📅 2024-09-27 11:55- Ver 1.2.3.0</strong></h3>
<p><strong>新增</strong>: •監聽<code>clipboard.writeText</code>事件</p>
<hr /></details>
...
在其他地方下載的腳本，作者不知道是誰很不錯，防範牛皮癬。用 ChatGPT 修改了下，讓腳本在 PC 端瀏覽時可以使用快捷鍵複製，專防網頁後台複製各種口令。該腳本與復制限制解除類腳本可能不兼容！
腳本生效時，會在網頁右下角顯示半透明小圓點，不同顏色對應不同狀態，說明如下：

-   **紅色** : 攔截所有復制行為，並彈窗通知是否授權。
-   **綠色** : 放行所有復制行為，等於腳本不運行。
-   **橘色** : 臨時解除攔截，該狀態僅出現在手動複製時，用戶完成複制後自動變為紅色，恢復攔截。
-   **紅點默認不顯示**，在檢測到剪貼板寫入行為後會顯示 4s。這個時間你可以點擊切換狀態，選擇是否放行這個網頁的剪貼板寫入行為。

## 作者

-   **姓名**：人民的勤务员
-   **郵箱**：toniaiwanowskiskr47@gmail.com
...
如有任何問題，請通過 [GitHub Issues](https://github.com/ChinaGodMan/UserScripts/issues) 提交反饋。
