...
<center><div align="center">
    ...
    <p>Download:<a href="https://github.com/ChinaGodMan/UserScripts/tree/main/github-comment-translate">Github</a> | ⭐<a
            ...
            Fork</a></p><details><summary>Update records</summary><h1><strong>🛠️ GitHub Quick translation Update log</strong></h1>
...
3. **翻译结果替换**：Replace the translated text to the selected position in the original text box。
...
> -   [**Web Translation——Automatic translation into Chinese**](https://greasyfork.org/scripts/505208): Give each non-Chinese web page the bottom right corner（可以调整到左下角）Add onegoogleTranslation icon，This version is a Chinese translation，Translate only foreign languages ​​to Chinese,Add automatic translation
