...
<!--HISTORY-->
<center><div align="center">
    <h1>GitHub 快捷鍵翻譯助手</h1>
    <p>「 監聽鍵盤快捷鍵 Ctrl + Q，實現對文本進行翻譯並將翻譯結果替換到原文本框中的功能 支持Issue和pull request 頁面. 」</p>
    ...
    <img src="https://img.shields.io/greasyfork/dt/530312?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=%E7%94%A8%E6%88%B6%E6%95%B8%E9%87%8F">
    <img src="https://img.shields.io/badge/dynamic/json?&label=%E6%AF%8F%E6%97%A5%E6%AA%A2%E6%9F%A5%E6%9B%B4%E6%96%B0%E6%AC%A1%E6%95%B8&query=$.530312&logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&url=https://github.com/ChinaGodMan/UserScriptsHistory/raw/main/daily_update_checks.json">
    <p>Download:<a href="https://github.com/ChinaGodMan/UserScripts/tree/main/github-comment-translate">Github</a> | ⭐<a
            href="https://greasyfork.org/scripts/530312">Greasy
            Fork</a></p><details><summary style="color:#FFD700">更新記錄</summary><div align="right"><a href="https://github.com/ChinaGodMan/UserScripts/tree/main/github-comment-translate/CHANGELOG.md"><img src="https://img.shields.io/badge/-GitHub-3A3A3A?style=flat&logo=GitHub&logoColor=white"></a></div><h1><strong>🛠️ GitHub 快捷翻譯 更新日誌</strong></h1>
...
該腳本通過監聽鍵盤快捷鍵 `Ctrl + Q`，實現對選中文本進行翻譯並將翻譯結果替換到原文本框中的功能。翻譯調用了 Google Translate API。

## 功能描述

1. **快捷鍵觸發**：按下 `Ctrl + Q` 時觸發翻譯功能。
2. **選中文本翻譯**：自動檢測文本框中選中的文本，並將其翻譯為目標語言。
3. **翻譯結果替換**：將翻譯後的文本替換到原文本框中選中的位置。
4. 支持對 GitHub 上的`issues`和`pull`頁面的`markdown`的信息進行翻譯。
5. 你可以在腳本自定義你需要的翻譯語言,默認翻譯為英文。`const translate = 'en'`

## 腳本邏輯

1. 監聽鍵盤事件，判斷是否按下了 `Ctrl + Q`。
2. 如果在目標文本框中檢測到選中文本：
    - 提取選中的文本。
    - 調用 Google Translate API 進行翻譯。
    - 用翻譯結果替換原選中文本。
3. 如果未選中文本或未找到目標文本框，會在控制台輸出提示信息。
