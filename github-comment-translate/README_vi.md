...
<!--HISTORY-->
<center><div align="center">
    <h1>Trợ lý bản dịch phím tắt GitHub</h1>
    <p>「 Nghe phím tắt Ctrl + Q, trong đó thực hiện chức năng dịch văn bản và thay thế kết quả dịch với hộp văn bản gốc. 」</p>
    ...
    <img src="https://img.shields.io/greasyfork/dt/530312?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=S%E1%BB%91%20l%C6%B0%E1%BB%A3ng%20ng%C6%B0%E1%BB%9Di%20d%C3%B9ng">
    <img src="https://img.shields.io/badge/dynamic/json?&label=C%E1%BA%ADp%20nh%E1%BA%ADt%20ki%E1%BB%83m%20tra%20h%C3%A0ng%20ng%C3%A0y&query=$.530312&logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&url=https://github.com/ChinaGodMan/UserScriptsHistory/raw/main/daily_update_checks.json">
...
Tập lệnh này lắng nghe các phím tắt bàn phím `Ctrl + Q`，Thực hiện chức năng dịch văn bản đã chọn và thay thế kết quả dịch trong hộp văn bản gốc。Dịch đã được gọi Google Translate API。
...
5. Bạn có thể tùy chỉnh ngôn ngữ dịch bạn cần trong tập lệnh,Được dịch theo mặc định bằng tiếng Anh。`const translate = 'en'`

## Logic tập lệnh

1. Nghe các sự kiện bàn phím，Xác định xem nó đã được nhấn `Ctrl + Q`。
2. Nếu văn bản đã chọn được phát hiện trong hộp văn bản đích：
    - Trích xuất văn bản đã chọn。
    - Gọi Google Translate API Thực hiện một bản dịch。
    - Thay thế văn bản đã chọn ban đầu bằng kết quả dịch。
3. Nếu văn bản không được chọn hoặc hộp văn bản đích không tìm thấy，Thông tin nhanh chóng sẽ được đầu ra trên bảng điều khiển。
