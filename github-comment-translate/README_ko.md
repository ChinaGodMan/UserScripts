...
<center><div align="center">
    ...
    <p>Download:<a href="https://github.com/ChinaGodMan/UserScripts/tree/main/github-comment-translate">Github</a> | ⭐<a
            ...
            Fork</a></p><details><summary>레코드 업데이트</summary><h1><strong>🛠️ GitHub 빠른 번역 로그 업데이트</strong></h1>
...
2. **텍스트 번역을 선택하십시오**：텍스트 상자에서 선택한 텍스트를 자동으로 감지합니다，并将其翻译为目标语言。
...
**如果你需要了解更多关于如何安装用户脚本,[나를 클릭하십시오](https://github.com/ChinaGodMan/UserScripts/blob/main/docs/help/README.md)그림과 텍스트의 가르침을보십시오!**
...
> -   [**Google 검색 사이트를 차단하십시오**](https://greasyfork.org/scripts/500262): 在google검색 지정된 사이트를 차단합니다
...
> ### 🔍자동 번역을 찾고있을 수 있습니다
>
> -   [**외국어 터미네이터**](https://greasyfork.org/scripts/504890): 비 중국어 캐릭터를 인식합니다，길이가 더 큰 경우5번역 된 텍스트에는 중국어가 포함되어 있지 않습니다，则翻译并且替换原始文本到中文
