...
<!--HISTORY-->
<center><div align="center">
    <h1>트위터 (x) 블랙리스트 및 차단 된 목록 다운로드</h1>
...
빠른 다운로드 Twitter 차단 된 사용자 목록의 사용자 스크립트。차단 된 사용자의 정보를 자동으로 스크롤하고 추출합니다.，계정 및 사용자 이름으로 사용자 이름을 생성하십시오 `.tsv` 문서，차단 된 계정을 백업하고 관리하도록 편리하게 지원합니다.。
...
- 스크립트는 차단 된 계정 페이지의 내용을 자동으로 통과합니다.，계정 정보를 로컬로 저장하십시오。

**파일 다운로드**：

- 얻은 차단 된 계정 정보는 다음과 같이 저장됩니다 `.tsv` 체재，편리합니다 Excel 또는보고 관리하는 다른 도구。

**버튼 작동**：

- A는 페이지의 오른쪽 상단에 생성됩니다. “Download Blocklist” 단추，다운로드를 수동으로 트리거하려면 클릭하십시오。
...
- 새 책갈피를 만듭니다，지명 `GetBlocklist`,다음 링크를 북마크에 복사하십시오 URL 열：또는 직접 액세스 할 수 있습니다[https://x.com/settings/blocked/all#DOWNLOAD](https://x.com/settings/blocked/all#DOWNLOAD)
- 새 책갈피를 만듭니다，지명 `GetMutedlist`, 다음 링크를 북마크에 복사하십시오 URL 열：또는 직접 액세스 할 수 있습니다[https://x.com/settings/muted/all#DOWNLOAD](https://x.com/settings/muted/all#DOWNLOAD)

**북마크 또는 버튼을 클릭하십시오**：

- 생성 한 북마크를 클릭하십시오，또는 페이지의 오른쪽 상단을 직접 사용하십시오. “Download” 단추。

**다운로드를 기다리고 있습니다**：

- 스크립트는 페이지의 차단 된 계정 목록을 자동으로 통과합니다.，그리고 트래버스가 완료된 후 다운로드 대화 상자가 나타납니다.。

---

## 파일 형식

다운로드 된 파일은입니다 `.tsv` 체재，내용은 다음과 같습니다：  
No. Account Name  
