...
<div align="right">
    <h6>
        ...
        <a href="https://github.com/ChinaGodMan/UserScripts/blob/main/twitter-download-blocklist/README.md">简体中文</a> |
        <a href="https://github.com/ChinaGodMan/UserScripts/blob/main/twitter-download-blocklist/README_en.md">English</a> |
        <a href="https://github.com/ChinaGodMan/UserScripts/blob/main/twitter-download-blocklist/README_ko.md">한국어</a> |
        <a href="https://github.com/ChinaGodMan/UserScripts/blob/main/twitter-download-blocklist/README_vi.md">Tiếng Việt</a> |
        <a href="https://github.com/ChinaGodMan/UserScripts/blob/main/twitter-download-blocklist/README_zh-TW.md">繁體中文</a>
    <br>
...
<!--HISTORY-->
<center><div align="center">
    <h1>Tải xuống danh sách đen và danh sách đen và danh sách bị chặn</h1>
    <p>「 Được sử dụng để tải xuống danh sách đen và danh sách đen của Twitter (x), hỗ trợ phát hiện tự động các trang và xuất danh sách tương ứng dưới dạng các tệp TSV, giúp bạn dễ dàng sao lưu và quản lý. 」</p>
    ...
    <img src="https://img.shields.io/greasyfork/dt/538137?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=S%E1%BB%91%20l%C6%B0%E1%BB%A3ng%20ng%C6%B0%E1%BB%9Di%20d%C3%B9ng">
    <img src="https://img.shields.io/badge/dynamic/json?&label=C%E1%BA%ADp%20nh%E1%BA%ADt%20ki%E1%BB%83m%20tra%20h%C3%A0ng%20ng%C3%A0y&query=$.538137&logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&url=https://github.com/ChinaGodMan/UserScriptsHistory/raw/main/daily_update_checks.json">
    <p>Download:<a href="https://github.com/ChinaGodMan/UserScripts/tree/main/twitter-download-blocklist">Github</a> | ⭐<a
            ...
            Fork</a></p>
    <img src="https://raw.githubusercontent.com/ChinaGodMan/UserScriptsHistory/main/stats/538137.png">
</div></center>
...
Để tải xuống nhanh Twitter Tập lệnh người dùng cho danh sách người dùng bị chặn。Nó tự động cuộn và trích xuất thông tin của người dùng bị chặn，Tạo tên người dùng có tài khoản và tên người dùng `.tsv` tài liệu，Hỗ trợ thuận tiện để bạn sao lưu và quản lý các tài khoản bị chặn。

---

## Chức năng

**Tự động nhận danh sách bị chặn**：

- Tập lệnh sẽ tự động vượt qua nội dung của trang tài khoản bị chặn，Và lưu thông tin tài khoản cục bộ。

**Tải xuống tập tin**：

- Thông tin tài khoản bị chặn thu được sẽ được lưu dưới dạng `.tsv` Định dạng，Thuận tiện cho bạn Excel hoặc các công cụ khác để xem và quản lý。

**Hoạt động nút**：

- A sẽ được tạo ở góc trên bên phải của trang “Download Blocklist” Cái nút，Bấm để kích hoạt tải xuống thủ công。
...
- Tạo một dấu trang mới，Được đặt tên `GetBlocklist`,Sao chép liên kết sau vào dấu trang URL cột：Hoặc bạn có thể truy cập trực tiếp[https://x.com/settings/blocked/all#DOWNLOAD](https://x.com/settings/blocked/all#DOWNLOAD)
- Tạo một dấu trang mới，Được đặt tên `GetMutedlist`, Sao chép liên kết sau vào dấu trang URL cột：Hoặc bạn có thể truy cập trực tiếp[https://x.com/settings/muted/all#DOWNLOAD](https://x.com/settings/muted/all#DOWNLOAD)

**Bấm vào dấu trang hoặc nút**：

- Nhấp vào dấu trang bạn đã tạo，Hoặc trực tiếp sử dụng góc trên bên phải của trang “Download” Cái nút。

**Đang chờ tải xuống**：

- Tập lệnh sẽ tự động vượt qua danh sách tài khoản bị chặn của trang，Và hộp thoại tải xuống bật lên sau khi hoàn thành việc truyền tải。

---

## Định dạng tệp

Tệp đã tải xuống là `.tsv` Định dạng，Nội dung như sau：  
No. Account Name  
...
[🧑‍💻 **@Skeeve**](https://github.com/Skeeve) ⇒ 📜 _[Download Blocklist](https://github.com/Skeeve/Download-Twitter-Blocklist/blob/main/Download%20Blocklist)_
<!--AUTHORS-END-->
<!--SCREENSHOT-->
