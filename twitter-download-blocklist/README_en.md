...
<!--HISTORY-->
<center><div align="center">
    <h1>Twitter(X) Blacklist and Blocked List Download</h1>
    <p>「 Used to download Twitter(X) blacklists and blocked lists, support automatic detection of pages and export corresponding lists as TSV files, making it easy to backup and manage. 」</p>
    ...
    <img src="https://img.shields.io/greasyfork/dt/538137?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=Number%20of%20users">
    <img src="https://img.shields.io/badge/dynamic/json?&label=Daily%20check%20updates&query=$.538137&logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&url=https://github.com/ChinaGodMan/UserScriptsHistory/raw/main/daily_update_checks.json">
...
For quick downloads Twitter User scripts for blocked user list。It automatically scrolls and extracts the information of blocked users，Generate a username with an account and username `.tsv` document，Conveniently support you to back up and manage blocked accounts。

---

## Function

**Automatically get blocked list**：

- The script will automatically traverse the content of the blocked account page，And save the account information locally。

**File download**：

- The obtained blocked account information will be saved as `.tsv` Format，Convenient for you Excel or other tools to view and manage。

**Button operation**：

- A will be generated in the upper right corner of the page “Download Blocklist” Button，Click to trigger the download manually。
...
- Create a new bookmark，Named `GetBlocklist`,Copy the following link to the bookmark URL column：Or you can access it directly[https://x.com/settings/blocked/all#DOWNLOAD](https://x.com/settings/blocked/all#DOWNLOAD)
- Create a new bookmark，Named `GetMutedlist`, Copy the following link to the bookmark URL column：Or you can access it directly[https://x.com/settings/muted/all#DOWNLOAD](https://x.com/settings/muted/all#DOWNLOAD)

**Click on the bookmark or button**：

- Click on the bookmark you created，Or directly use the upper right corner of the page “Download” Button。

**Waiting for download**：

- The script will automatically traverse the page’s blocked account list，And the download dialog box pops up after the traversal is completed。

---

## File format

The downloaded file is `.tsv` Format，The content is as follows：  
No. Account Name  
