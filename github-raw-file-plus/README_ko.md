...
<!--HISTORY-->
<center><div align="center">
    <h1>Github 원본 파일 복사 URL 다운로드 파일 포함</h1>
    <p>「 각 파일 줄 끝에 추가 버튼，원본 파일을 복사하려면 URL 그리고 파일 다운로드 」</p>
    ...
    <img src="https://img.shields.io/greasyfork/dt/505501?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=%EC%82%AC%EC%9A%A9%EC%9E%90%20%EC%88%98">
    <img src="https://img.shields.io/badge/dynamic/json?&label=%EB%A7%A4%EC%9D%BC%20%ED%99%95%EC%9D%B8%20%EC%97%85%EB%8D%B0%EC%9D%B4%ED%8A%B8&query=$.505501&logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&url=https://github.com/ChinaGodMan/UserScriptsHistory/raw/main/daily_update_checks.json">
...
# Github 원본 파일을 복사하십시오 URL 다운로드 파일로

<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">

## 설명하다

이 사용자 스크립트입니다 GitHub 파일 줄 끝에 추가하십시오단추，사용자를 위해원본 파일을 복사하십시오 URL 그리고파일을 다운로드하십시오。버튼에는 포함됩니다“원본 파일을 복사하십시오 URL”버튼과“파일을 다운로드하십시오”단추。

<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">

## 기능

-   각 파일 줄의 끝에 추가하십시오“원본 파일을 복사하십시오 URL”단추。
-   추가“파일을 다운로드하십시오”단추，사용자가 원본 파일을 다운로드 할 수 있습니다。
-   버튼을 복사하여 원본 파일을 전송합니다 URL 클립 보드에 복사하십시오。
-   다운로드 버튼 파일 다운로드를 트리거합니다。
...
문제가있는 경우，방문하십시오 [지원 페이지](https://github.com/ChinaGodMan/UserScripts/issues)。

<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">

## 고마워하는

사용자로부터 스크립트를 수정하십시오 **[Kamikaze](https://greasyfork.org/zh-CN/users/928242)** ~의스크립트 [Button to copy the raw file URL | Github](https://greasyfork.org/scripts/453489) 원래 저자에게 감사합니다 **Kamikaze** ~의**성실한**그리고**지혜**
