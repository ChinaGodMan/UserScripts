...
이 사용자 스크립트입니다 GitHub 文件行末尾添加단추，以便用户원본 파일을 복사하십시오 URL 和파일을 다운로드하십시오。버튼에는 포함됩니다“复制原始文件 URL”버튼과“下载文件”按钮。
...
사용자로부터 스크립트를 수정하십시오 **[Kamikaze](https://greasyfork.org/zh-CN/users/928242)** ~의脚本 [Button to copy the raw file URL | Github](https://greasyfork.org/scripts/453489) 원래 저자에게 감사합니다 **Kamikaze** 的**성실한**그리고**지혜**
