...
Tập lệnh người dùng này là GitHub 文件行末尾添加Cái nút，以便用户Sao chép tệp gốc URL 和Tải xuống tệp。Các nút bao gồm“复制原始文件 URL”Nút và“下载文件”按钮。
...
Sửa đổi tập lệnh từ người dùng **[Kamikaze](https://greasyfork.org/zh-CN/users/928242)** của脚本 [Button to copy the raw file URL | Github](https://greasyfork.org/scripts/453489) Cảm ơn tác giả ban đầu **Kamikaze** 的**Siêng năng**Và**khôn ngoan**
