...
<!--HISTORY-->
<center><div align="center">
    <h1>Greasyfork 未更新腳本高亮</h1>
    <p>「 Greasyfork 未更新的腳本背景顯示為淺紅色,方便識別這些未更新腳本 」</p>
    ...
    <img src="https://img.shields.io/greasyfork/dt/538259?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=%E7%94%A8%E6%88%B6%E6%95%B8%E9%87%8F">
...
1. 此腳本用於檢測頁面中的腳本列表項
2. 如果某腳本的最後更新時間超過指定的天數，則對其進行高亮顯示(未更新的腳本背景顯示為淺紅)。
3. 可以自定義檢測的時間範圍（以天為單位）。

<!--AUTHORS-->
## 💖 腳本參考或使用了以下腳本:
[🧑‍💻 **@AN drew**](https://greasyfork.org/users/472487) ⇒ 📜 _[greasyfork顯示長時間未更新腳本](https://greasyfork.org/scripts/446140)_
<!--AUTHORS-END-->
<!--SCREENSHOT-->
