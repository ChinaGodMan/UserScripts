...
<div align="right">
    <h6>
        ...
        <a href="https://github.com/ChinaGodMan/UserScripts/blob/main/tiktok-user-info/README.md">简体中文</a> |
        <a href="https://github.com/ChinaGodMan/UserScripts/blob/main/tiktok-user-info/README_en.md">English</a> |
        <a href="https://github.com/ChinaGodMan/UserScripts/blob/main/tiktok-user-info/README_ko.md">한국어</a> |
        <a href="https://github.com/ChinaGodMan/UserScripts/blob/main/tiktok-user-info/README_vi.md">Tiếng Việt</a> |
        <a href="https://github.com/ChinaGodMan/UserScripts/blob/main/tiktok-user-info/README_zh-TW.md">繁體中文</a>
    <br>
...
<!--HISTORY-->
<center><div align="center">
    <h1>Thông tin người dùng Tiktok</h1>
    <p>「 Tiktok hiển thị nhiều thông tin mở rộng hơn về hồ sơ 」</p>
    <img src="https://views.whatilearened.today/views/github/537677/hmjz100.svg" alt="Views">
    <img src="https://img.shields.io/github/size/ChinaGodMan/UserScripts/tiktok-user-info/tiktok-user-info.user.js?color=%23990000">
    <img src="https://img.shields.io/greasyfork/dt/537677?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=S%E1%BB%91%20l%C6%B0%E1%BB%A3ng%20ng%C6%B0%E1%BB%9Di%20d%C3%B9ng">
    <img src="https://img.shields.io/badge/dynamic/json?&label=C%E1%BA%ADp%20nh%E1%BA%ADt%20ki%E1%BB%83m%20tra%20h%C3%A0ng%20ng%C3%A0y&query=$.537677&logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&url=https://github.com/ChinaGodMan/UserScriptsHistory/raw/main/daily_update_checks.json">
    <p>Download:<a href="https://github.com/ChinaGodMan/UserScripts/tree/main/tiktok-user-info">Github</a> | ⭐<a
            href="https://greasyfork.org/scripts/537677">Greasy
            Fork</a></p>
    <img src="https://raw.githubusercontent.com/ChinaGodMan/UserScriptsHistory/main/stats/537677.png">
</div></center>

<!--HISTORY-END-->
<!--TEXT-->

# TikTok Tập lệnh trích xuất thông tin người dùng

Kịch bản này được sử dụng trong TikTok Trích xuất chi tiết người dùng và hiển thị dữ liệu người dùng bổ sung trên trang người dùng。Bao gồm cả người dùng ID、khu vực、ngôn ngữ、Thời gian tạo tài khoản、Số lượng bạn bè, v.v.，Nó cũng cung cấp chức năng tải xuống hình đại diện của người dùng。

---

## Chức năng chính

1. **Phát hiện thay đổi tên người dùng**  
   Bằng cách theo dõi URL và tên người dùng trong dữ liệu người dùng，Phát hiện xem có bất kỳ thay đổi nào không，Nếu thay đổi, trang sẽ được làm mới tự động。

2. **Trích xuất thông tin người dùng**  
   Từ trang `__UNIVERSAL_DATA_FOR_REHYDRATION__` Tập lệnh trích xuất thông tin người dùng，bao gồm：

    - người dùng ID
    - Cờ khu vực và quốc gia
    - Tên ngôn ngữ và ngôn ngữ
    - Thời gian tạo tài khoản
    - Số lượng bạn bè
    - Nó có phải là người bán hay không
    - Nó có phải là một tài khoản tổ chức?
    - Thời gian sửa đổi tên người dùng
    - Thời gian sửa đổi biệt danh

3. **Tải xuống Avatar người dùng**  
   Cung cấp một nút，Nhấp để tải xuống hình đại diện của người dùng trực tiếp，Lưu dưới dạng dấu thời gian `.jpg` tài liệu。

4. **Hiển thị giao diện động**  
   Trong phần chứa tiêu đề chia sẻ trên trang người dùng，Tự động chèn một hộp thông tin，Hiển thị dữ liệu chi tiết được trích xuất。
...
1. **Tập lệnh cài đặt**  
   Sao chép mã vào công cụ quản lý tập lệnh người dùng trình duyệt（giống Tampermonkey）。

2. **Mở TikTok Trang người dùng**  
   Ví dụ `https://www.tiktok.com/@username`。

3. **Xem dữ liệu người dùng**  
   Sau khi tải trang，Hộp thông tin người dùng bổ sung sẽ được hiển thị tự động，Nhấp“Download Profile Pic”Nút có thể tải xuống hình đại diện。

---

## Những điều cần lưu ý

- **Phụ thuộc cấu trúc trang**  
  Kịch bản này phụ thuộc vào TikTok Trang hiện tại DOM kết cấu，giống TikTok Cập nhật cấu trúc trang，Tập lệnh có thể cần được sửa đổi。

- **Nguồn dữ liệu**  
  Dữ liệu có nguồn gốc từ `__UNIVERSAL_DATA_FOR_REHYDRATION__` Thẻ tập lệnh，Nếu thẻ này không tồn tại，Tập lệnh sẽ không chạy。

- **Tải xuống Avatar**  
  Tải xuống sự phụ thuộc chức năng `GM_download`，Cần hỗ trợ Greasemonkey / Tampermonkey。

---

## Ví dụ

Hộp thông báo chứa nội dung sau：

- người dùng ID
- khu vực（Với cờ quốc gia）
- ngôn ngữ（Với tên đầy đủ）
- Thời gian tạo tài khoản
- Số lượng bạn bè
- Trạng thái tài khoản người bán và tổ chức
- Tên người dùng và thời gian sửa đổi tên
- Nút tải xuống avatar người dùng
