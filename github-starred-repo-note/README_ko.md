...
<!--HISTORY-->
<center><div align="center">
    <h1>Github Star Warehouse Notes Assistant</h1>
    <p>「 스타 저장소의 목적을 잊었습니까? 이것은 좋아하는 저장소에 메모를 추가 할 수있는 스크립트이며, 귀하가 댓글을 달아 Github Gist에 업로드하여 다운로드 할 수 있습니다. 」</p>
    ...
    <img src="https://img.shields.io/greasyfork/dt/533511?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=%EC%82%AC%EC%9A%A9%EC%9E%90%20%EC%88%98">
    <img src="https://img.shields.io/badge/dynamic/json?&label=%EB%A7%A4%EC%9D%BC%20%ED%99%95%EC%9D%B8%20%EC%97%85%EB%8D%B0%EC%9D%B4%ED%8A%B8&query=$.533511&logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&url=https://github.com/ChinaGodMan/UserScriptsHistory/raw/main/daily_update_checks.json">
...
이것은 당신을위한 것입니다 star 창고에 메모를 추가하는 스크립트,그리고 당신이 기록한 정보는 업로드 및 다운로드 할 수 있습니다. GitHub Gist

## 소개

한 번 Star 창고에서 그들의 목적을 잊었습니까?？**GitHub RepoNotesHelper** 그것은 당신을 위해 맞춤형 대본입니다，당신을 허용합니다 Star 창고에 메모를 추가하십시오。더 나은 것은，메모를 업로드 할 수 있습니다 **GitHub Gist**，언제든지 백업 및 복원，편리하고 안전합니다！

---

## 기능

-   **메모를 추가하십시오**：~을 위한 Star ~의 GitHub 저장소에 사용자 정의 노트를 추가하십시오，편리한 기억。
-   **쉽게 관리합니다**：비고는 저장소 페이지에 직접 내장됩니다，직관적이고 효율적입니다。
-   **데이터 동기화**：업로드 메모를 지원합니다 GitHub Gist，언제든지 데이터를 다운로드하여 복구하십시오。
-   **원활한 통합**：페이지의 모든 저장소를 자동으로 감지하고 메모 추가，수동 개입이 필요하지 않습니다。
...
여기서 나는 당신에게 그것을 줄 수 있습니다 star 창고에 메모를 추가하십시오 <br>

![2025.04.21](https://s2.loli.net/2025/04/21/vCNOWuMFUSRLGm5.png)

여기에서 메모를 업로드하고 다운로드 할 수 있습니다 Gist<br>
