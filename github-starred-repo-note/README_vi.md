...
<div align="right">
    <h6>
        ...
        <a href="https://github.com/ChinaGodMan/UserScripts/blob/main/github-starred-repo-note/README.md">简体中文</a> |
        <a href="https://github.com/ChinaGodMan/UserScripts/blob/main/github-starred-repo-note/README_en.md">English</a> |
        <a href="https://github.com/ChinaGodMan/UserScripts/blob/main/github-starred-repo-note/README_ko.md">한국어</a> |
        <a href="https://github.com/ChinaGodMan/UserScripts/blob/main/github-starred-repo-note/README_vi.md">Tiếng Việt</a> |
        <a href="https://github.com/ChinaGodMan/UserScripts/blob/main/github-starred-repo-note/README_zh-TW.md">繁體中文</a>
    <br>
...
<!--HISTORY-->
<center><div align="center">
    <h1>Github Star Warehouse Ghi chú Trợ lý</h1>
    <p>「 Bạn đã quên mục đích của kho sao? Đây là một tập lệnh có thể thêm ghi chú vào kho lưu trữ yêu thích của bạn và thông tin bạn nhận xét có thể được tải lên và tải xuống 」</p>
    ...
    <img src="https://img.shields.io/greasyfork/dt/533511?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=S%E1%BB%91%20l%C6%B0%E1%BB%A3ng%20ng%C6%B0%E1%BB%9Di%20d%C3%B9ng">
    <img src="https://img.shields.io/badge/dynamic/json?&label=C%E1%BA%ADp%20nh%E1%BA%ADt%20ki%E1%BB%83m%20tra%20h%C3%A0ng%20ng%C3%A0y&query=$.533511&logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&url=https://github.com/ChinaGodMan/UserScriptsHistory/raw/main/daily_update_checks.json">
    <p>Download:<a href="https://github.com/ChinaGodMan/UserScripts/tree/main/github-starred-repo-note">Github</a> | ⭐<a
            ...
            Fork</a></p><details><summary style="color:#FFD700">Cập nhật hồ sơ</summary><div align="right"><a href="https://github.com/ChinaGodMan/UserScripts/tree/main/github-starred-repo-note/CHANGELOG.md"><img src="https://img.shields.io/badge/-GitHub-3A3A3A?style=flat&logo=GitHub&logoColor=white"></a></div><h1><strong>🛠️ GitHub Trợ lý ghi chú của Star Warehouse Cập nhật nhật ký</strong></h1>
<h3><strong>📅 2025.04.24.1933</strong></h3>
<p><strong>t tối ưu hóa</strong>:Di dời<code>alert</code> Thay đổi thành <code>toast</code></p>
<hr />
...
Đây là một cho bạn star Tập lệnh để thêm ghi chú vào kho,Và thông tin bạn lưu ý có thể được tải lên và tải xuống GitHub Gist

## Giới thiệu

một lần Star Bạn đã quên mục đích của họ trong kho?？**GitHub RepoNotesHelper** Nó là một kịch bản phù hợp với bạn，Cho phép bạn Star Thêm ghi chú vào kho。Điều thậm chí còn tốt hơn là，Ghi chú của bạn có thể được tải lên **GitHub Gist**，Sao lưu và khôi phục bất cứ lúc nào，Thuận tiện và an toàn！

---

## Chức năng

-   **Thêm một ghi chú**：vì Star của GitHub Thêm ghi chú tùy chỉnh trong kho lưu trữ，Bộ nhớ thuận tiện。
-   **Dễ dàng quản lý**：Nhận xét được nhúng trực tiếp vào trang kho lưu trữ，Trực quan và hiệu quả。
-   **Đồng bộ hóa dữ liệu**：Hỗ trợ tải lên ghi chú lên GitHub Gist，Tải xuống và khôi phục dữ liệu bất cứ lúc nào。
-   **Tích hợp liền mạch**：Tự động phát hiện tất cả các kho lưu trữ trên trang và thêm ghi chú，Không cần can thiệp thủ công。

<!--AUTHORS-->
## 💖 Tập lệnh được tham chiếu hoặc sử dụng tập lệnh sau:
[🧑‍💻 **@malagebidi**](https://greasyfork.org/users/314803) ⇒ 📜 _[RepoNotes](https://greasyfork.org/scripts/531335)_
<!--AUTHORS-END-->
<!--SCREENSHOT-->

Ở đây tôi có thể đưa nó cho bạn star Thêm ghi chú vào kho <br>

![2025.04.21](https://s2.loli.net/2025/04/21/vCNOWuMFUSRLGm5.png)

Tại đây bạn có thể tải lên và tải ghi chú của mình lên Gist<br>
![2025.04.21](https://s2.loli.net/2025/04/21/4hZHprwL3BOARTK.png)
