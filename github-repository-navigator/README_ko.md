...
<center><div align="center">
    ...
    <p>Download:<a href="https://github.com/ChinaGodMan/UserScripts/tree/main/github-repository-navigator">Github</a> | ⭐<a
            ...
            Fork</a></p><details><summary style="color:#FFD700">레코드 업데이트</summary><div align="right"><a href="https://github.com/ChinaGodMan/UserScripts/tree/main/github-repository-navigator/CHANGELOG.md"><img src="https://img.shields.io/badge/-GitHub-3A3A3A?style=flat&logo=GitHub&logoColor=white"></a></div><p>초기 버전,환영</p></details>
...
GitHub Quick Jump Assistant는 사용자가 빠르게 액세스 할 수 있도록 특별히 설계되었습니다. GitHub 창고에서 설계되었습니다。개발자의 사용을 크게 향상시킬 수 있습니다 GitHub 현재 효율성。

## 주요 기능

1. **빠른 점프 버튼**：존재하다 GitHub 페이지에 편리한 버튼을 추가하십시오，사용자가 한 번의 클릭으로 모든 리포지토리로 점프 할 수 있습니다.。
2. **사용자 정의 저장소 목록**：사용자의 저장소 목록을 자동으로 얻고 표시합니다，필터링 및 정렬을 지원합니다，사용자는 대상 저장소를 빠르게 찾을 수 있습니다。
3. **사용하기 쉽습니다**：간단한 사용자 인터페이스，사용자가 신속하게 시작할 수 있습니다，복잡한 구성이 필요하지 않습니다。
4. **모바일 장치에서 사용할 수 있습니다**：모바일 장치에 적응합니다，사용자가 휴대 전화에서 창고에 쉽게 액세스 할 수 있도록합니다.。(왼쪽 상단 코너의 새끼 고양이 아이콘을 클릭해야합니다.)

## 사용 지침

1. 설치하다 Tampermonkey 또는 다른 사용자 스크립트 관리자。
2. 위의 것을 클릭하십시오 "설치하다" 단추，브라우저에 스크립트를 추가하십시오。
3. 존재하다 GitHub 페이지의 새로 추가 된 빠른 점프 버튼을 클릭하십시오.，저장소 목록을보고 빠르게 액세스 할 수 있습니다.。

## 주목해야 할 것

-   개인 창고에 액세스하려면,직접 추가 해주세요 GitHub Token 스크립트 설정으로 이동하십시오。
-   확인하십시오 GitHub 저장소에 액세스 할 수있는 충분한 권한이 있습니다。
-   스크립트는 모든 공통 브라우저에 적합합니다，그러나 다른 장치에는 약간의 차이가있을 수 있습니다。
