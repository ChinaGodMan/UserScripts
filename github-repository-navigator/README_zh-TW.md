...
<center><div align="center">
    ...
    <p>「 🤠 GitHub 倉庫快速跳轉助手，專為幫助用戶快速訪問自己在 GitHub 上的倉庫而設計 。它在導航欄頂部生成一個按鈕,點擊展開自己的所有倉庫，輕鬆跳轉到自己的 GitHub 倉庫頁面，而無需使用 GitHub 的二級菜單 」</p>
    ...
    <p>Download:<a href="https://github.com/ChinaGodMan/UserScripts/tree/main/github-repository-navigator">Github</a> | ⭐<a
            ...
            Fork</a></p><details><summary>更新記錄</summary><p>初始版本,歡迎使用</p></details>
