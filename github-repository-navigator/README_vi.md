...
<!--HISTORY-->
<center><div align="center">
    <h1>Trợ lý nhảy nhanh kho GitHub</h1>
    <p>「 🤠 Trợ lý nhảy nhanh kho GitHub, được thiết kế đặc biệt để giúp người dùng truy cập nhanh vào kho của họ trên GitHub. Nó tạo ra một nút ở đầu thanh điều hướng. Nhấp để mở rộng tất cả các kho lưu trữ của bạn và dễ dàng chuyển đến trang kho lưu trữ GitHub của riêng bạn mà không cần sử dụng menu phụ của GitHub. 」</p>
    ...
    <img src="https://img.shields.io/greasyfork/dt/515205?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=S%E1%BB%91%20l%C6%B0%E1%BB%A3ng%20ng%C6%B0%E1%BB%9Di%20d%C3%B9ng">
    <img src="https://img.shields.io/badge/dynamic/json?&label=C%E1%BA%ADp%20nh%E1%BA%ADt%20ki%E1%BB%83m%20tra%20h%C3%A0ng%20ng%C3%A0y&query=$.515205&logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&url=https://github.com/ChinaGodMan/UserScriptsHistory/raw/main/daily_update_checks.json">
    <p>Download:<a href="https://github.com/ChinaGodMan/UserScripts/tree/main/github-repository-navigator">Github</a> | ⭐<a
            ...
            Fork</a></p><details><summary style="color:#FFD700">Cập nhật hồ sơ</summary><div align="right"><a href="https://github.com/ChinaGodMan/UserScripts/tree/main/github-repository-navigator/CHANGELOG.md"><img src="https://img.shields.io/badge/-GitHub-3A3A3A?style=flat&logo=GitHub&logoColor=white"></a></div><p>Phiên bản ban đầu,Chào mừng</p></details>
    <img src="https://raw.githubusercontent.com/ChinaGodMan/UserScriptsHistory/main/stats/515205.png">
</div></center>
...
GitHub Trợ lý nhảy nhanh là một người được thiết kế đặc biệt để giúp người dùng nhanh chóng truy cập GitHub Được thiết kế trên kho。Nó có thể cải thiện đáng kể việc sử dụng các nhà phát triển GitHub Hiệu quả tại thời điểm này。

## Chức năng chính

1. **Nút nhảy nhanh**：hiện hữu GitHub Thêm một nút tiện dụng vào trang，Cho phép người dùng nhảy vào tất cả các kho lưu trữ của họ chỉ bằng một cú nhấp chuột。
2. **Danh sách kho lưu trữ tùy chỉnh**：Tự động lấy và hiển thị danh sách kho lưu trữ của người dùng，Hỗ trợ lọc và sắp xếp，Người dùng có thể nhanh chóng tìm thấy kho lưu trữ mục tiêu。
3. **Dễ sử dụng**：Giao diện người dùng đơn giản，Dễ dàng cho người dùng bắt đầu nhanh chóng，Không cần cấu hình phức tạp。
4. **Có sẵn trên thiết bị di động**：Thích ứng với thiết bị di động，Cho phép người dùng dễ dàng truy cập kho của họ trên điện thoại di động của họ。(Bạn cần nhấp vào biểu tượng mèo con ở góc trên bên trái)

## Hướng dẫn sử dụng

1. Cài đặt Tampermonkey hoặc Trình quản lý tập lệnh người dùng khác。
2. Bấm vào những điều trên "Cài đặt" Cái nút，Thêm tập lệnh vào trình duyệt của bạn。
3. hiện hữu GitHub Nhấp vào nút Nhảy nhanh mới được thêm vào trang，Bạn có thể xem danh sách kho lưu trữ của mình và nhanh chóng truy cập nó。

## Những điều cần lưu ý

-   Để truy cập một nhà kho riêng,Vui lòng thêm của riêng bạn GitHub Token Chuyển đến Cài đặt tập lệnh。
-   Hãy đảm bảo GitHub Có đủ quyền để truy cập kho lưu trữ của bạn。
-   Các tập lệnh phù hợp cho tất cả các trình duyệt thông thường，Nhưng có thể có một số khác biệt trên các thiết bị khác nhau。

![Snipaste_2024-11-01_19-50-13.png](https://s2.loli.net/2024/11/01/AWopjtOVhEcYKxC.png)
