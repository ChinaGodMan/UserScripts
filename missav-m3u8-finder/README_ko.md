...
<!--HISTORY-->
<center><div align="center">
    <h1>Missav 비디오 다운로드 도구</h1>
    <p>「 현재 Missav 재생 페이지에서 비디오의 실제 다운로드 주소를 스니핑하고 다운로드하십시오. 」</p>
    ...
    <img src="https://img.shields.io/greasyfork/dt/528160?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=%EC%82%AC%EC%9A%A9%EC%9E%90%20%EC%88%98">
    <img src="https://img.shields.io/badge/dynamic/json?&label=%EB%A7%A4%EC%9D%BC%20%ED%99%95%EC%9D%B8%20%EC%97%85%EB%8D%B0%EC%9D%B4%ED%8A%B8&query=$.528160&logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&url=https://github.com/ChinaGodMan/UserScriptsHistory/raw/main/daily_update_checks.json">
...
人民的勤务员 수정: [MissAv m3u8 finder](https://greasyfork.org/zh-CN/scripts/502821)

# missav m3u8 뷰어

비디오 재생 페이지에서 비디오를 볼 수 있습니다. m3u8 주소
사용 가능 [m3u8 다운로더](https://github.com/nilaoda/N_m3u8DL-RE)시청하려면 다운로드
다운로드 기능이 추가되었습니다，다중 스레드 비동기 다운로드。진행 상황 표시가 없습니다，기다리세요~
다운로드 진행 상황 디스플레이를 늘리십시오。묻지 마세요。업데이트하는 것이 매우 빠릅니다
