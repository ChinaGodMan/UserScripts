...
<!--HISTORY-->
<center><div align="center">
    <h1>GitHub displays file and folder sizes</h1>
    <p>「 Displays the size of each file and folder in the GitHub repository. It uses the GitHub API to get details, including recursive folder sizes, making it easy to see the total size of nested directories. Display file size in KB, MB, or GB 」</p>
    ...
    <img src="https://img.shields.io/greasyfork/dt/537310?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=Number%20of%20users">
    <img src="https://img.shields.io/badge/dynamic/json?&label=Daily%20check%20updates&query=$.537310&logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&url=https://github.com/ChinaGodMan/UserScriptsHistory/raw/main/daily_update_checks.json">
    <p>Download:<a href="https://github.com/ChinaGodMan/UserScripts/tree/main/github-file-size-viewer">Github</a> | ⭐<a
            ...
            Fork</a></p><details><summary style="color:#FFD700">Update records</summary><div align="right"><a href="https://github.com/ChinaGodMan/UserScripts/tree/main/github-file-size-viewer/CHANGELOG.md"><img src="https://img.shields.io/badge/-GitHub-3A3A3A?style=flat&logo=GitHub&logoColor=white"></a></div><h1><strong>🛠️ GitHub Show file and folder sizes Update log</strong></h1>
<h3><strong>📅 2025.9.2.1</strong></h3>
<p><strong>New</strong>: <a href="https://github.com/aspen138">aspen138</a>exist<a href="https://github.com/ChinaGodMan/UserScripts/issues/188">#188</a> Added new features<code>Display the number of files</code> </p>
<details>
  <summary>Function display</summary>
<img src="https://s2.loli.net/2025/09/02/PS6w42WGiOLrqRZ.png" alt="Function display" width="500" height="900">
</details>
...
# GitHub File Size Viewer (GitHub document/Folder Size Display Tool)

This script passes GitHub API Get the size of files and folders，and display it in GitHub Files corresponding to the warehouse page/Next to the folder link。  
Support recursive calculation of folder size，Provides a humanized size format。

## Functional Features

-   show GitHub File and folder size
-   Automatically recursively calculate the total folder size
-   In the file/Display size visually next to the folder link

## How to use

-   Make sure the configuration is valid GitHub Personal access token（`GITHUB_TOKEN`）[Here](https://github.com/settings/tokens/new?description=GitHub%20File%20Size%20Viewer&scopes=repo)Generate a new token，To avoid API Request restrictions。
-   Open any GitHub Warehouse page，The script will run automatically，And in the file/Display size next to folder link。
