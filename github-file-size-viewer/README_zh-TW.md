...
<!--HISTORY-->
<center><div align="center">
    <h1>GitHub 顯示文件和文件夾大小</h1>
    <p>「 顯示 GitHub 存儲庫中每個文件和文件夾的大小。 它使用 GitHub API 獲取詳細信息，包括遞歸文件夾大小，從而輕鬆查看嵌套目錄的總大小。 以 KB、MB 或 GB 顯示文件大小 」</p>
    ...
    <img src="https://img.shields.io/greasyfork/dt/537310?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=%E7%94%A8%E6%88%B6%E6%95%B8%E9%87%8F">
    <img src="https://img.shields.io/badge/dynamic/json?&label=%E6%AF%8F%E6%97%A5%E6%AA%A2%E6%9F%A5%E6%9B%B4%E6%96%B0%E6%AC%A1%E6%95%B8&query=$.537310&logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&url=https://github.com/ChinaGodMan/UserScriptsHistory/raw/main/daily_update_checks.json">
    <p>Download:<a href="https://github.com/ChinaGodMan/UserScripts/tree/main/github-file-size-viewer">Github</a> | ⭐<a
            ...
            Fork</a></p><details><summary style="color:#FFD700">更新記錄</summary><div align="right"><a href="https://github.com/ChinaGodMan/UserScripts/tree/main/github-file-size-viewer/CHANGELOG.md"><img src="https://img.shields.io/badge/-GitHub-3A3A3A?style=flat&logo=GitHub&logoColor=white"></a></div><h1><strong>🛠️ GitHub 顯示文件和文件夾大小 更新日誌</strong></h1>
<h3><strong>📅 2025.9.2.1</strong></h3>
<p><strong>新增</strong>: <a href="https://github.com/aspen138">aspen138</a>在<a href="https://github.com/ChinaGodMan/UserScripts/issues/188">#188</a> 添加了新功能<code>顯示文件數量</code> </p>
<details>
  <summary>功能展示</summary>
<img src="https://s2.loli.net/2025/09/02/PS6w42WGiOLrqRZ.png" alt="功能顯示" width="500" height="900">
</details>
...
# GitHub File Size Viewer (GitHub 文件/文件夾大小顯示工具)

本腳本通過 GitHub API 獲取文件和文件夾的大小，並將其顯示在 GitHub 倉庫頁面對應的文件/文件夾鏈接旁邊。  
支持遞歸計算文件夾大小，提供人性化的大小格式。

## 功能特點

-   顯示 GitHub 文件和文件夾的大小
-   自動遞歸計算文件夾總大小
-   在文件/文件夾鏈接旁邊以直觀方式顯示大小

## 使用方法

-   確保配置了有效的 GitHub 個人訪問令牌（`GITHUB_TOKEN`）[此處](https://github.com/settings/tokens/new?description=GitHub%20File%20Size%20Viewer&scopes=repo)生成新令牌，以避免 API 請求限制。
-   打開任意 GitHub 倉庫頁面，腳本會自動運行，並在文件/文件夾鏈接旁顯示大小。
