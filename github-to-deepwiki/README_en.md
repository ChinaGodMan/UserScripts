...
<center><div align="center">
    ...
    <p>Download:<a href="https://github.com/ChinaGodMan/UserScripts/tree/main/github-to-deepwiki">Github</a> | ⭐<a
            ...
            Fork</a></p><details><summary style="color:#FFD700">Update records</summary><div align="right"><a href="https://github.com/ChinaGodMan/UserScripts/tree/main/github-to-deepwiki/CHANGELOG.md"><img src="https://img.shields.io/badge/-GitHub-3A3A3A?style=flat&logo=GitHub&logoColor=white"></a></div><h1><strong>🛠️ github-to-deepwiki Update log</strong></h1>
<h3><strong>📅 2025.5.17.1</strong></h3>
<p><strong>New</strong>: • Dynamic monitoringURLchange，Automatic insertionDeepWikiButton.Support desktop and mobile devices </p>
<hr /></details>
...
>
> -   [**Foreign Language Terminator**](https://greasyfork.org/scripts/504890): Identify non-Chinese characters. If the length is greater than 5 and the translated text does not contain Chinese, then translate and replace the original text to Chinese.
> -   [**Web page translation – automatic translation into Chinese**](https://greasyfork.org/scripts/505208): Add a Google Translation icon to the lower right corner of each non-Chinese web page (can be adjusted to the lower left corner). This version is a Chinese translation version, and only foreign languages are translated into Chinese, and automatic translation is added.
