...
<p><strong>Sửa chữa</strong>: Thêm vào<code>fr</code> Và <code>fr-CA</code>Hỗ trợ ngôn ngữ,Ở định dạng thời gian của Pháp<code>10.04.2025 20:38</code><a href="https://greasyfork.org/scripts/529359/discussions/295260">#295260</a> <br>
<strong>Ảnh chụp màn hình</strong>:<img alt="2025.04.12" src="https://s2.loli.net/2025/04/12/EqfUv7T6l9ebcLB.png" /></p>
...
# trình diễn Greasyfork Thời gian đăng ký người dùng，Xác định ý kiến ​​độc hại
...
-   **Hiển thị thời gian đăng ký người dùng**：Tập lệnh sẽ tự động có được thời gian đăng ký của người dùng，và hiển thị nó bên cạnh tên người dùng，Giúp phân biệt người dùng mới với người dùng hoạt động dài hạn。
-   **Dự đoán thời gian đăng ký**：Bằng cách truy cập GreasyFork Cung cấp API，Tập lệnh suy đoán và hiển thị thời gian đăng ký của mỗi người dùng。
-   **Xác định tài khoản độc hại**：Nếu thời gian đăng ký là thời gian trong tương lai，Nó có nghĩa là người dùng có thể đã đăng ký một tài khoản độc hại，Cảnh báo người dùng để chú ý。
...
1. 💯 Sau khi cài đặt tập lệnh，Nó sẽ được duyệt trong của bạn GreasyFork hoặc SleazyFork Tự động tải trên trang web。
2. 👍 Khi trang được tải，Kịch bản sẽ hiển thị thời gian đăng ký của người dùng bên cạnh thông tin của người dùng.。
3. ⏲️ Nếu thời gian đăng ký của người dùng đã có trên trang，Tập lệnh sẽ được hiển thị trực tiếp；Nếu không，Một nút sẽ được hiển thị，Bấm để nhận và hiển thị thời gian。(Kịch bản được truyền trực tiếp`GreasyFork`Cung cấp API Nhận thời gian đăng ký，Để ngăn chặn chặn,Vì vậy, thêm nút để lấy nó theo cách thủ công)
4. 🇹🇱 Định dạng thời gian mặc định là`YYYY-MM-DD HH:mm:ss`。Biến tập lệnh`absoluteTime`Thay đổi thành`relative-time`Hiển thị thời gian sử dụng trang web.

## Môi trường áp dụng：

-   💯 ủng hộ Chrome、Firefox、Edge、Opera、Safari、Kiwi Chờ các trình duyệt。

## Thông tin liên hệ：

-   👨‍🦰 **tác giả**: 人民的勤务员@ChinaGodMan
...
1. _Khớp trang danh sách bình luận：[https://greasyfork.org/zh-CN/scripts/\\d+/feedback](https://greasyfork.org/zh-CN/scripts/\d+/feedback)_

![](https://s3.bmp.ovh/imgs/2022/09/02/42c32b26a20c4b01.png)

2. _Trang bình luận phù hợp：[https://greasyfork.org/zh-CN/scripts/\\d+/discussions/\\d](https://greasyfork.org/zh-CN/scripts/\d+/discussions/\d)+_

3. ![](https://s3.bmp.ovh/imgs/2022/09/02/9d5924d4f8412416.png)

4. _Phù hợp với trang thảo luận người dùng：[https://greasyfork.org/zh-CN/discussions?user=\\d](https://greasyfork.org/zh-CN/discussions?user=\d)+_

![](https://s3.bmp.ovh/imgs/2022/09/02/993a3ac7ec9fd2ab.png)

5._Trận đấu danh sách thảo luận：[https://greasyfork.org/zh-CN/discussions](https://greasyfork.org/zh-CN/discussions)_

![](https://s3.bmp.ovh/imgs/2022/09/02/9a7ff6eddf3a74bb.png)

6. _Khớp với các liên kết tác giả tập lệnh trên các trang khác nhau_

![](https://s3.bmp.ovh/imgs/2022/09/02/94b38eda3fb69948.png)

7. _Khớp trang danh sách người dùng [https://greasyfork.org/zh-CN/users](https://greasyfork.org/zh-CN/users)_

![](https://s3.bmp.ovh/imgs/2022/09/03/aa2e429f08ddc797.png)

8. _Phù hợp với trang bảng script：[https://greasyfork.org/zh-CN/scripts](https://greasyfork.org/zh-CN/discscriptsussions)_
...
> -   [**MissAvBộ sưu tập video dự phòng hàng loạt**](https://greasyfork.org/scripts/497682): Từ hiện tạimissavTrang để có được tệp hình ảnh và thông tin video，Sau khi kết quả hợp nhất được kết hợp, hãy cung cấp tệp trang web đã tải xuống
