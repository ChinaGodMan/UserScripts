...
<!--HISTORY-->
<center><div align="center">
    <h1>GitHub 提交資料顯示網頁視圖</h1>
    <p>「 該腳本將 GitHub 上的提交資訊轉化為 HTML 視圖，以更清晰地查看提交詳情。它會自動將提交資訊列表、提交頭部和最新提交資訊轉化為 HTML 格式，提供更佳的視覺效果與使用者體驗。 」</p>
    ...
    <img src="https://img.shields.io/greasyfork/dt/505830?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=%E7%94%A8%E6%88%B6%E6%95%B8%E9%87%8F">
    <img src="https://img.shields.io/badge/dynamic/json?&label=%E6%AF%8F%E6%97%A5%E6%AA%A2%E6%9F%A5%E6%9B%B4%E6%96%B0%E6%AC%A1%E6%95%B8&query=$.505830&logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&url=https://github.com/ChinaGodMan/UserScriptsHistory/raw/main/daily_update_checks.json">
...
`GitHub CommitMessage Html View` 是一個用戶腳本，旨在將 GitHub 上的提交信息轉換為 HTML 視圖，從而提供更清晰的提交詳情。該腳本自動將提交信息列表、提交頭部和最新提交信息轉換為 HTML 格式，以增強視覺效果和用戶體驗,配合git使用

<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">

## 功能

-   **提交信息列表轉換**: 將提交消息列表中的提交信息轉化為 HTML 視圖。
-   **頭部信息展示**: 顯示提交頭部和最新提交的詳細信息。
-   **增強視覺效果**: 改善提交信息的可視性和用戶體驗。

<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">

## PowerShell配合上傳到遠程倉庫

點擊[qinwuyuan.ps1](https://raw.githubusercontent.com/ChinaGodMan/UserScripts/main/github-commit-viewer/preview/qinwuyuan.ps1)下載Powershell腳本
...
-   [報告問題](https://github.com/ChinaGodMan/UserScripts/issues)
-   [項目主頁](https://github.com/ChinaGodMan/UserScripts)

<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">

## 許可證

此腳本使用 [MIT 許可證](https://opensource.org/licenses/MIT)
