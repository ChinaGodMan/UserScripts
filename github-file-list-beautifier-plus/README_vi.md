...
<!--HISTORY-->
<center><div align="center">
    <h1>GitHub Trình làm đẹp danh sách tập tin</h1>
    ...
    <img src="https://img.shields.io/greasyfork/dt/508047?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=s%E1%BB%91%20l%C6%B0%E1%BB%A3ng%20ng%C6%B0%E1%BB%9Di%20d%C3%B9ng">
    <img src="https://img.shields.io/badge/dynamic/json?&label=Ki%E1%BB%83m%20tra%20c%E1%BA%ADp%20nh%E1%BA%ADt%20h%C3%A0ng%20ng%C3%A0y&query=$.508047&logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&url=https://github.com/ChinaGodMan/UserScriptsHistory/raw/main/daily_update_checks.json">
    <p>Download:<a href="https://github.com/ChinaGodMan/UserScripts/tree/main/github-file-list-beautifier-plus">Github</a> | ⭐<a
            ...
            Fork</a></p><details><summary style="color:#FFD700">Cập nhật bản ghi</summary><div align="right"><a href="https://github.com/ChinaGodMan/UserScripts/tree/main/github-file-list-beautifier-plus/CHANGELOG.md"><img src="https://img.shields.io/badge/-GitHub-3A3A3A?style=flat&logo=GitHub&logoColor=white"></a></div><h1><strong>🛠️ GitHub Trình làm đẹp danh sách tập tin Nhật ký thay đổi</strong></h1>
<h3><strong>📅 2026.3.5.1</strong></h3>
<p><strong>Sửa chữa</strong>: Thay đổi<code>.sh</code>Liên kết biểu tượng tập tin，Ôn lại<code>powershell</code>màu văn bản，Xóa nội dung gỡ lỗi</p>
<hr />
<h3><strong>📅 2024/9/12 11:35 - Ver 4.1</strong></h3>
<p><strong>Mới</strong>: Đã thêm biểu tượng cho tập tin,Đã thêm màu sắc và biểu tượng tệp tùy chỉnh。</p>
<hr /></details>
...
# GitHub Danh sách tập tin làm đẹp

## Giới thiệu

GitHub Danh sách tệp làm đẹp là một tập lệnh người dùng，Để tăng cường GitHub Hiệu ứng hiển thị tệp trong kho。Nó có thể thêm màu sắc vào các tệp và thư mục，và thay thế biểu tượng loại tệp bằng một hình ảnh nhỏ，Làm cho cơ sở mã dễ dàng hơn để duyệt và quản lý。

<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">

## Chức năng

-   **Biểu tượng thư mục**：Thay thế biểu tượng thư mục bằng biểu tượng thư mục trực quan hơn。
-   **Các biểu tượng tùy chỉnh**：Theo tiện ích mở rộng tệp hoặc tên tệp，Hiển thị các biểu tượng tùy chỉnh。
-   **Xem trước tệp hình ảnh**：Cho các tập tin hình ảnh，Tự động hiển thị hình thu nhỏ。
-   **Điểm đánh dấu màu**：Thêm màu sắc vào các loại tệp khác nhau，Để xác định các loại tệp nhanh hơn。

<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">

## Xin lưu ý:

**Tập lệnh này được thiết kế để tô màu các loại tệp khác nhau,Biểu tượng hiển thị chỉ được bao gồm,Nếu cần Github Hiển thị biểu tượng,Tải xuống được đề xuất**
...
1. **Cài đặt Tampermonkey hoặc Greasemonkey Plugin**：

    - [Tampermonkey](https://www.tampermonkey.net/)（ủng hộ Chrome, Firefox, Edge, Opera Chờ các trình duyệt）
    - [Greasemonkey](https://www.greasespot.net/)（ủng hộ Firefox）

2. **Thêm tập lệnh**：

    - Nhấp Cài đặt đến Tampermonkey Greasemonkey 。

3. **Cấu hình tập lệnh**：
    - Tập lệnh sẽ được chỉ định khi nó được chạy đầu tiên URL Tải cấu hình màu。Nếu cấu hình không thể được tải，Các cài đặt mặc định sẽ được sử dụng。

<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">

## sử dụng

-   Kịch bản sẽ ở GitHub Tự động chạy khi trang được tải，Xử lý biểu tượng tệp trong danh sách tệp。
-   Có thể được sử dụng khi cần thiết `localStorage` Hoặc điều chỉnh biểu tượng và cấu hình màu trong cài đặt tập lệnh。
...
-   Tên tuyệt đối：(Được sử dụng để hiển thị các biểu tượng,Tùy chỉnh màu của các tệp tuyệt đối chưa được thêm vào)
    `
"123.txt": {
    "color": "red",
    "icon": "javascript"
},`
-   Mặc định từ vscode-material-icon-theme Nhận biểu tượng：
    `    "123.txt": {
    "color": "red",
    "icon": "javascript"
},`
-   Tải biểu tượng từ mạng：
    `
"123.txt": {
    "color": "red",
    "icon": "https://www.1.com/1.png"
},`
-   Tải biểu tượng từ địa phương：
    `
"123.txt": {
    "color": "red",
...
-   **Trình duyệt**：ủng hộ Chrome、Firefox、Edge、Opera Và Safari。

<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">

## Hỗ trợ và Phản hồi

-   Nếu bạn có bất kỳ vấn đề hoặc có bất kỳ đề xuất nào，Vui lòng truy cập [GitHub Issues trang](https://github.com/ChinaGodMan/UserScripts/issues) Gửi phản hồi。

<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">

## Ủy quyền

-   Kịch bản dựa trên [MIT giấy phép](https://opensource.org/licenses/MIT) Nguồn mở。

<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">

## đóng góp

-   Kịch bản này là [wOxxOm](https://greasyfork.org/zh-CN/users/2159) [GitHub file list beautifier](https://greasyfork.org/zh-CN/scripts/5982) Và 人民的勤务员 Phát triển。
-   Để biết thêm thông tin, vui lòng truy cập [GitHub Trang chủ dự án](https://github.com/ChinaGodMan/UserScripts)。
