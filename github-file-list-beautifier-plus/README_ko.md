...
<!--HISTORY-->
<center><div align="center">
    <h1>GitHub 파일 목록 미화자</h1>
    <p>「 GitHub File List Beautifier는 사용자 스크립트입니다.，향상시키는 데 사용됨 GitHub 창고 내 파일 표시 효과。파일과 폴더에 색상을 추가할 수 있습니다.，파일 형식 아이콘을 작은 이미지로 바꿉니다.，코드 베이스를 더 쉽게 찾아보고 관리할 수 있습니다.。유형별로 파일에 색상 및 아이콘 추가，저장소 소스 트리의 파일 유형 아이콘 대신 작은 이미지 표시 」</p>
    ...
    <img src="https://img.shields.io/greasyfork/dt/508047?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=%EC%82%AC%EC%9A%A9%EC%9E%90%20%EC%88%98">
    <img src="https://img.shields.io/badge/dynamic/json?&label=%EB%A7%A4%EC%9D%BC%20%EC%97%85%EB%8D%B0%EC%9D%B4%ED%8A%B8%20%ED%99%95%EC%9D%B8&query=$.508047&logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&url=https://github.com/ChinaGodMan/UserScriptsHistory/raw/main/daily_update_checks.json">
...
# GitHub 파일 목록 Beautifier

## 소개

GitHub 파일 목록 Beautifier는 사용자 스크립트입니다，향상을 위해 GitHub 창고의 파일 표시 효과。파일과 폴더에 색상을 추가 할 수 있습니다，파일 유형 아이콘을 작은 이미지로 바꾸십시오.，코드 기반을 쉽게 탐색하고 관리 할 수 ​​있도록합니다。

<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">

## 기능

-   **폴더 아이콘**：보다 직관적 인 폴더 아이콘으로 폴더 아이콘을 교체하십시오。
-   **사용자 정의 아이콘**：파일 확장자 또는 파일 이름에 따라，사용자 정의 아이콘을 보여줍니다。
-   **이미지 파일 미리보기**：사진 파일의 경우，썸네일을 자동으로 표시합니다。
-   **컬러 마커**：다른 유형의 파일에 색상을 추가하십시오，파일 유형을 더 빨리 식별합니다。

<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">

## 참고하십시오:

**이 스크립트는 다른 파일 유형을 색칠하도록 설계되었습니다,디스플레이 아이콘은 포함됩니다,필요한 경우 Github 아이콘을 표시하십시오,권장 다운로드**
...
1. **설치하다 Tampermonkey 또는 Greasemonkey 플러그인**：

    - [Tampermonkey](https://www.tampermonkey.net/)（지원하다 Chrome, Firefox, Edge, Opera 브라우저를 기다리십시오）
    - [Greasemonkey](https://www.greasespot.net/)（지원하다 Firefox）

2. **스크립트를 추가하십시오**：

    - 딸깍 하는 소리 설치하십시오 Tampermonkey Greasemonkey 。

3. **스크립트 구성**：
    - 스크립트는 처음 실행될 때 지정됩니다. URL 색상 구성로드。구성을로드 할 수없는 경우，기본 설정이 사용됩니다。

<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">

## 사용

-   스크립트가 있습니다 GitHub 페이지가로드되면 자동으로 실행됩니다，파일 목록의 프로세스 파일 아이콘。
-   필요에 따라 사용할 수 있습니다 `localStorage` 또는 스크립트 설정에서 아이콘 및 색상 구성을 조정하십시오。
...
-   절대 이름：(아이콘을 표시하는 데 사용됩니다,절대 파일의 사용자 정의 색소는 아직 추가되지 않았습니다.)
    `
"123.txt": {
    "color": "red",
    "icon": "javascript"
},`
-   기본값 vscode-material-icon-theme 아이콘을 얻으십시오：
    `    "123.txt": {
    "color": "red",
    "icon": "javascript"
},`
...
-   **브라우저**：지원하다 Chrome、Firefox、Edge、Opera 그리고 Safari。

<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">

## 지원 및 피드백

-   문제가 있거나 제안이있는 경우，방문하십시오 [GitHub Issues 페이지](https://github.com/ChinaGodMan/UserScripts/issues) 피드백을 제출하십시오。

<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">

## 권한 부여

-   스크립트는 기반입니다 [MIT 특허](https://opensource.org/licenses/MIT) 오픈 소스。

<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">

## 기여하다

-   이 스크립트입니다 [wOxxOm](https://greasyfork.org/zh-CN/users/2159) [GitHub file list beautifier](https://greasyfork.org/zh-CN/scripts/5982) 그리고 人民的勤务员 개발。
-   자세한 내용은 방문하십시오 [GitHub 프로젝트 홈페이지](https://github.com/ChinaGodMan/UserScripts)。
