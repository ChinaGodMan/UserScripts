...
<center><div align="center">
    <h1>GitHub 파일 목록 Beautifier</h1>
    <p>「 GitHub 파일 목록 Beautifier는 사용자 스크립트입니다，향상을 위해 GitHub 창고의 파일 표시 효과。파일과 폴더에 색상을 추가 할 수 있습니다，파일 유형 아이콘을 작은 이미지로 바꾸십시오.，코드 기반을 쉽게 탐색하고 관리 할 수 ​​있도록합니다。유형별 파일에 색상과 아이콘을 추가하십시오，파일 유형 아이콘 대신 저장소 소스 트리에 작은 이미지 표시 」</p>
    ...
    <p>Download:<a href="https://github.com/ChinaGodMan/UserScripts/tree/main/github-file-list-beautifier-plus">Github</a> | ⭐<a
            ...
            Fork</a></p><details><summary>레코드 업데이트</summary><h1><strong>🛠️ GitHub 파일 목록 Beautifier 로그 업데이트</strong></h1>
