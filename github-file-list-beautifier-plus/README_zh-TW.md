...
<center><div align="center">
    ...
    <p>「 GitHub 文件列表美化器是一個用戶腳本，用於增強 GitHub 倉庫中的文件顯示效果。它可以為文件和文件夾添加顏色，並將文件類型圖標替換為小圖像，使得代碼庫更加易於瀏覽和管理。按類型為文件添加顏色和圖標，在存儲庫源樹中顯示小圖像以代替文件類型圖標 」</p>
    ...
    <p>Download:<a href="https://github.com/ChinaGodMan/UserScripts/tree/main/github-file-list-beautifier-plus">Github</a> | ⭐<a
            ...
            Fork</a></p><details><summary>更新記錄</summary><h1><strong>🛠️ GitHub 文件列表美化器 更新日誌</strong></h1>
