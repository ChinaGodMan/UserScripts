...
<p><strong>수리하다</strong>: • 청취 규칙의 변화로 인한 동적 청취 실패 고정。<br />
...
• 증가하다 <a href="https://greasyfork.org/zh-CN/scripts/475722">GreasyFork 최적화</a> 이중 열의 스크립트가 표시됩니다。<br />
• 증가하다 <a href="https://greasyfork.org/zh-CN/scripts/475722">GreasyFork 최적화</a> 내비게이션 바를 아름답게하십시오。<br />
...
<p><strong>새로운</strong>:<br />
• 측면 탐색 바 스위치를 추가하십시오。<br />
• 이미지 에이전트를 추가하십시오（켜질 때 호환되지 않습니다 <a href="https://greasyfork.org/zh-CN/scripts/475722">GreasyFork 최적화</a> 사진 탐색）。<br />
<strong>수리하다</strong>:<br />
• 모바일 장치에서 사진 브라우징이 브라우저를 초과하는 문제를 수정했습니다.。<br />
• 코드를 편집 할 때 Beautify를 자동으로 확인하십시오。</p>
<hr />
<h3><strong>📅 2024/7/14 - Ver 2.2.0.6</strong></h3>
<p><strong>새로운</strong>:<br />
• 탐색 표시 줄을 추가하여 확장하십시오 "더"。<br />
• 증가하다 <a href="https://greasyfork.org/zh-CN/scripts/467078">Greasy Fork 향상되었습니다</a> 측면 탐색 표시 줄。<br />
<strong>최적화</strong>: • 다국어에 대한 지원을 향상시킵니다。</p>
<hr />
<h3><strong>📅 2024/7/13 - Ver 2.2.0.5</strong></h3>
<p><strong>새로운</strong>: • 자동 로그인을 추가하십시오 <a href="https://greasyfork.org/zh-CN/scripts/475722">GreasyFork 최적화</a>。<br />
<strong>수리하다</strong>: • 디스플레이 목록에서 스크립트 설치 상태를 수정했습니다。<br />
<strong>최적화</strong>: • 다국어에 대한 지원을 향상시킵니다。</p>
<hr /></details>
...
>
> -   [**Greasy fork스크립트 페이지는 URL 향상에 적합합니다**](https://greasyfork.org/scripts/497317): 스크립트 세부 정보 페이지는 기본 URL 리디렉션없이 검색에 적합합니다. 클릭 가능한 텍스트 링크로 전환하고 프롬프트를 팝업하십시오.
