...
<h2><a href="https://greasyfork.org/zh-CN/scripts/424966">Dịch web——Dịch sang tiếng Trung</a>Sửa đổi tập lệnh thành bản dịch tự động.Không cần nhấp hoặc nhấn phím</h2>
<h2>Ghi chú đặc biệt</h2>
<ul>
    <li>
        <p><span style="color: red; --darkreader-inline-color: #f61c1c;" data-darkreader-inline-color="">Đã được điều chỉnh PC
                kết thúc，Di động</span></p>
    </li>
    <li>
        <p><span style="color: red; --darkreader-inline-color: #f61c1c;"
                data-darkreader-inline-color="">Phiên bản này chủ yếu được dịch sang tiếng Trung chỉ dành cho ngoại ngữ，Nếu bạn cần nhiều bản dịch ngôn ngữ，Vui lòng tải xuống tập lệnh gốc trực tiếp：</span><a
                href="https://greasyfork.org/zh-CN/scripts/398746-%E7%BD%91%E9%A1%B5%E7%BF%BB%E8%AF%91">Dịch web</a></p>
    </li>
</ul>
<h2>1 Giới thiệu chức năng</h2>
<ul>
    <li>Cung cấp cho mọi trang web không phải người Trung Quốc để<span style="color: red; --darkreader-inline-color: #f61c1c;"
            data-darkreader-inline-color="">Góc dưới bên trái</span>Thêm một google Biểu tượng dịch，hiện hữu<span
            style="color: red; --darkreader-inline-color: #f61c1c;" data-darkreader-inline-color="">Góc dưới bên phải</span>Thêm một nút để hiển thị trang web gốc
    </li>
    <li>phím tắt：Nhấp vào biểu tượng cho Monkey Oil hoặc Mở rộng Khỉ bạo lực，Có một kịch bản bên dưới【Đặt phím tắt】，Bấm để đặt</li>
</ul>
<h2>2 Giới thiệu về triển khai trình cắm</h2>
<ul>
    <li>Gọi trực tiếp Google Giao diện dịch để dịch các trang web không phải người Trung Quốc.</li>
</ul>
<h2>3 Ghi chú về cách sử dụng</h2>
<ul>
    <li>Bởi vì kịch bản được gọi là Google Giao diện dịch，Vì vậy, nó có thể là cần thiết<span style="color: red; --darkreader-inline-color: #f61c1c;"
            data-darkreader-inline-color="">Truy cập Internet khoa học</span>có nghĩa（Không cần thiết，Có lẽ Google sẽ bị chặn sau）</li>
    <li>Bởi vì một số trang web sử dụng nó <span style="color: red; --darkreader-inline-color: #f61c1c;"
            data-darkreader-inline-color="">CSP</span>(giống:github)，Vì vậy, một số trang web có thể không được dịch。Một số trang web có thể sử dụng các phương pháp sau để giải quyết nó，Sử dụng mở rộng，Loại bỏ đầu tiên <span
            style="color: red; --darkreader-inline-color: #f61c1c;"
            data-darkreader-inline-color="">CSP</span>，Điều này có thể giải quyết vấn đề mà các trang web như vậy không thể được dịch.Các tiện ích mở rộng sau đây có sẵn： <ul>
            <li>Bạn có thể tìm kiếm trực tiếp tại cửa hàng mở rộng<span style="color: red; --darkreader-inline-color: #f61c1c;"
                    data-darkreader-inline-color="">Disable Content-Security-Policy </span>Tải xuống（Nguồn phương pháp: <a
                    href="/zh-CN/users/453123-andy-ao">@Andy AO</a>）</li>
            <li>hoặc<a href="https://www.crx4chrome.com/crx/16901/" rel="nofollow">Bấm để nhảy đến Crx4Chrome Tải xuống Disable
                    Content-Security-Policy 3.0.0</a>（Nguồn phương pháp: <a href="/zh-CN/users/453123-andy-ao">@Andy AO</a>）</li>
            <li>Hoặc cho con khỉ dầu<span style="color: red; --darkreader-inline-color: #f61c1c;"
                    data-darkreader-inline-color="">cài đặt</span>Tìm nó trong<span
                    style="color: red; --darkreader-inline-color: #f61c1c;"
                    data-darkreader-inline-color="">Sự an toàn</span>-&gt;<span
                    style="color: red; --darkreader-inline-color: #f61c1c;"
                    data-darkreader-inline-color="">Nếu trang web có chính sách bảo mật nội dung（CSP）Sau đó, theo chiến lược của nó</span>-&gt;Thay đổi thành<span
                    style="color: red; --darkreader-inline-color: #f61c1c;"
                    data-darkreader-inline-color="">Loại bỏ tất cả</span>(Nguồn phương pháp: <a href="/zh-CN/users/566096-xxxxue">@xxxxue</a>)
            </li>
        </ul>
    </li>
</ul>
