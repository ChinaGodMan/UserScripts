...
<center><div align="center">
    <h1>網頁翻譯——自動翻譯為中文</h1>
    <p>「 給每個非中文的網頁右下角（可以調整到左下角）添加一個google翻譯圖標，該版本為中文翻譯版本，只把外語翻譯為中文,添加自動翻譯 」</p>
    ...
    <img src="https://img.shields.io/greasyfork/dt/505208?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=%E7%94%A8%E6%88%B6%E6%95%B8%E9%87%8F">
    <img src="https://img.shields.io/badge/dynamic/json?&label=%E6%AF%8F%E6%97%A5%E6%AA%A2%E6%9F%A5%E6%9B%B4%E6%96%B0%E6%AC%A1%E6%95%B8&query=$.505208&logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&url=https://github.com/ChinaGodMan/UserScriptsHistory/raw/main/daily_update_checks.json">
...
<h2><a href="https://greasyfork.org/zh-CN/scripts/424966">網頁翻譯——翻譯為中文</a>修改腳本為自動翻譯.無需點擊或者按鍵</h2>
<h2>特別說明</h2>
<ul>
    <li>
        <p><span style="color: red; --darkreader-inline-color: #f61c1c;" data-darkreader-inline-color="">已適配 PC
                端，移動端</span></p>
    </li>
    <li>
        <p><span style="color: red; --darkreader-inline-color: #f61c1c;"
                data-darkreader-inline-color="">該版本主要只針對外語翻譯為中文，如果你需要多種語言的互相翻譯，請直接下載原腳本：</span><a
                href="https://greasyfork.org/zh-CN/scripts/398746-%E7%BD%91%E9%A1%B5%E7%BF%BB%E8%AF%91">網頁翻譯</a></p>
    </li>
</ul>
<h2>1 功能介紹</h2>
<ul>
    <li>給每個非中文的網頁在<span style="color: red; --darkreader-inline-color: #f61c1c;"
            data-darkreader-inline-color="">左下角</span>添加一個 google 翻譯圖標，在<span
            style="color: red; --darkreader-inline-color: #f61c1c;" data-darkreader-inline-color="">右下角</span>添加顯示原網頁按鈕
    </li>
    <li>快速鍵：點擊油猴或者暴力猴擴展的圖標，腳本下面有【設置快捷鍵】，點擊進行設置</li>
</ul>
<h2>2 插件實現簡介</h2>
<ul>
    <li>直接調用 Google 的翻譯接口對非中文網頁進行翻譯.</li>
</ul>
<h2>3 使用注意</h2>
<ul>
    <li>由於腳本調用了 Google 的翻譯接口，所以可能需要<span style="color: red; --darkreader-inline-color: #f61c1c;"
            data-darkreader-inline-color="">科學上網</span>手段（目前暫時不需要，可能後面谷歌的被牆了就要了）</li>
    <li>由於一些網站使用了 <span style="color: red; --darkreader-inline-color: #f61c1c;"
            data-darkreader-inline-color="">CSP</span>(如:github)，所以可能有些網站翻譯不了。有些網站可以使用以下方法解決，使用擴展，先去掉 <span
            style="color: red; --darkreader-inline-color: #f61c1c;"
            data-darkreader-inline-color="">CSP</span>，就能夠解決這類網站不能翻譯的問題.下列擴展親測可用： <ul>
            <li>可以直接到擴展商店搜索<span style="color: red; --darkreader-inline-color: #f61c1c;"
                    data-darkreader-inline-color="">Disable Content-Security-Policy </span>下載（方法來源: <a
                    href="/zh-CN/users/453123-andy-ao">@Andy AO</a>）</li>
            <li>或者<a href="https://www.crx4chrome.com/crx/16901/" rel="nofollow">點擊跳轉到 Crx4Chrome 下載 Disable
                    Content-Security-Policy 3.0.0</a>（方法來源: <a href="/zh-CN/users/453123-andy-ao">@Andy AO</a>）</li>
            <li>或者到油猴的<span style="color: red; --darkreader-inline-color: #f61c1c;"
                    data-darkreader-inline-color="">環境</span>裡找<span
                    style="color: red; --darkreader-inline-color: #f61c1c;"
                    data-darkreader-inline-color="">安全</span>-&gt;<span
                    style="color: red; --darkreader-inline-color: #f61c1c;"
                    data-darkreader-inline-color="">如果站點有內容安全策略（CSP）則向其策略</span>-&gt;改為<span
                    style="color: red; --darkreader-inline-color: #f61c1c;"
                    data-darkreader-inline-color="">全部移除</span>(方法來源: <a href="/zh-CN/users/566096-xxxxue">@xxxxue</a>)
            </li>
        </ul>
    </li>
</ul>
