...
<center><div align="center">
    <h1>Web Translation——Automatic translation into Chinese</h1>
    <p>「 Give each non-Chinese web page the bottom right corner（Can be adjusted to the lower left corner）Add onegoogleTranslation icon，This version is a Chinese translation，Translate only foreign languages ​​to Chinese,Add automatic translation 」</p>
...
<h2><a href="https://greasyfork.org/zh-CN/scripts/424966">Web Translation——Translated into Chinese</a>Modify the script to automatic translation.No need to click or press keys</h2>
<h2>Special Note</h2>
<ul>
    <li>
        <p><span style="color: red; --darkreader-inline-color: #f61c1c;" data-darkreader-inline-color="">Already adapted PC
                end，Mobile</span></p>
    </li>
    <li>
        <p><span style="color: red; --darkreader-inline-color: #f61c1c;"
                data-darkreader-inline-color="">This version is mainly translated into Chinese only for foreign languages，If you need multiple language translations，Please download the original script directly：</span><a
                href="https://greasyfork.org/zh-CN/scripts/398746-%E7%BD%91%E9%A1%B5%E7%BF%BB%E8%AF%91">Web Translation</a></p>
    </li>
</ul>
<h2>1 Functional introduction</h2>
<ul>
    <li>Give every non-Chinese web page to<span style="color: red; --darkreader-inline-color: #f61c1c;"
            data-darkreader-inline-color="">Lower left corner</span>Add one google Translation icon，exist<span
            style="color: red; --darkreader-inline-color: #f61c1c;" data-darkreader-inline-color="">Lower right corner</span>Add a button to show original web page
    </li>
    <li>shortcut key：Click the icon for the oil monkey or violent monkey extension，There is a script below【Set shortcut keys】，Click to set</li>
</ul>
<h2>2 Introduction to plug-in implementation</h2>
<ul>
    <li>Call directly Google Translation interface for translation of non-Chinese web pages.</li>
</ul>
<h2>3 Notes on usage</h2>
<ul>
    <li>Because the script is called Google Translation interface，So it may be necessary<span style="color: red; --darkreader-inline-color: #f61c1c;"
            data-darkreader-inline-color="">Scientific Internet access</span>means（No need yet，Maybe Google is going to be blocked later）</li>
    <li>Because some websites use it <span style="color: red; --darkreader-inline-color: #f61c1c;"
            data-darkreader-inline-color="">CSP</span>(like:github)，So some websites may not be translated。Some websites can use the following methods to solve it，Use extension，Remove first <span
            style="color: red; --darkreader-inline-color: #f61c1c;"
            data-darkreader-inline-color="">CSP</span>，This can solve the problem that such websites cannot be translated.The following extensions are available： <ul>
            <li>You can search directly at the extension store<span style="color: red; --darkreader-inline-color: #f61c1c;"
                    data-darkreader-inline-color="">Disable Content-Security-Policy </span>download（Method source: <a
                    href="/zh-CN/users/453123-andy-ao">@Andy AO</a>）</li>
            <li>or<a href="https://www.crx4chrome.com/crx/16901/" rel="nofollow">Click to jump to Crx4Chrome download Disable
                    Content-Security-Policy 3.0.0</a>（Method source: <a href="/zh-CN/users/453123-andy-ao">@Andy AO</a>）</li>
            <li>Or to the oil monkey<span style="color: red; --darkreader-inline-color: #f61c1c;"
                    data-darkreader-inline-color="">set up</span>Find it in<span
                    style="color: red; --darkreader-inline-color: #f61c1c;"
                    data-darkreader-inline-color="">Safety</span>-&gt;<span
                    style="color: red; --darkreader-inline-color: #f61c1c;"
                    data-darkreader-inline-color="">If the site has a content security policy（CSP）Then, to its strategy</span>-&gt;Change to<span
                    style="color: red; --darkreader-inline-color: #f61c1c;"
                    data-darkreader-inline-color="">Remove all</span>(Method source: <a href="/zh-CN/users/566096-xxxxue">@xxxxue</a>)
            </li>
        </ul>
    </li>
</ul>
