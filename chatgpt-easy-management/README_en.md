...
<!--HISTORY-->
<center><div align="center">
    <h1>ChatGPT Easily manage chats</h1>
...
ChatGPT Batch delete session function。Manage session data，and provide deletes on the web page。

---

## 2. Functional Features

- **Quick Delete Button**：Provide quick deletion options next to each session。
- **Batch Delete**：Support users to select multiple sessions and perform batch deletion。
