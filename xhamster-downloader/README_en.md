...
<div align="right">
    <h6>
        ...
        <a href="https://github.com/ChinaGodMan/UserScripts/blob/main/xhamster-downloader/README.md">简体中文</a> |
        <a href="https://github.com/ChinaGodMan/UserScripts/blob/main/xhamster-downloader/README_en.md">English</a> |
        <a href="https://github.com/ChinaGodMan/UserScripts/blob/main/xhamster-downloader/README_ko.md">한국어</a> |
        <a href="https://github.com/ChinaGodMan/UserScripts/blob/main/xhamster-downloader/README_vi.md">Tiếng Việt</a> |
        <a href="https://github.com/ChinaGodMan/UserScripts/blob/main/xhamster-downloader/README_zh-TW.md">繁體中文</a>
    <br>
...
<!--HISTORY-->
<center><div align="center">
    <h1>xhamster video one-click download assistant</h1>
    <p>「 xhamster video download with one click | xhamster.com | Download directly without login | All viewable resolutions can be downloaded 」</p>
    <img src="https://views.whatilearened.today/views/github/529043/hmjz100.svg" alt="Views">
    ...
    <img src="https://img.shields.io/greasyfork/dt/529043?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=Number%20of%20users">
    <img src="https://img.shields.io/badge/dynamic/json?&label=Daily%20check%20updates&query=$.529043&logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&url=https://github.com/ChinaGodMan/UserScriptsHistory/raw/main/daily_update_checks.json">
    <p>Download:<a href="https://github.com/ChinaGodMan/UserScripts/tree/main/xhamster-downloader">Github</a> | ⭐<a
            href="https://greasyfork.org/scripts/529043">Greasy
            Fork</a></p><details><summary style="color:#FFD700">Update records</summary><div align="right"><a href="https://github.com/ChinaGodMan/UserScripts/tree/main/xhamster-downloader/CHANGELOG.md"><img src="https://img.shields.io/badge/-GitHub-3A3A3A?style=flat&logo=GitHub&logoColor=white"></a></div><h1><strong>🛠️ Xhamster One-click video download assistant Update log</strong></h1>
<h3><strong>📅 2025.03.13.0330</strong></h3>
<p><strong>New</strong>: •Automatic playback<br>
<strong>New</strong>: •Automatic wide screen<br>
<strong>New</strong>: •Automatic highest image quality playback<br>
<strong>set up</strong>: •<code>autoMax = true</code> <strong>Automatic wide screen</strong><br>
<strong>set up</strong>: • <code>autoPlay = true</code> <strong>Automatic playback</strong><br>
<strong>set up</strong>: •<code>autoMaxQuality</code> <strong>Automatic highest image quality playback</strong><br></p>
...
# xhamster One-click video download assistant

人民的勤务员 Extracted from script [x Downloader](https://greasyfork.org/scripts/524702/)

1. This script focuses on improving the viewing effect and video download experience，A must-have item at home。
2. This script is a simple and powerful `xhamster` Video download plugin！

## Function

-   ✅ Click to download the video directly
-   ✅ Download directly without logging in
...
2.  When watching videos，Click the download button that appears in the lower right corner of the video to download the video(You can save it directly with right click，You can also click to download)

## Things to note

1.  This script is for personal learning only，Do not use for commercial purposes
2.  This script does not guarantee download speed，Please wait
3.  This script does not guarantee the download success rate，Please try to download multiple times
4.  This script does not guarantee that the downloaded files are complete，Please check the integrity of the document yourself
5.  This script does not guarantee the security of downloaded files，Please check the security of the file yourself

## Picture preview

![pb.png](https://s2.loli.net/2025/03/07/MgBqAsFSGbptCHx.png)
