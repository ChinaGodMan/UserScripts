...
<!--HISTORY-->
<center><div align="center">
    <h1>xhamster 視頻一鍵下載助手</h1>
    <p>「 xhamster 視頻一鍵下載 | xhamster.com | 無需登錄直接下載 | 可下載所有可觀看分辨率 」</p>
    ...
    <img src="https://img.shields.io/badge/dynamic/json?&label=%E6%AF%8F%E6%97%A5%E6%AA%A2%E6%9F%A5%E6%9B%B4%E6%96%B0%E6%AC%A1%E6%95%B8&query=$.529043&logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&url=https://github.com/ChinaGodMan/UserScriptsHistory/raw/main/daily_update_checks.json">
    <p>Download:<a href="https://github.com/ChinaGodMan/UserScripts/tree/main/xhamster-downloader">Github</a> | ⭐<a
            ...
            Fork</a></p><details><summary style="color:#FFD700">更新記錄</summary><div align="right"><a href="https://github.com/ChinaGodMan/UserScripts/tree/main/xhamster-downloader/CHANGELOG.md"><img src="https://img.shields.io/badge/-GitHub-3A3A3A?style=flat&logo=GitHub&logoColor=white"></a></div><h1><strong>🛠️ Xhamster 視頻一鍵下載助手 更新日誌</strong></h1>
<h3><strong>📅 2025.03.13.0330</strong></h3>
<p><strong>新增</strong>: •自動播放<br>
<strong>新增</strong>: •自動寬屏<br>
<strong>新增</strong>: •自動最高畫質播放<br>
<strong>環境</strong>: •<code>autoMax = true</code> <strong>自動寬屏</strong><br>
<strong>環境</strong>: • <code>autoPlay = true</code> <strong>自動播放</strong><br>
<strong>環境</strong>: •<code>autoMaxQuality</code> <strong>自動最高畫質播放</strong><br></p>
...
人民的勤务员 提取自腳本 [x Downloader](https://greasyfork.org/scripts/524702/)

1. 本腳本注重提升觀影效果和影片下載體驗，堪稱居家必備之好物。
2. 本腳本是一款簡單而又強大的 `xhamster` 視頻下載插件！
...
1.  安裝腳本
2.  觀看視頻時，點擊視頻右下角出現的下載按鈕即可下載視頻(可以直接右鍵保存，也可以點擊下載)

## 注意事項

1.  本腳本僅供個人學習使用，請勿用於商業用途
2.  本腳本不保證下載速度，請耐心等待
3.  本腳本不保證下載成功率，請嘗試多次下載
4.  本腳本不保證下載的文件完整，請自行檢查文件完整性
5.  本腳本不保證下載的文件安全，請自行檢查文件安全性
