...
<div align="right">
    <h6>
        ...
        <a href="https://github.com/ChinaGodMan/UserScripts/blob/main/greasyfork-webhook-sync-enhanced/README_ko.md">한국어</a> |
        <a href="https://github.com/ChinaGodMan/UserScripts/blob/main/greasyfork-webhook-sync-enhanced/README_vi.md">Tiếng Việt</a> |
        <a href="https://github.com/ChinaGodMan/UserScripts/blob/main/greasyfork-webhook-sync-enhanced/README_zh-TW.md">繁體中文</a>
    <br>
...
<!--HISTORY-->
<center><div align="center">
    <h1>GreaysFork Nâng caoWebHookĐồng bộ hóa cài đặt</h1>
    <p>「 GreaysFork Nhập nhanh thông tin đồng bộ script，Và thêm mã ngôn ngữ cho nhiều quốc gia theo đợt，Thay vì nhấp vào từng hộp lựa chọn và đi tới URL tương ứng。 」</p>
    ...
    <img src="https://img.shields.io/greasyfork/dt/506717?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=S%E1%BB%91%20l%C6%B0%E1%BB%A3ng%20ng%C6%B0%E1%BB%9Di%20d%C3%B9ng">
    <img src="https://img.shields.io/badge/dynamic/json?&label=C%E1%BA%ADp%20nh%E1%BA%ADt%20ki%E1%BB%83m%20tra%20h%C3%A0ng%20ng%C3%A0y&query=$.506717&logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&url=https://github.com/ChinaGodMan/UserScriptsHistory/raw/main/daily_update_checks.json">
    <p>Download:<a href="https://github.com/ChinaGodMan/UserScripts/tree/main/greasyfork-webhook-sync-enhanced">Github</a> | ⭐<a
            href="https://greasyfork.org/scripts/506717">Greasy
            Fork</a></p><details><summary style="color:#FFD700">Cập nhật hồ sơ</summary><div align="right"><a href="https://github.com/ChinaGodMan/UserScripts/tree/main/greasyfork-webhook-sync-enhanced/CHANGELOG.md"><img src="https://img.shields.io/badge/-GitHub-3A3A3A?style=flat&logo=GitHub&logoColor=white"></a></div><h1><strong>🛠️ GreaysForkNâng caoWebHook Cập nhật nhật ký</strong></h1>
<h3><strong>📅 2024/9/15 10:53 - Ver 1.1.1.0</strong></h3>
<p><strong>Sửa chữa</strong>: • Cái nút<code>hover active focus</code>Đưa vào lớp phụ huynh<code>.Sync-Modal</code></p>
<h3><strong>📅 2024/9/5 04:29 - Ver 1.1.0.0</strong></h3>
<p><strong>Mới</strong>: • Trở lại sau mỗi lần gửi GreasyFork Lời nhắc đồng bộ hóa。</p>
<hr />
<h3><strong>📅 2024/9/4 11:52 - Ver 1.0.0.0</strong></h3>
<p><strong>Phiên bản ban đầu</strong>: • Chào mừng。</p>
<hr /></details>
    <img src="https://raw.githubusercontent.com/ChinaGodMan/UserScriptsHistory/main/stats/506717.png">
</div></center>
...
# GreasyFork - Nâng caoWebHookCài đặt đồng bộ

hiện hữuGreasyForkKhi thiết lập thông tin đồng bộ hóa trên，Thông thường, bạn sẽ bắt gặp việc xem sau khi gửi，Nó đã được tìm thấy rằng thông tin đồng bộ hóa không được đặt thành công，Nhập lại。Đây là một trong những vấn đề nhỏ với trang web。Để giải quyết vấn đề này，Tập lệnh này có thể giúp bạn nhanh chóng nhập thông tin đồng bộ hóa tập lệnh，Và thêm mã ngôn ngữ ở nhiều quốc gia theo đợt，Thay vì nhấp vào hộp lựa chọn từng cái một và sau đó đi đến URL tương ứng。

<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">

## Các tính năng chức năng

-   **Nhanh chóng nhập thông tin đồng bộ hóa**：Không cần lặp lại đầu vào theo cách thủ công，Nó có thể nhanh chóng đặt và đồng bộ hóa thông tin。
-   **Thêm mã ngôn ngữ theo đợt**：Hỗ trợ bổ sung hàng loạt các quốc gia/Mã ngôn ngữ khu vực，Không cần phải chọn từng cái một。
-   **Hỗ trợ nhiều định dạng**：Bạn có thể chọn những cái khác nhau theo nhu cầu của bạnURLĐặt định dạng。

<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">

## Hướng dẫn sử dụng (Để biết chi tiết, bạn có thể xem hình bên dưới hoặc video trên)

-   **Trang quản lý tập lệnh**：Trên trang quản lý tập lệnh,Thêm một nút bên dưới,Sau khi nhấp vào, bạn có thể quản lý tập lệnh hiện tại。
-   **Trang web thanh điều hướng hàng đầu**：Thêm một tùy chọn vào thanh điều hướng,Được sử dụng để tự động nhận được sau khi nhấp vàoWebhookTập lệnh đồng bộ.Thực hiện nhiều quản lý.

<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">

## Định dạng được hỗ trợ

Hiện đang hỗ trợ ba định dạng sau:

1.  **từMarkdownTệp có được ngôn ngữ quốc gia**: Chỉ hỗ trợ `README_xxx.md`.<br>
    `https://www.xxx.com/path/to/your/README_xxxxx.md`
2.  **Đặt trực tiếp ngôn ngữ quốc gia tương ứng（Định dạng ngắn gọn）**: Hỗ trợ các tệp định dạng khác.<br>
    ` https://www.xxx.com/path/to/your/filename.md##ko`
3.  **Đặt trực tiếp ngôn ngữ quốc gia tương ứng（Định dạng chi tiết）**: Hỗ trợ các tệp định dạng khác<br>
    ` https://www.xxx.com/path/to/your/filename.md##简体中文 (zh-CN)`

Mã như sau: Nếu bạn có nhiều lựa chọn hơn, bạn có thể mở rộng<br>
...
-   Khi gửi thông tin quốc gia địa phương,Tuyên bố tiêu đề phải tồn tại trong mã Ví dụ//@name:zh-CN,Nếu không, nó sẽ thất bại ngay cả khi việc gửi thành công.!
-   Kịch bản phải tồn tại!Nếu không, đồng bộ hóa thất bại,
