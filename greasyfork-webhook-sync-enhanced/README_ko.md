...
<!--HISTORY-->
<center><div align="center">
    <h1>GreaysFork 향상시키다WebHook동기화 설정</h1>
    <p>「 GreaysFork 스크립트 동기화 정보를 빠르게 입력하세요，여러 국가의 언어 코드를 일괄 추가합니다.，선택 상자를 하나씩 클릭하여 해당 URL로 이동하는 대신。 」</p>
    ...
    <img src="https://img.shields.io/greasyfork/dt/506717?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=%EC%82%AC%EC%9A%A9%EC%9E%90%20%EC%88%98">
    <img src="https://img.shields.io/badge/dynamic/json?&label=%EB%A7%A4%EC%9D%BC%20%ED%99%95%EC%9D%B8%20%EC%97%85%EB%8D%B0%EC%9D%B4%ED%8A%B8&query=$.506717&logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&url=https://github.com/ChinaGodMan/UserScriptsHistory/raw/main/daily_update_checks.json">
...
-   **동기화 정보를 빠르게 입력하십시오**：입력을 수동으로 반복 할 필요가 없습니다，정보를 신속하게 설정하고 동기화 할 수 있습니다。
...
현재 다음 세 가지 형식을 지원합니다:

1.  **~에서Markdown국가 언어를 얻는 파일**: 지원됩니다 `README_xxx.md`.<br>
    `https://www.xxx.com/path/to/your/README_xxxxx.md`
2.  **해당 국가 언어를 직접 설정하십시오（간결한 형식）**: 다른 형식 파일을 지원합니다.<br>
    ` https://www.xxx.com/path/to/your/filename.md##ko`
3.  **해당 국가 언어를 직접 설정하십시오（자세한 형식）**: 다른 형식 파일을 지원합니다<br>
...
-   현지 국가 정보를 제출할 때,헤더 선언은 코드에 있어야합니다 예를 들어//@name:zh-CN,그렇지 않으면 제출이 성공하더라도 실패합니다.!
