// ==UserScript==
// @name              🤠 Github enhanced assistant, warehouse display size, inactive development warning, quick jump to other user warehouses within the warehouse 🤠
...
// @name:en           🤠 Github enhanced assistant, warehouse display size, inactive development warning, quick jump to other user warehouses within the warehouse 🤠
...
// @name:zh-CN        🤠 Github 增强小助手 仓库显示大小 不活跃开发警告 仓库内快捷跳转用户其他仓库 🤠
...
// @name:ar           🤠 مساعد Github المُحسّن، حجم عرض المستودع، تحذير التطوير غير النشط، الانتقال السريع إلى مستودعات المستخدمين الأخرى داخل المستودع 🤠
...
// @name:bg           🤠 Подобрен асистент на Github, размер на дисплея на склада, предупреждение за неактивна разработка, бързо прескачане към други потребителски складове в склада 🤠
...
// @name:cs           🤠 Rozšířený asistent Github, velikost zobrazení skladu, upozornění na neaktivní vývoj, rychlý skok do jiných uživatelských skladů ve skladu 🤠
...
// @name:da           🤠 Github forbedret assistent, lagerdisplaystørrelse, inaktiv udviklingsadvarsel, hurtigt spring til andre brugerlagre på lageret 🤠
...
// @name:de           🤠 Erweiterter Github-Assistent, Anzeigegröße des Lagers, Warnung bei inaktiver Entwicklung, schneller Sprung zu anderen Benutzer-Lagern innerhalb des Lagers 🤠
...
// @name:el           🤠 Βελτιωμένος βοηθός Github, μέγεθος οθόνης αποθήκης, προειδοποίηση ανενεργής ανάπτυξης, γρήγορο άλμα σε άλλες αποθήκες χρηστών εντός της αποθήκης 🤠
...
// @name:en           🤠 Github enhanced assistant, warehouse display size, inactive development warning, quick jump to other user warehouses within the warehouse 🤠
// @description:en    🤠 Warehouse display size: On GitHub’s code search, warehouse search, issue page, user warehouse list and repository page, the size of the warehouse will be displayed next to the warehouse name, allowing users to quickly understand the scale of the warehouse and optimize their selection. Inactive development warning: If a repository has not been updated in the past six months, the system will add a prompt at the top of the repository to remind users that the repository is inactive and display the time of the last update. This helps users determine the activity and maintenance status of the warehouse. Quick jump within the warehouse: When browsing the warehouse, the user can easily view the list of all warehouses of the user, providing an entrance to quickly jump to different warehouses. Users can quickly find and access other projects of interest, improving work efficiency. Usage scenarios: Developers: By displaying the warehouse size and active warnings, you can quickly filter out suitable libraries for development and avoid using projects that are no longer maintained. Project Manager: Through the quick jump function, it is easy to manage and coordinate multiple projects and improve work efficiency. Learners: When learning new technologies, they can more easily find relevant open source projects and quickly check the activity and scale of the projects. 🤠
// @name:eo           🤠 Plibonigita asistanto de Github, montra grandeco de magazeno, neaktiva evoluaverto, rapida salto al aliaj uzantstokejoj ene de la stokejo 🤠
...
// @name:es           🤠 Asistente mejorado de Github, tamaño de visualización del almacén, advertencia de desarrollo inactivo, salto rápido a otros almacenes de usuarios dentro del almacén 🤠
...
// @name:fi           🤠 Githubin tehostettu avustaja, varaston näytön koko, ei-aktiivinen kehitysvaroitus, nopea hyppy muihin käyttäjien varastoihin varastossa 🤠
...
// @name:fr           🤠 Assistant amélioré Github, taille d’affichage de l’entrepôt, avertissement de développement inactif, saut rapide vers d’autres entrepôts utilisateur au sein de l’entrepôt 🤠
...
// @name:he           🤠 עוזר משופר של Github, גודל תצוגת מחסן, אזהרת פיתוח לא פעיל, קפיצה מהירה למחסני משתמשים אחרים בתוך המחסן 🤠
...
// @name:hr           🤠 Github poboljšani pomoćnik, veličina prikaza skladišta, upozorenje o neaktivnom razvoju, brzi skok na druga korisnička skladišta unutar skladišta 🤠
...
// @name:hu           🤠 Github továbbfejlesztett asszisztens, raktári kijelző mérete, inaktív fejlesztési figyelmeztetés, gyors ugrás a raktáron belüli más felhasználói raktárakhoz 🤠
...
// @name:id           🤠 Asisten Github yang ditingkatkan, ukuran tampilan gudang, peringatan pengembangan tidak aktif, lompatan cepat ke gudang pengguna lain di dalam gudang 🤠
...
// @name:it           🤠 Assistente Github migliorato, dimensioni di visualizzazione del magazzino, avviso di sviluppo inattivo, passaggio rapido ai magazzini di altri utenti all’interno del magazzino 🤠
...
// @name:ja           🤠 Github の強化されたアシスタント、ウェアハウスの表示サイズ、非アクティブな開発の警告、ウェアハウス内の他のユーザーのウェアハウスへのクイックジャンプ 🤠
...
// @name:ka           🤠 Github-ის გაუმჯობესებული ასისტენტი, საწყობის ჩვენების ზომა, არააქტიური განვითარების გაფრთხილება, სწრაფი გადახტომა სხვა მომხმარებლის საწყობებში საწყობში 🤠
...
// @name:ko           🤠 Github 강화된 어시스턴트, 웨어하우스 표시 크기, 비활성 개발 경고, 웨어하우스 내 다른 사용자 웨어하우스로 빠르게 이동 🤠
...
// @name:nl           🤠 Verbeterde Github-assistent, weergavegrootte magazijn, waarschuwing voor inactieve ontwikkeling, snelle sprong naar andere gebruikersmagazijnen binnen het magazijn 🤠
...
// @name:nb           🤠 Github forbedret assistent, lagervisningsstørrelse, inaktiv utviklingsadvarsel, raskt hopp til andre brukerlagre på lageret 🤠
...
// @name:pl           🤠 Ulepszony asystent Githuba, rozmiar wyświetlania magazynu, ostrzeżenie o nieaktywnym rozwoju, szybki skok do magazynów innych użytkowników w obrębie magazynu 🤠
...
// @name:pt-BR        🤠 Assistente aprimorado do Github, tamanho de exibição do warehouse, aviso de desenvolvimento inativo, salto rápido para outros armazéns de usuários dentro do warehouse 🤠
...
// @name:ro           🤠 Asistent îmbunătățit Github, dimensiunea afișajului depozitului, avertisment de dezvoltare inactivă, salt rapid la alte depozite de utilizatori din depozit 🤠
...
// @name:ru           🤠 Улучшенный помощник Github, размер отображения склада, предупреждение о неактивной разработке, быстрый переход к складам других пользователей внутри склада 🤠
...
// @name:sk           🤠 Vylepšený asistent Github, veľkosť zobrazenia skladu, upozornenie na neaktívny vývoj, rýchly skok do iných skladov používateľov v rámci skladu 🤠
...
// @name:sr           🤠 Гитхуб побољшани асистент, величина приказа складишта, упозорење о неактивном развоју, брзи скок на друга корисничка складишта у складишту 🤠
...
// @name:sv           🤠 Github förbättrad assistent, lagervisningsstorlek, inaktiv utvecklingsvarning, snabbhopp till andra användarlager inom lagret 🤠
...
// @name:th           🤠 ผู้ช่วยที่ได้รับการปรับปรุง Github, ขนาดการแสดงผลของคลังสินค้า, คำเตือนการพัฒนาที่ไม่ได้ใช้งาน, ข้ามไปยังคลังสินค้าของผู้ใช้อื่นภายในคลังสินค้าได้อย่างรวดเร็ว 🤠
...
// @name:tr           🤠 Github gelişmiş asistanı, depo görüntüleme boyutu, etkin olmayan geliştirme uyarısı, depo içindeki diğer kullanıcı depolarına hızlı geçiş 🤠
...
// @name:ug           🤠 Github كۈچەيتىلگەن ياردەمچى ، ئامبار كۆرسىتىش چوڭلۇقى ، ھەرىكەتسىز تەرەققىيات ئاگاھلاندۇرۇشى ، ئامبار ئىچىدىكى باشقا ئىشلەتكۈچى ئامبارلىرىغا تېز سەكرەش 🤠
...
// @name:uk           🤠 Розширений помічник Github, розмір відображення складу, попередження про неактивну розробку, швидкий перехід до інших сховищ користувачів у складі 🤠
...
// @name:vi           🤠 Trợ lý nâng cao Github, kích thước hiển thị kho, cảnh báo phát triển không hoạt động, chuyển nhanh sang kho người dùng khác trong kho 🤠
...
// @name:zh-SG        🤠 Github 增强小助手 仓库显示大小 不活跃开发警告 仓库内快捷跳转用户其他仓库 🤠
// @description:zh-SG 🤠 仓库显示大小：在 GitHub 的代码搜索、仓库搜索、议题页面、用户仓库列表和存储库页面上，仓库名称旁边会显示该仓库的大小，方便用户快速了解仓库的规模，优化选择。不活跃开发警告：如果某个仓库在过去六个月内没有更新，系统将在仓库的顶部添加提示，提醒用户该仓库不活跃，并显示最后一次更新的时间。这有助于用户判断仓库的活跃程度和维护状况。仓库内快捷跳转：在浏览仓库时，用户可以方便地查看该用户的所有仓库列表，提供一个快速跳转到不同仓库的入口。用户可以快速找到和访问感兴趣的其他项目，提高工作效率。使用场景：开发者：可以通过显示仓库大小和活跃警告，快速筛选出合适的库进行开发，避免使用不再维护的项目。项目管理者：通过快速跳转功能，便于管理和协调多个项目，提高工作效率。学习者：在学习新技术时，可以更方便地找到相关的开源项目，快速查看项目的活跃程度和规模。🤠
// @name:zh           🤠 Github 增强小助手 仓库显示大小 不活跃开发警告 仓库内快捷跳转用户其他仓库 🤠
// @description:zh    🤠 仓库显示大小：在 GitHub 的代码搜索、仓库搜索、议题页面、用户仓库列表和存储库页面上，仓库名称旁边会显示该仓库的大小，方便用户快速了解仓库的规模，优化选择。不活跃开发警告：如果某个仓库在过去六个月内没有更新，系统将在仓库的顶部添加提示，提醒用户该仓库不活跃，并显示最后一次更新的时间。这有助于用户判断仓库的活跃程度和维护状况。仓库内快捷跳转：在浏览仓库时，用户可以方便地查看该用户的所有仓库列表，提供一个快速跳转到不同仓库的入口。用户可以快速找到和访问感兴趣的其他项目，提高工作效率。使用场景：开发者：可以通过显示仓库大小和活跃警告，快速筛选出合适的库进行开发，避免使用不再维护的项目。项目管理者：通过快速跳转功能，便于管理和协调多个项目，提高工作效率。学习者：在学习新技术时，可以更方便地找到相关的开源项目，快速查看项目的活跃程度和规模。🤠
// @name:zh-TW        🤠 Github 增強小助手 倉庫顯示大小 不活躍開發警告 倉庫內快速跳轉用戶其他倉庫 🤠
...
// @name:zh-HK        🤠 Github 增強小助手 倉庫顯示大小 不活躍開發警告 倉庫內快速跳轉用戶其他倉庫 🤠
// @description:zh-HK 🤠 倉庫顯示大小：在 GitHub 的程式碼搜尋、倉庫搜尋、議題頁面、使用者倉庫清單和儲存庫頁面上，倉庫名稱旁會顯示該倉庫的大小，方便使用者快速了解倉庫的規模，最佳化選擇。不活躍開發警告：如果某個倉庫在過去六個月內沒有更新，系統會在倉庫的頂部添加提示，提醒用戶該倉庫不活躍，並顯示最後一次更新的時間。這有助於使用者判斷倉庫的活躍程度和維護狀況。倉庫內快速跳轉：在瀏覽倉庫時，使用者可以方便地查看該使用者的所有倉庫列表，提供一個快速跳到不同倉庫的入口。用戶可以快速找到和存取感興趣的其他項目，提高工作效率。使用情境：開發者：可以透過顯示倉庫大小和活躍警告，快速篩選出適當的庫進行開發，避免使用不再維護的項目。專案管理者：透過快速跳轉功能，方便管理和協調多個項目，提高工作效率。學習者：在學習新科技時，可以更方便地找到相關的開源項目，快速查看專案的活躍程度和規模。 🤠
// @name:fr-CA        🤠 Assistant amélioré Github, taille d’affichage de l’entrepôt, avertissement de développement inactif, saut rapide vers d’autres entrepôts utilisateur au sein de l’entrepôt 🤠
