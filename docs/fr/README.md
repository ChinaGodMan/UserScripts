...
<h5><a href="https://greasyfork.org/zh-CN/scripts?by=1169082&sort=updated" target="_blank">GreasyForkVoir le script du militaire</a><br></h5>
...
<img src="https://img.shields.io/badge/dynamic/json?&label=Nombre%20de%20fois%20qu%E2%80%99un%20script%20est%20utilis%C3%A9%20par%20jour&query=$.total&logo=greasyfork&logoColor=white&labelColor=%23670000&color=186f83&style=for-the-badge&url=https://github.com/ChinaGodMan/UserScriptsHistory/raw/main/daily_update_checks.json" alt="Daily update checks">
...
<!--SCRIPTS_COUNT-->
**Le nombre de scripts publiés actuels pour le référentiel:82,Le script comprend:**
...
<div align="right"><a href="#-Liste-de-scénarios">Retour au répertoire</a></div>
<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">
<div align="center"><h1>Scripts adultes (11)</h1></div><h3>
...
<div align="right"><a href="#-Liste-de-scénarios">Retour au répertoire</a></div>
<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">
<div align="center"><h1>Script de traduction (3)</h1></div><h3>
...
<h3>
    ...
    <a href="../../zhihu-black">Thèmes sombres de Zhihu</a>&nbsp;
...
Style de thème sombre de Zhihu
...
<h3>
    ...
    <a href="../../wechat-black">Mode sombre de la version Web WeChat</a>&nbsp;
...
Activez la fenêtre en plein écran de WeChat sur la page Web，Mode sombre
...
<h3>
    ...
    <a href="../../weibo-mobile-redirect">Sina Weibo Version mobile Jump</a>&nbsp;
...
Sina Weibo passera automatiquement à la version mobile，Soutenez Weibo、article、vidéo
...
Télécharger la vidéo Bilibili（Drame non pris en charge）
...
<h3>
    <a href="../../bilibili-liveroom-filter">
        <picture><source type="image/png" media="(prefers-color-scheme: dark)" srcset="https://i0.hdslb.com/bfs/static/jinkela/long/images/512.png"><img width=18 src="https://i0.hdslb.com/bfs/static/jinkela/long/images/512.png" width=18></a>
    <a href="../../bilibili-liveroom-filter">Outil de blocage de la salle de diffusion en direct de Bilibili en direct</a>&nbsp;
...
Outil de blocage de la salle de diffusion en direct de Bilibili en direct，Liste de gestion du support，Blocage en vrac，Exporter、Liste d’importation, etc.……
...
-   Cliquez sur le formulaire **\[Installer\]** Faites entendre directement l’interface d’installation de Script Manager。
-   si Github La vitesse d’accès est trop lente，Vous pouvez choisir de cliquer GreasyFork **\[Installer\]** L’invite d’extension apparaît，Allez et cliquez à nouveau **\[Installer\]** Juste。
-   [Afficher le tutoriel détaillé](https://github.com/ChinaGodMan/UserScripts/blob/main/docs/help/README.md)
...
> -   Ce fichier ReadMe de référentiel a été copié[XIU2/UserScript//README.md](https://github.com/XIU2/UserScript/#:~:text=%E5%A6%82%E4%BD%95%E5%AE%89%E8%A3%85/%E4%BD%BF%E7%94%A8%E8%84%9A%E6%9C%AC%EF%BC%9F)contenu `Navigateur et gestionnaire de script`
...
> -   Tout dans l’entrepôt`README.md`Badge de fichier copié[Hmjz100](https://github.com/hmjz100)Entrepôt[Online-disk-direct-link-download-assistant](https://github.com/hmjz100/Online-disk-direct-link-download-assistant)Interne[README.md](https://github.com/hmjz100/Online-disk-direct-link-download-assistant/blob/main/README.md)Style de badge de fichier
...
> -   仓库À l’intérieur所有`README.md`Introduction de l’en-tête de fichier et formulaire d’installation historique copié[FengFeng](https://github.com/BonjourFeng)Entrepôt[Github-Search-Purification](https://github.com/BonjourFeng/Github-Search-Purification)内[README.md](https://github.com/BonjourFeng/Github-Search-Purification/blob/main/README.md)Déposer un contenu
> -   Sous-assise de cet entrepôt`UserScriptsHistory`Mise à jour automatique du code d’image de la table d’historique d’installation a également été copiée et utilisée[FengFeng](https://github.com/BonjourFeng)Entrepôt[Script-History](https://github.com/BonjourFeng/Script-History)Code à l’intérieur[main.py](https://github.com/BonjourFeng/Script-History/blob/main/source/main.py)
...
> -   Copyé [Fils du désert](https://github.com/maboloshi)Entrepôt[github-chinese](https://github.com/maboloshi/github-chinese)Code à l’intérieur<br>
> -   Dans cet entrepôt`writer.py` `update-contributors.yml` Copie utilisée[tributors_images.yml](https://github.com/maboloshi/github-chinese/blob/gh-pages/.github/workflows/update_contributors_images.yml)Le code à l’intérieur
> -   Ce fichier ReadMe de référentiel a été copié[github-chinese/README.md](https://github.com/maboloshi/github-chinese#:~:text=%E6%B5%8F%E8%A7%88%E5%99%A8%E4%B8%8EChef%20de%20script)contenu `Comment installer/Utilisation de scripts？`
...
> -   _Traduction automatique de cet entrepôt et Action Un merci spécial aux Américains[Adam Lui Liu Zhanpeng](https://github.com/adamlui)Excellentes idées et code!_ :trollface:
> -   _Cet entrepôt est nommé en Américain[Adam Lui Liu Zhanpeng](https://github.com/adamlui)Inspirer_ :trollface:
> -   _Les fichiers en lecture dans cet entrepôt sont de[Adam Lui Liu Zhanpeng](https://github.com/adamlui)Style d’auto-évaluation_ :trollface:
> -   _Les sauts de détournement mutuel dans le script proviennent de[Adam Lui Liu Zhanpeng](https://github.com/adamlui)Style d’auto-évaluation_ :trollface:
> -   _Tout dans cet entrepôt`README.md`Le fichier a été copié et utilisé par ce référentiel américain`README.md`Disposition des fichiers，Délimiteur，Code，Idées_ :trollface:
> -   _Copier l’Américain[Adam Lui Liu Zhanpeng](https://github.com/adamlui) Action Code interne_ [sync-autoclear-chatgpt-history-changes.yml](https://github.com/adamlui/chatgpt-apps/blob/main/.github/workflows/sync-autoclear-chatgpt-history-changes.yml) :trollface:
> -   _Copyé Américain[Adam Lui Liu Zhanpeng](https://github.com/adamlui)Action Code interne_ [sync-autoclear-chatgpt-history-changes.yml](https://github.com/adamlui/chatgpt-apps/blob/main/.github/workflows/sync-autoclear-chatgpt-history-changes.yml) :trollface:
...
|                               Navigateur recommandé                                |                                                         Gestionnaire d’installation                                                          | Installer le navigateur                                                                    |
| :---------------------------------------------------------------------: | :-------------------------------------------------------------------------------------------------------------------------: | ----------------------------------------------------------------------------- |
...
|           <center> Via Navigateur（Android）[![][via]][via_link]            |                                                    <center> Vient dans le navigateur                                                    | <center>[![][via]][via_link]                                                  |
|              <center> X Navigateur（Android） [![][x]][x_link]              |                                                    <center> Vient dans le navigateur                                                    | <center>[![][x]][x_link]                                                      |
...
|            <center> Navigateur de lémur（Android）[![][le]][le_link]             | <center>![.png][TM][Tampermonkey][Tampermonkey] ![.png][vm][Violentmonkey][Violentmonkey] ![.png][cat][ScriptCat][cat_link] | <center>[![][le]][le_link]                                                    |
|                                                                         |                                                                                                                             |                                                                               |

[Tampermonkey]: http://tampermonkey.net/ "Altération de singe"
...
[cat_link]: https://docs.scriptcat.org/ "Chat de scénario"
[TM]: https://img.xwyue.com/i/2024/08/02/66ac94776a4f8.png "Altération de singe"
