...
<!--SCRIPTS_COUNT-->
**O número de scripts publicados atuais para o repositório:58,O script inclui:**
<h6><a href="#ChatGPTScripts-relacionados-5">ChatGPTScripts relacionados (5)</a>
 ...
 | <a href="#GitHubScripts-relacionados-14">GitHubScripts relacionados (14)</a>
...
<div align="right"><a href="#-Lista-de-scripts">Voltar ao diretório</a></div><img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest"><h1>GitHubScripts relacionados (14)</h1><h3>
