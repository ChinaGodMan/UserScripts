...
<details>
    <summary>Proibido de cagar na versão editada，Verde é para liberação，Vermelho proibido，Direção temporária laranja</summary>
    <br><blockquote>
        <a href="https://github.com/ChinaGodMan/UserScripts/tree/main/clipboard-manager">
...
<details>
    <summary>O script irá GitHub As informações de envio são convertidas em HTML visualizar，Ver detalhes de envio mais claramente。Ele listará automaticamente as informações de envio、O cabeçalho de envio e as informações mais recentes de envio são convertidas em HTML Formatar，Forneça melhores efeitos visuais e experiência do usuário。</summary>
    <br><blockquote>
        <a href="https://github.com/ChinaGodMan/UserScripts/tree/main/github-commit-viewer">
