...
> [!WARNING]
>  <div align="center">
>  Este repositório está disponível apenas em<code>GitHub</code>hospedado em,Aqui não<code>GitCode</code>e<code>XPlaza</code>hospedado em。Os seguintes repositórios são todos espelhos。<br>
>    :trollface: Se você estiver usando na China continental<code>git clone</code>A velocidade de download é muito lenta，Você também pode usar o seguinte endereço
>    
>  
>    [https://www.xplaza.cn/ChinaGodMan](https://www.xplaza.cn/ChinaGodMan) (Conta espelhada，não-identidade)  
...
<!--SCRIPTS_COUNT-->
**O número atual de scripts publicados no repositório:84,O roteiro inclui:**
<h6><a href="#script da web-10">script da web (10)</a>
 ...
 | <a href="#GitHub Roteiro-19">GitHub Roteiro (19)</a>
...
<div align="right"><a href="#-lista de scripts">Voltar ao índice</a></div>
<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">
<div align="center"><h1>GitHub Roteiro (19)</h1></div><h3>
