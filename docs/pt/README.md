...
<h5><a href="https://greasyfork.org/zh-CN/scripts?by=1169082&sort=updated" target="_blank">GreasyForkVeja o script do service</a><br></h5>
...
<img src="https://img.shields.io/badge/dynamic/json?&label=N%C3%BAmero%20de%20vezes%20que%20um%20script%20%C3%A9%20usado%20por%20dia&query=$.total&logo=greasyfork&logoColor=white&labelColor=%23670000&color=186f83&style=for-the-badge&url=https://github.com/ChinaGodMan/UserScriptsHistory/raw/main/daily_update_checks.json" alt="Daily update checks">
...
💡 <strong>Tip:</strong> O gerente de script e o navegador listados acima não representam tudo<br>
    <strong>O script é executado normalmente no ambiente seguinte</strong><br>
...
> [!WARNING]
>  <div align="center">
>  Este repositório é apenas<code>GitHub</code>Hospedando,Não aqui<code>GitCode</code>e<code>XPlaza</code>Hospedando。Os seguintes repositórios são espelhados。<br>
>    :trollface: Se você o usar na China continental<code>git clone</code>O download de velocidade é muito lento，Você também pode usar o seguinte endereço
>    
>  
>    [https://www.xplaza.cn/ChinaGodMan](https://www.xplaza.cn/ChinaGodMan) (Conta espelhada，Não-pessoa)  
...
<!--README-TOC-->
## 🔖 TOC
[🌐 Navegador e gerente de scripts](#-Navegador-e-gerente-de-scripts) |
[❔️ Como instalar ou usar scripts](#%EF%B8%8F-Como-instalar-ou-usar-scripts) |
[🙏 Agradecimentos especiais a Kaiyuan](#-Agradecimentos-especiais-a-Kaiyuan) |
...
[⭐ História da estrela](#-História-da-estrela) |
...
<!--SCRIPTS_COUNT-->
**O número de scripts publicados atuais para o repositório:82,O script inclui:**
<h6><a href="#Script-da-web-10">Script da web (10)</a>
 | <a href="#GreasyFork-12">GreasyFork (12)</a>
 | <a href="#Scripts-adultos-11">Scripts adultos (11)</a>
 | <a href="#Google-Script-2">Google Script (2)</a>
 | <a href="#GitHub-Script-19">GitHub Script (19)</a>
 | <a href="#Script-de-tradução-3">Script de tradução (3)</a>
 | <a href="#AI-Script-9">AI Script (9)</a>
 | <a href="#Site-do-blog-5">Site do blog (5)</a>
...
<div align="right"><a href="#-Lista-de-scripts">Voltar ao diretório</a></div>
<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">
<div align="center"><h1>Scripts adultos (11)</h1></div><h3>
...
<div align="right"><a href="#-Lista-de-scripts">Voltar ao diretório</a></div>
<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">
<div align="center"><h1>Google Script (2)</h1></div><h3>
...
<div align="right"><a href="#-Lista-de-scripts">Voltar ao diretório</a></div>
<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">
<div align="center"><h1>Script de tradução (3)</h1></div><h3>
...
<div align="right"><a href="#-Lista-de-scripts">Voltar ao diretório</a></div>
<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">
<div align="center"><h1>AI Script (9)</h1></div><h3>
    <a href="../../chatgpt-plus">
...
<div align="right"><a href="#-Lista-de-scripts">Voltar ao diretório</a></div>
<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">
<div align="center"><h1>Site do blog (5)</h1></div><h3>
    <a href="../../csdn-blocker">
...
<h3>
    ...
    <a href="../../zhihu-black">Temas sombrios de Zhihu</a>&nbsp;
...
<h3>
    ...
    <a href="../../wechat-black">Modo escuro da versão weChat web</a>&nbsp;
...
Ative a janela de tela completa do WeChat na página da web，Modo escuro
...
Sina Weibo irá automaticamente pular para a versão móvel，Apoie Weibo、artigo、vídeo
...
<div align="center"><h1>Bilibili (2)</h1></div><h3>
    ...
    <a href="../../bilibili-video-downloader">Downloader de vídeo bilibili</a>&nbsp;
...
Baixe o vídeo bilibili（Não suportado drama）
...
<h3>
    <a href="../../bilibili-liveroom-filter">
        <picture><source type="image/png" media="(prefers-color-scheme: dark)" srcset="https://i0.hdslb.com/bfs/static/jinkela/long/images/512.png"><img width=18 src="https://i0.hdslb.com/bfs/static/jinkela/long/images/512.png" width=18></a>
    <a href="../../bilibili-liveroom-filter">Ferramenta de bloqueio de bloqueio de transmissão ao vivo bilibili</a>&nbsp;
...
Ferramenta de bloqueio de bloqueio de transmissão ao vivo bilibili，Lista de gerenciamento de suporte，Bloqueio a granel，Exportar、Lista de importação, etc.……
...
## ❔️ Como instalar ou usar scripts？
...
<a href="https://github.com/ChinaGodBot" title="O assistente do povo"><img src="https://avatars.githubusercontent.com/u/177234083?v=4" width="42;" alt="O assistente do povo"/></a>
...
|                               Navegador recomendado                                |                                                         Gerenciador de instalação                                                          | Instale o navegador                                                                    |
| :---------------------------------------------------------------------: | :-------------------------------------------------------------------------------------------------------------------------: | ----------------------------------------------------------------------------- |
...
<p align="center"><a href="https://github.com/ChinaGodMan">Entre em contato com o autor</a> /<a href="#top">De volta ao topo↑</a></p>
