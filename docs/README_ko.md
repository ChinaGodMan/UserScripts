<div align="right">
    <h6>
        ...
        <a href="https://github.com/ChinaGodMan/UserScripts/blob/main/docs/README_zh-TW.md">중국어 번체</a>|
        <a href="https://github.com/ChinaGodMan/UserScripts/blob/main/docs/README_en.md">English</a> |
        <a href="https://github.com/ChinaGodMan/UserScripts/blob/main/docs/README_ja.md">일본어</a>|
...
<details><summary>ChatGPT관련 스크립트</summary><table>
    <thead>
        <tr>
            <th>스크립트 이름</th>
            <th>스크립트 설명</th>
    ...
    </table></details><details><summary>웹 관련 스크립트</summary><table>
    <thead>
        <tr>
            <th>스크립트 이름</th>
            <th>스크립트 설명</th>
    ...
    </table></details><details><summary>GitHub관련 스크립트</summary><table>
    <thead>
        <tr>
            <th>스크립트 이름</th>
            <th>스크립트 설명</th>
    ...
    <tr>
        ...
        <tr>
            <td>
                <img src="https://greasyfork.org/vite/assets/blacklogo96-CxYTSM_T.png" width="16" height="16">
                <a href="https://greasyfork.org/zh-CN/scripts/502291" target="_blank">🤠 Github 어시스턴트 강화 창고 전시 크기 비활성 개발 경고 창고 내 사용자의 다른 창고로 빠르게 이동 🤠</a><br>
                <img src="https://github.githubassets.com/favicons/favicon.svg" width="16" height="16">
            ...
            <td>존재하다Github창고 보기 및 검색 시 창고 크기 표시 ，비활성 개발 경고，창고 내 빠른 점프.</td>
            <td>
    ...
    </table></details><details><summary>Google관련 스크립트</summary><table>
    <thead>
        <tr>
            <th>스크립트 이름</th>
            <th>스크립트 설명</th>
    ...
    </table></details><details><summary>GreasyFork관련 스크립트</summary><table>
    <thead>
        <tr>
            <th>스크립트 이름</th>
            <th>스크립트 설명</th>
    ...
    </table></details><details><summary>성인 각본</summary><table>
    <thead>
        <tr>
            <th>스크립트 이름</th>
            <th>스크립트 설명</th>
    ...
    </table></details><details><summary>자동 번역</summary><table>
    <thead>
        <tr>
            <th>스크립트 이름</th>
            <th>스크립트 설명</th>
...
**인용됨 py 내부 코드** 프로젝트 주소는: [translate-en-messages.py](https://github.com/adamlui/python-utils/blob/main/translate-messages/translate-en-messages.py)
...
**감사합니다 배지 아이콘 스타일** [![[CodeFactor grade]](https://img.shields.io/codefactor/grade/github/adamlui/chatgpt-apps?label=Code+Quality&logo=codefactor&logoColor=white&labelColor=464646&color=b3ff68&style=for-the-badge)](https://www.codefactor.io/repository/github/adamlui/chatgpt-apps)
