...
<center><div align="center">
    ...
    <img src="https://img.shields.io/greasyfork/dt/537648?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=%E7%94%A8%E6%88%B6%E6%95%B8%E9%87%8F">
    <img src="https://img.shields.io/badge/dynamic/json?&label=%E6%AF%8F%E6%97%A5%E6%AA%A2%E6%9F%A5%E6%9B%B4%E6%96%B0%E6%AC%A1%E6%95%B8&query=$.537648&logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&url=https://github.com/ChinaGodMan/UserScriptsHistory/raw/main/daily_update_checks.json">
...
2. 打開含聊天對話的網頁（支持帶有 `data-message-id` 和 `data-message-author-role` 屬性的結構）。
...
- 依賴頁面結構，要求消息節點帶有 `data-message-id` 和 `data-message-author-role` 屬性。
- 只提取帶有 `.whitespace-pre-wrap` 或 `.markdown` 類的文本內容。
