...
<!--HISTORY-->
<center><div align="center">
    <h1>ChatGPT 字元計數器限制 (CCCL)</h1>
    <p>「 新增一個字元計數器到輸入框，限制為 32732 個字元。（ChatGPT 的限制是 32732 個字元。） 」</p>
    ...
    <img src="https://img.shields.io/greasyfork/dt/506166?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=%E7%94%A8%E6%88%B6%E6%95%B8%E9%87%8F">
    <img src="https://img.shields.io/badge/dynamic/json?&label=%E6%AF%8F%E6%97%A5%E6%AA%A2%E6%9F%A5%E6%9B%B4%E6%96%B0%E6%AC%A1%E6%95%B8&query=$.506166&logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&url=https://github.com/ChinaGodMan/UserScriptsHistory/raw/main/daily_update_checks.json">
    <p>Download:<a href="https://github.com/ChinaGodMan/UserScripts/tree/main/chatgpt-counter">Github</a> | ⭐<a
            ...
            Fork</a></p><details><summary style="color:#FFD700">更新記錄</summary><div align="right"><a href="https://github.com/ChinaGodMan/UserScripts/tree/main/chatgpt-counter/CHANGELOG.md"><img src="https://img.shields.io/badge/-GitHub-3A3A3A?style=flat&logo=GitHub&logoColor=white"></a></div><h1><strong>🛠️ ChatGPT 字符計數器 更新日誌</strong></h1>
<h3><strong>📅 2024/9/1 09:37 - Ver 1.3.1</strong></h3>
<p><strong>修復</strong>: 無法在新開聊天或切換聊天時顯示計數器的問題，以及發送後計數器不清零的問題</p>
<hr /></details>
...
ChatGPT Character Counter Limit (CCCL) 是一個用戶腳本，旨在為 ChatGPT 的输入框添加一個字符计数器，限制為 32732 個字符。這個腳本可以幫助用戶在輸入時實時查看已輸入字符的數量，並在超出限制時給出視覺提示。.

<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">

## 功能

-   在 ChatGPT 輸入框下方添加一個字符計數器。
-   實時更新計數器，顯示已輸入字符數和字符限制。
-   當字符數超出限制時，計數器文本顏色變為紅色，提示用戶。
-   當字符數接近限制時，計數器文本顏色變為綠色，顯示警告。
...
修改自用戶 [Emree.el](https://greasyfork.org/zh-CN/users/1297357)的腳本 [ChatGPT Character Counter Limit (CCCL)](https://greasyfork.org/scripts/505802)
