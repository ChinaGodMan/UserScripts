...
<!--HISTORY-->
<center><div align="center">
    <h1>ChatGPT Giới hạn bộ đếm ký tự (CCCL)</h1>
    <p>「 Thêm bộ đếm ký tự vào hộp nhập liệu，giới hạn ở 32732 nhân vật。（ChatGPT Giới hạn là 32732 nhân vật。） 」</p>
    ...
    <img src="https://img.shields.io/greasyfork/dt/506166?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=S%E1%BB%91%20l%C6%B0%E1%BB%A3ng%20ng%C6%B0%E1%BB%9Di%20d%C3%B9ng">
    <img src="https://img.shields.io/badge/dynamic/json?&label=C%E1%BA%ADp%20nh%E1%BA%ADt%20ki%E1%BB%83m%20tra%20h%C3%A0ng%20ng%C3%A0y&query=$.506166&logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&url=https://github.com/ChinaGodMan/UserScriptsHistory/raw/main/daily_update_checks.json">
    <p>Download:<a href="https://github.com/ChinaGodMan/UserScripts/tree/main/chatgpt-counter">Github</a> | ⭐<a
            ...
            Fork</a></p><details><summary style="color:#FFD700">Cập nhật hồ sơ</summary><div align="right"><a href="https://github.com/ChinaGodMan/UserScripts/tree/main/chatgpt-counter/CHANGELOG.md"><img src="https://img.shields.io/badge/-GitHub-3A3A3A?style=flat&logo=GitHub&logoColor=white"></a></div><h1><strong>🛠️ ChatGPT Bộ đếm nhân vật Cập nhật nhật ký</strong></h1>
<h3><strong>📅 2024/9/1 09:37 - Ver 1.3.1</strong></h3>
<p><strong>Sửa chữa</strong>: Các vấn đề mà bộ đếm không thể được hiển thị khi một cuộc trò chuyện mới được mở hoặc khi trò chuyện được chuyển đổi，Và vấn đề không xóa bộ đếm sau khi gửi</p>
<hr /></details>
...
ChatGPT Character Counter Limit (CCCL) Đó là một tập lệnh người dùng，Nhằm mục đích ChatGPT Thêm một hộp đầu vào vàoKý tựquầy tính tiền，Giới hạn 32732 Ký tự。Tập lệnh này giúp người dùng xem số lượng ký tự được nhập vào thời gian thực khi nhập，Và đưa ra lời nhắc trực quan khi vượt quá giới hạn。.

<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">

## Chức năng

-   hiện hữu ChatGPT Thêm bộ đếm ký tự bên dưới hộp đầu vào。
-   Bộ đếm cập nhật thời gian thực，Hiển thị số lượng ký tự và giới hạn ký tự đã nhập。
-   Khi số lượng ký tự vượt quá giới hạn，Màu văn bản truy cập thay đổi thành màu đỏ，Nhắc người dùng。
-   Khi số lượng ký tự gần với giới hạn，Màu văn bản truy cập thay đổi thành màu xanh lá cây，Hiển thị cảnh báo。
...
Sửa đổi từ người dùng [Emree.el](https://greasyfork.org/zh-CN/users/1297357)Kịch bản [ChatGPT Character Counter Limit (CCCL)](https://greasyfork.org/scripts/505802)
