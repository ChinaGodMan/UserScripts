...
<center><div align="center">
    ...
    <p>「 添加一캐릭터计数器到输入框，제한 32732 캐릭터。（ChatGPT 한계는입니다 32732 个字符。.） 」</p>
...
ChatGPT Character Counter Limit (CCCL) 사용자 스크립트입니다，목표 ChatGPT 的输入框添加一캐릭터计数器，제한 32732 个字符。이 스크립트는 사용자가 입력 할 때 실시간으로 입력 한 문자 수를 볼 수 있도록 도와줍니다.，제한이 초과 될 때 시각적 프롬프트를 제공합니다。.
