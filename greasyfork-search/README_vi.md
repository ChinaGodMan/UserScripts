...
<center><div align="center">
    ...
    <p>「 Tìm kiếm bằng GoogleGreasyForkVàSleazyForkchữ viết trên 」</p>
    ...
    <img src="https://img.shields.io/greasyfork/dt/505215?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=S%E1%BB%91%20l%C6%B0%E1%BB%A3ng%20ng%C6%B0%E1%BB%9Di%20d%C3%B9ng">
    <img src="https://img.shields.io/badge/dynamic/json?&label=C%E1%BA%ADp%20nh%E1%BA%ADt%20ki%E1%BB%83m%20tra%20h%C3%A0ng%20ng%C3%A0y&query=$.505215&logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&url=https://github.com/ChinaGodMan/UserScriptsHistory/raw/main/daily_update_checks.json">
...
# GreasyFork SleazyFork Các tập lệnh tìm kiếm của Google

<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">

## mô tả

**GreasyFork SleazyFork Các tập lệnh tìm kiếm của Google**Đó là một tập lệnh người dùng，Được tăng cường bằng cách tận dụng tìm kiếm của Google [GreasyFork.org](https://greasyfork.org/) [SleazyFork.org](https://sleazyfork.org/) Chức năng tìm kiếm tập lệnh trên。Tập lệnh này cho phép bạn tìm kiếm tập lệnh bằng công cụ tìm kiếm mạnh mẽ của Google，Cung cấp kết quả tìm kiếm chính xác và toàn diện hơn。

<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">

## cách sử dụng

Hiện tại chỉ có hai chức năng。Chỉ cần tìm kiếm hộp trên trang chính hoặc bên [https://greasyfork.org/](https://greasyfork.org/) [https://sleazyfork.org/](https://sleazyfork.org/)Nhập và tìm kiếm。

1. `g YouTube`

    > Nó sẽ sử dụng tìm kiếm google Greasy Fork Lên và "YouTube" Tập lệnh liên quan。

2. `youtube.com tamer`
    > Nó sẽ sử dụng Greasy Fork Tìm kiếm và "tamer" Tập lệnh liên quan，Phạm vi tìm kiếm được giới hạn trong "youtube.com" Trong tên miền。

<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">

## Đặc trưng

-   **Cải thiện tìm kiếm**：Tập lệnh người dùng này tích hợp với tìm kiếm google，Thay vì chỉ dựa vào GreasyFork Chức năng tìm kiếm tích hợp，Điều này nâng cao trải nghiệm tìm kiếm tập lệnh。
-   **Cú pháp tìm kiếm của Google**：Bạn có thể sử dụng các toán tử tìm kiếm nâng cao và cú pháp được Google hỗ trợ để tối ưu hóa các truy vấn tìm kiếm của bạn。Điều này bao gồm loại trừ các loại trang cụ thể và giới hạn phạm vi tìm kiếm để GreasyFork Trong trang tập lệnh。
-   **Kết quả chính xác và toàn diện**：Bằng cách tận dụng sức mạnh của tìm kiếm Google，Bạn có thể nhận được kết quả tìm kiếm chính xác và rộng hơn，Điều này làm tăng cơ hội tìm kiếm các tập lệnh bạn muốn。
-   **Dễ sử dụng**：Tập lệnh người dùng này được tích hợp liền mạch vào [GreasyFork.org](https://greasyfork.org/) [SleazyFork.org](https://sleazyfork.org/) trang web，Chức năng nâng cao của các hộp đầu vào tìm kiếm hiện có。Bạn chỉ cần nhập trước khi truy vấn "g "（Ví dụ，"g Tên tập lệnh"）Bắt đầu tìm kiếm Google。
...
**GreasyFork Các tập lệnh tìm kiếm của Google**Được thiết kế cho [GreasyFork.org](https://greasyfork.org/) [SleazyFork.org](https://sleazyfork.org/) trang web。Nó tương thích với các trình duyệt web hiện đại hỗ trợ tập lệnh người dùng，Ví dụ Tampermonkey Và Greasemonkey。
<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">

## Sửa đổi nguồn

tác giả[𝖢𝖸 𝖥𝗎𝗇𝗀](https://greasyfork.org/zh-CN/users/371179)Kịch bản[GreasyFork Search](https://greasyfork.org/scripts/468495),Cảm ơn tác giả vì sự chăm chỉ và trí tuệ của anh ấy
