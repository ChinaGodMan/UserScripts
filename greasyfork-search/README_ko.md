...
<center><div align="center">
    ...
    <p>「 Google을 사용하여 검색GreasyFork그리고SleazyFork상적 각본 」</p>
    ...
    <img src="https://img.shields.io/greasyfork/dt/505215?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=%EC%82%AC%EC%9A%A9%EC%9E%90%20%EC%88%98">
    <img src="https://img.shields.io/badge/dynamic/json?&label=%EB%A7%A4%EC%9D%BC%20%ED%99%95%EC%9D%B8%20%EC%97%85%EB%8D%B0%EC%9D%B4%ED%8A%B8&query=$.505215&logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&url=https://github.com/ChinaGodMan/UserScriptsHistory/raw/main/daily_update_checks.json">
...
# GreasyFork SleazyFork Google 검색 스크립트

<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">

## 설명하다

**GreasyFork SleazyFork Google 검색 스크립트**사용자 스크립트입니다，Google 검색을 활용하여 향상되었습니다 [GreasyFork.org](https://greasyfork.org/) [SleazyFork.org](https://sleazyfork.org/) 스크립트 검색 기능 켜짐。이 스크립트는 Google의 강력한 검색 엔진을 사용하여 스크립트를 검색 할 수 있습니다.，보다 정확하고 포괄적 인 검색 결과를 제공하십시오。

<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">

## 용법

현재 두 가지 기능 만 있습니다。메인 페이지 또는 측면에서 상자를 검색하기 만하면 [https://greasyfork.org/](https://greasyfork.org/) [https://sleazyfork.org/](https://sleazyfork.org/)입력하고 검색하십시오。

1. `g YouTube`

    > Google 검색을 사용합니다 Greasy Fork 위로 "YouTube" 관련 스크립트。

2. `youtube.com tamer`
    > 그것은 사용할 것입니다 Greasy Fork 검색 및 "tamer" 관련 스크립트，검색 범위는 다음으로 제한됩니다 "youtube.com" 도메인 이름으로。

<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">

## 특징

-   **개선 된 검색**：이 사용자 스크립트는 Google 검색과 통합됩니다，전적으로 의존하는 대신 GreasyFork 내장 검색 기능，이것은 스크립트 검색 경험을 향상시킵니다。
-   **Google 검색 구문**：Google에서 지원하는 고급 검색 연산자 및 구문을 사용하여 검색 쿼리를 최적화 할 수 있습니다.。여기에는 특정 유형의 페이지를 제외하고 검색 범위를 제한하는 것이 포함됩니다. GreasyFork 스크립트 페이지에서。
-   **정확하고 포괄적 인 결과**：Google 검색의 힘을 활용하여，보다 정확하고 광범위한 검색 결과를 얻을 수 있습니다，이것은 원하는 스크립트를 찾을 가능성이 높아집니다.。
-   **사용하기 쉽습니다**：이 사용자 스크립트는 완벽하게 통합됩니다 [GreasyFork.org](https://greasyfork.org/) [SleazyFork.org](https://sleazyfork.org/) 웹 사이트，기존 검색 입력 상자의 기능이 향상되었습니다。쿼리 전에 입력하면됩니다 "g "（예를 들어，"g 스크립트 이름"）Google 검색을 시작하십시오。
...
**GreasyFork Google 검색 스크립트**설계 [GreasyFork.org](https://greasyfork.org/) [SleazyFork.org](https://sleazyfork.org/) 웹 사이트。사용자 스크립팅을 지원하는 최신 웹 브라우저와 호환됩니다.，예를 들어 Tampermonkey 그리고 Greasemonkey。
<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">

## 소스를 수정하십시오

작가[𝖢𝖸 𝖥𝗎𝗇𝗀](https://greasyfork.org/zh-CN/users/371179)스크립트[GreasyFork Search](https://greasyfork.org/scripts/468495),그의 노력과 지혜에 대한 저자에게 감사합니다
