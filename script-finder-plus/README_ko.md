...
<center><div align="center">
    ...
    <img src="https://img.shields.io/greasyfork/dt/498904?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=%EC%82%AC%EC%9A%A9%EC%9E%90%20%EC%88%98">
    <img src="https://img.shields.io/badge/dynamic/json?&label=%EB%A7%A4%EC%9D%BC%20%ED%99%95%EC%9D%B8%20%EC%97%85%EB%8D%B0%EC%9D%B4%ED%8A%B8&query=$.498904&logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&url=https://github.com/ChinaGodMan/UserScriptsHistory/raw/main/daily_update_checks.json">
...
<p><strong>수리하다</strong>: 소형 화면을 클릭하면 수정되었습니다<code>스크립트</code>버튼 후,다른 페이지 위치를 클릭 할 때<code>스크립트</code>버튼의 문제가 사라집니다  </p>
<hr />
<h3><strong>📅 2025.5.20.1</strong></h3>
<p><strong>CSS</strong>: @itheabyss 통합 이름 지정 규칙<a href="https://github.com/ChinaGodMan/UserScripts/issues/136#issuecomment-2894349461">#136</a><br></p>
<hr />
<h3><strong>📅 2025.04.28.1400</strong></h3>
<p><strong>수리하다</strong>: • CSS 스타일과 GreasyFork 갈등 <code>script-description</code>→<code>'script-description-finder</code> <a href="https://github.com/ChinaGodMan/UserScripts/issues/123">#123</a><br>
<strong>새로운</strong>: • 지원 시스템<code>다크 모드</code><br>
<strong>새로운</strong>: • <code>i18n</code>더 많은 언어를 지원합니다<br>
<strong>새로운</strong>: • 스크립트가 처음으로로드 된 후，기다리다<code>2s</code> 로딩이 성공했는지 확인하십시오,성공하지 못한 경우,한 번 다시로드하십시오。</p>
<hr />
...
<p><strong>수리하다</strong>: • <a href="https://greasyfork.org/scripts/498904/discussions/253924">#253924</a> SF Express 공식 웹 사이트에서 CSS 갈등，오른쪽 하단의 버튼이 길어지게합니다.，전체 페이지 하단의 수평。
...
<p><strong>새로운</strong>: • 모바일 장치에 대한 지원을 늘립니다，휴대 전화에서 사용할 수 있습니다~
...
Script Finder 사용자 스크립트입니다（userscript），모든 웹 사이트에서 사용자 스크립트를 찾고 관리하는 데 도움이됩니다.。검색하고 설치하는 편리한 방법을 제공합니다. Greasy Fork 사용자 스크립트。도움으로 Script Finder，한 번의 클릭으로 좋아하는 웹 사이트에 사용자 정의 스크립트를 쉽게 추가 할 수 있습니다.，탐색 경험을 향상시키기 위해。

<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">

## 기능

-   웹 사이트 도메인 이름을 기반으로 사용자 스크립트를 검색합니다
-   각 스크립트의 세부 사항을보십시오，저자를 포함하여、설명하다、설치 수량、버전 및 등급
-   한 번의 클릭으로 사용자 스크립트를 설치하십시오
...
1. 브라우저에 사용자 스크립트 관리자를 설치하십시오，예를 들어 Tampermonkey 또는 Greasemonkey
2. 입장 Greasy Fork 웹 사이트 및 클릭 "Install" 설치하는 버튼 Script Finder 스크립트
3. 설치 후 완료된 후，보기 페이지가 페이지 오른쪽에 나타납니다. "Scripts" 단추
4. 딸깍 하는 소리 "Scripts" 버튼이 열립니다 Script Finder 인터페이스
5. 검색 창을 사용하여 특정 웹 사이트를 기반으로 사용자 스크립트를 찾을 수 있습니다.
6. 자세한 내용을 보거나 한 번의 클릭으로 스크립트를 설치하려면 사용자 스크립트를 클릭하십시오.
7. 온 마음으로 그것을 발견하고 사용하십시오 Script Finder 새로운 사용자 스크립트가 제공되었습니다！

**알아채다**：이 사용자 스크립트는 브라우저에 설치하여 정상적으로 사용해야합니다.(바닥에서 사용 가능한 관리자를 볼 수 있습니다)
...
사용자로부터 스크립트를 수정하십시오 **[shiquda](https://greasyfork.org/zh-CN/users/935206)** ~의스크립트 [Script Finder](https://greasyfork.org/scripts/472056) 원래 저자에게 감사합니다 **[shiquda](https://greasyfork.org/zh-CN/users/935206)** ~의**성실한**그리고**지혜**
