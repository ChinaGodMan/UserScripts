...
<!--HISTORY-->
<center><div align="center">
    <h1>Script Finder 油猴腳本查找</h1>
    <p>「 Script Finder 在任何網站上找到適用於該網站的 油猴腳本。 」</p>
    ...
    <img src="https://img.shields.io/greasyfork/dt/498904?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=%E7%94%A8%E6%88%B6%E6%95%B8%E9%87%8F">
    <img src="https://img.shields.io/badge/dynamic/json?&label=%E6%AF%8F%E6%97%A5%E6%AA%A2%E6%9F%A5%E6%9B%B4%E6%96%B0%E6%AC%A1%E6%95%B8&query=$.498904&logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&url=https://github.com/ChinaGodMan/UserScriptsHistory/raw/main/daily_update_checks.json">
...
Script Finder 是一個用戶腳本（userscript），它可以幫助你在任何網站上查找和管理用戶腳本。它提供了一種方便的方式來搜索和安裝來自 Greasy Fork 的用戶腳本。借助 Script Finder，你可以輕鬆地一鍵將自定義腳本添加到你喜愛的網站上，從而增強你的瀏覽體驗。
...
-   根據網站域名搜索用戶腳本
-   查看每個腳本的詳細信息，包括作者、描述、安裝數量、版本和評分
-   一鍵安裝用戶腳本
...
1. 在瀏覽器中安裝用戶腳本管理器，例如 Tampermonkey 或 Greasemonkey
2. 訪問 Greasy Fork 網站並點擊 "Install" 按鈕來安裝 Script Finder 腳本
3. 安裝完成後，訪問頁面的右側上會出現一個 "Scripts" 按鈕
4. 點擊 "Scripts" 按鈕打開 Script Finder 介面
5. 可以使用搜索欄根據特定網站查找用戶腳本
6. 點擊一個用戶腳本以查看更多詳細信息或一鍵安裝腳本
7. 盡情發現和使用 Script Finder 提供的新用戶腳本吧！

**注意**：該用戶腳本需要在瀏覽器中安裝用戶腳本管理器才能正常使用(可在最底部查看可以使用的管理器)
...
腳本修改自用戶 **[shiquda](https://greasyfork.org/zh-CN/users/935206)** 的腳本 [Script Finder](https://greasyfork.org/scripts/472056) 感謝原作者 **[shiquda](https://greasyfork.org/zh-CN/users/935206)** 的**勤勞**與**智慧**
