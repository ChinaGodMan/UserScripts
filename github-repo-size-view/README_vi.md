...
[🧑‍💻 **@a1pha**](https://greasyfork.org/users/1298296) ⇒ 📜 _[Github Nhanh chóng tìm thấy hoạt độngForksDanh sách](https://greasyfork.org/scripts/494365)_<br>
...
## 🤠 Github Trợ lý nâng cao

**Github Trợ lý nâng cao** Nó là một sản phẩm được thiết kế để nâng cao người dùng GitHub Công cụ cho trải nghiệm người dùng。Sau đây là các chức năng và tính năng chính của công cụ này：

1. **Kích thước hiển thị kho**  
   hiện hữu GitHub Tìm kiếm mã、Tìm kiếm kho、Trang chương trình nghị sự、Danh sách kho lưu trữ người dùng và trang Kho lưu trữ，Kích thước của kho sẽ được hiển thị bên cạnh tên kho，Thật thuận tiện cho người dùng để nhanh chóng hiểu được kích thước của kho，Lựa chọn tối ưu hóa。

2. **Cảnh báo phát triển không hoạt động**  
   Nếu một kho lưu trữ chưa được cập nhật trong sáu tháng qua，Hệ thống sẽ thêm một lời nhắc ở đầu kho lưu trữ，Nhắc nhở người dùng rằng kho lưu trữ không hoạt động，và hiển thị thời gian cập nhật cuối cùng。Điều này giúp người dùng đánh giá mức độ hoạt động và trạng thái bảo trì của kho。

3. **Nhảy nhanh vào kho**  
   Trong khi duyệt kho，Người dùng có thể dễ dàng xem tất cả các kho lưu trữ của người dùng này，Cung cấp một lối vào một bước nhảy nhanh đến các kho khác nhau。Người dùng có thể nhanh chóng tìm thấy và truy cập các dự án quan tâm khác，Cải thiện hiệu quả làm việc。
4.

### Sử dụng kịch bản

-   **Nhà phát triển**：Có thể được hiển thị bằng cách hiển thị kích thước kho và cảnh báo hoạt động，Nhanh chóng lọc đúng thư viện để phát triển，Tránh sử dụng các dự án không còn được duy trì。
-   **Quản lý dự án**：Thông qua chức năng nhảy nhanh，Dễ dàng quản lý và phối hợp nhiều dự án，Cải thiện hiệu quả làm việc。

-   **người học**：Trong khi học các công nghệ mới，Dễ dàng tìm thấy các dự án nguồn mở có liên quan，Nhanh chóng xem mức độ hoạt động và quy mô của dự án。

## Cài đặt

1. Cài đặt Tampermonkey Hoặc Trình quản lý tập lệnh người dùng ưa thích của bạn。
2. từ[Đây](https://update.greasyfork.org/scripts/502291/Github%20Repo%20Size%2B.user.js)Tập lệnh cài đặt。
3. （Không bắt buộc）Nếu bạn muốn xem kích thước của kho lưu trữ riêng，Vui lòng tham khảo các hướng dẫn bên dưới。

<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">

## Kiểm tra kích thước kho lưu trữ riêng

Theo mặc định，Kịch bản này sẽ chỉ hiển thị kích thước của kho lưu trữ công cộng。
Để hiển thị kích thước của kho lưu trữ riêng，Bạn cần tạo ra một“repo”Mã thông báo truy cập cá nhân mới cho phạm vi。
Mã thông báo sẽ được sử dụng để vượt qua Github API Thực hiện xác thực danh tính。

1. [Đây](https://github.com/settings/tokens/new?description=repo-size%20userscript&scopes=repo)Tạo mã thông báo mới。
2. Đặt tên cho mã thông báo và kiểm tra nó`repo`phạm vi。
3. Nhấp `Generate token` Nút và sao chép mã thông báo。
4. Nhấp vào menu tập lệnh`Set GitHub Token`,Điền vào mã thông báo mà bạn vừa tạo。
...
GitHub: tác giả **[zvizvi](https://github.com/zvizvi)** ChromePlugin [GitHub-Web-IDE](https://github.com/zvizvi/GitHub-Web-IDE)<br>
tác giả **[mshll](https://greasyfork.org/zh-CN/users/1010122)** Các kịch bản được xuất bản [Github Repo Size](https://greasyfork.org/scripts/458048)<br>
tác giả **[a1pha](https://greasyfork.org/zh-CN/users/1298296)** Các kịch bản được xuất bản [Github Nhanh chóng tìm thấy hoạt động Forks Danh sách](https://greasyfork.org/zh-CN/scripts/494365)<br>
tác giả **[lly-ke](https://greasyfork.org/zh-CN/users/902432)** Các kịch bản được xuất bản [github-ossinsight](https://greasyfork.org/zh-CN/scripts/456878)<br>
tác giả **[Zach Hardesty](https://greasyfork.org/zh-CN/users/371100)** Các kịch bản được xuất bản [Github - Inactive Development Warning](https://greasyfork.org/zh-CN/scripts/419645)<br>
tác giả **[chen gang](https://greasyfork.org/zh-CN/users/720983)** Các kịch bản được xuất bản [GitHub Delete Repositories](https://greasyfork.org/zh-CN/scripts/500173)
