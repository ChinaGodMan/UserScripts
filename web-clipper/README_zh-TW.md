...
<center><div align="center">
    ...
    <p>Download:<a href="https://github.com/ChinaGodMan/UserScripts/tree/main/web-clipper">Github</a> | ⭐<a
            ...
            Fork</a></p><details><summary>更新記錄</summary><h1><strong>🛠️ Markdown Web Clipper 更新日誌</strong></h1>
...
-   **下載為 Markdown 文件**：可以将转换后的 Markdown 下載為 .md 文件。 ![2025.03.18](https://s2.loli.net/2025/03/18/ETzhM3Q6DPRipA8.png)
...
**你必須在腳本的頂部設置你的 GitHub 資訊。**
此處生成你的`Token`： [點擊我](https://github.com/settings/tokens/new?description=Web%20Clipper%20Token%20UserScript&scopes=repo)
