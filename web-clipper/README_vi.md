...
<center><div align="center">
    <h1>Markdown Cloud Cut Ghi chú</h1>
...
`Markdown Web Clipper` Đó là một tập lệnh người dùng，Cho phép bạn chọn bất kỳ trang nào HTML Chuyển đổi sang Markdown Định dạng。Đây là dành cho các nhà phát triển、Người tạo nội dung thường có thể cần HTML Chuyển đổi nội dung thành Markdown Rất hữu ích cho bất cứ ai.
Và có thể được tải lên`GitHub`Trong kho`Issues`Tiết kiệm vĩnh viễn,Nó là một công cụ mạnh mẽ để bảo quản nội dung vĩnh viễn trên các trang web!
...
-   **Lưu đến GitHub Issues**：Có thể chuyển đổi được chuyển đổi Markdown Lưu đến GitHub Trong kho Issues。
    **Lưu đến Obsidian**：Có thể chuyển đổi được chuyển đổi Markdown Lưu đến Obsidian。
-   **Hỗ trợ nhiều trình duyệt**：Có thể được Chrome、Firefox、Edge Được sử dụng trong các trình duyệt chính。
-   **Hỗ trợ nhiều ngôn ngữ**：Hỗ trợ Trung Quốc đơn giản hóa Trung Quốc、Trung Quốc truyền thống、Tiếng Anh、Hàn Quốc、Nhật Bản、Tiếng Pháp、Đức、Việt Nam Vinden đa ngôn ngữ。
...
1.  Cài đặt trình quản lý tập lệnh người dùng，giống Tampermonkey hoặc Greasemonkey。
2.  Thêm tập lệnh này vào trình quản lý tập lệnh người dùng của bạn。
3.  Trên bất kỳ trang web nào，Theo `Ctrl + m` ，Hoặc mở chức năng trong menu Trình quản lý tập lệnh，Bắt đầu lựa chọn HTML yếu tố。
4.  Khi chọn，Theo thông tin nhanh chóng，Sử dụng các phím bánh xe chuột hoặc mũi tên để chọn các phần tử。
