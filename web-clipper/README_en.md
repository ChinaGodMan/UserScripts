...
<center><div align="center">
    ...
    <p>Download:<a href="https://github.com/ChinaGodMan/UserScripts/tree/main/web-clipper">Github</a> | ⭐<a
            ...
            Fork</a></p><details><summary>Update records</summary><div align="right"><a href="https://github.com/ChinaGodMan/UserScripts/tree/main/web-clipper/CHANGELOG.md"><img src="https://img.shields.io/badge/-GitHub-3A3A3A?style=flat&logo=GitHub&logoColor=white"></a></div><h1><strong>🛠️ Markdown Cloud clip notes Update log</strong></h1>
...
`Markdown Web Clipper` It’s a user script，Allows you to select any page HTML Convert to Markdown Format。This is for developers、Content creators may often need to HTML Convert content to Markdown Very useful to anyone.
And can be uploaded to`GitHub`In the warehouse`Issues`Save permanently,It is a powerful tool for permanent preservation of content on web pages!
...
-   **Supports multiple browsers**：Can be Chrome、Firefox、Edge Used in mainstream browsers。
-   **Supports multiple languages**：Support Chinese simplified Chinese、Traditional Chinese、English、Korean、Japanese、French、German、Vietnamese Vinden Multilingual。

### GitHub Issues keep

**Important Tips：The first line of text on the left will be used as the title！！**
![2025.03.18](https://s2.loli.net/2025/03/18/Q9pFIcRsPwHgSot.png)
**You must set your GitHub information。**
Generate yours here`Token`： [Click me](https://github.com/settings/tokens/new?description=Web%20Clipper%20Token%20UserScript&scopes=repo) <br>
![2025.03.19](https://s2.loli.net/2025/03/19/MK4WfECZR2aDolA.png) <br>
You can jump to view it after creation： <br>
