...
<!--HISTORY-->
<center><div align="center">
    <h1>Google 고급 검색 도우미</h1>
    <p>「 Google 검색 페이지 상단에 고급 검색 양식을 추가하세요. 」</p>
    ...
    <img src="https://img.shields.io/greasyfork/dt/502652?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=%EC%82%AC%EC%9A%A9%EC%9E%90%20%EC%88%98">
    <img src="https://img.shields.io/badge/dynamic/json?&label=%EB%A7%A4%EC%9D%BC%20%ED%99%95%EC%9D%B8%20%EC%97%85%EB%8D%B0%EC%9D%B4%ED%8A%B8&query=$.502652&logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&url=https://github.com/ChinaGodMan/UserScriptsHistory/raw/main/daily_update_checks.json">
    <p>Download:<a href="https://github.com/ChinaGodMan/UserScripts/tree/main/google-advanced-search">Github</a> | ⭐<a
            ...
            Fork</a></p><details><summary style="color:#FFD700">레코드 업데이트</summary><div align="right"><a href="https://github.com/ChinaGodMan/UserScripts/tree/main/google-advanced-search/CHANGELOG.md"><img src="https://img.shields.io/badge/-GitHub-3A3A3A?style=flat&logo=GitHub&logoColor=white"></a></div><h1><strong>🛠️ Google 고급 검색 로그 업데이트</strong></h1>
<h3><strong>📅 2024/8/5 23:18 - Ver 0.1.9.1</strong></h3>
<p><strong>새로운</strong>: 스크립트 아이콘을 추가합니다</p>
<hr />
<h3><strong>📅 2024/8/5 10:26 - Ver 0.1.9</strong></h3>
<p><strong>issues</strong>: 모바일 장치는 고급 검색 창을 표시 할 수 없습니다。<br />
<strong>수리하다</strong>: 다음 코드는 전용입니다 PC 효과적인 끝 <code>searchContainer.appendChild(toggleButton)</code>。</p>
<hr /></details>
...
이것은 for입니다 Google 고급 검색 양식을 추가하는 사용자 스크립트。페이지 상단에 숨겨진 고급 검색 양식을 추가 할 수 있습니다.，정보를보다 정확하게 검색 할 수 있습니다。

<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">

## 기능

-   존재하다 Google 검색 페이지 상단에 하나를 추가하십시오 “고급 검색” 단추，버튼을 클릭하여 고급 검색 양식을 표시하십시오。
-   고급 검색 양식에는 다음 검색 옵션이 포함되어 있습니다：
    -   `다음 모든 단어`：지정된 모든 키워드는 검색 결과에 포함되어야합니다.。
    -   `다음 단어와 정확히 일치합니다`：검색 결과에는 지정된 단어와 정확히 일치하는 결과가 포함되어야합니다.。
    -   `다음 단어 중 하나`：검색 결과에는 지정된 키워드가 포함되어야합니다。
    -   `다음 단어를 제외하십시오`：검색 결과에는 지정된 키워드가 포함되어 있지 않습니다。
    -   `숫자 범위가 포함되어 있습니다`：검색 결과에는 지정된 범위 내의 숫자가 포함되어 있습니다。
    -   `마지막으로 업데이트 된 시간`：검색 결과에는 지정된 업데이트 시간이 포함 된 결과가 포함되어 있습니다。
    -   `웹 사이트 또는 도메인 이름`：지정된 웹 사이트 또는 도메인 이름을 포함하는 검색 결과。
    -   `파일 유형`：검색 결과에는 지정된 파일 유형에 대한 결과가 포함되어 있습니다。
-   이전 검색 옵션을 저장할 수 있습니다，새 페이지를 열 때 양식이 자동으로 채워집니다.。
-   명확한 버튼을 제공하십시오，양식으로 데이터를 지울 수 있습니다。

## 고마워하는

스크립트는 수정되었습니다 **[shiquda](https://greasyfork.org/users/935206)** 게시 된 스크립트 [Google Advanced Search Assistant](https://greasyfork.org/scripts/474178)
