...
<div align="right">
    <h6>
        ...
        <a href="https://github.com/ChinaGodMan/UserScripts/blob/main/google-advanced-search/README_ko.md">한국어</a> |
        <a href="https://github.com/ChinaGodMan/UserScripts/blob/main/google-advanced-search/README_vi.md">Tiếng Việt</a> |
        <a href="https://github.com/ChinaGodMan/UserScripts/blob/main/google-advanced-search/README_zh-TW.md">繁體中文</a>
    <br>
...
<!--HISTORY-->
<center><div align="center">
    <h1>Google Trợ lý tìm kiếm nâng cao</h1>
    <p>「 Thêm biểu mẫu tìm kiếm nâng cao vào đầu trang tìm kiếm Google của bạn 」</p>
    ...
    <img src="https://img.shields.io/greasyfork/dt/502652?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=S%E1%BB%91%20l%C6%B0%E1%BB%A3ng%20ng%C6%B0%E1%BB%9Di%20d%C3%B9ng">
    <img src="https://img.shields.io/badge/dynamic/json?&label=C%E1%BA%ADp%20nh%E1%BA%ADt%20ki%E1%BB%83m%20tra%20h%C3%A0ng%20ng%C3%A0y&query=$.502652&logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&url=https://github.com/ChinaGodMan/UserScriptsHistory/raw/main/daily_update_checks.json">
    <p>Download:<a href="https://github.com/ChinaGodMan/UserScripts/tree/main/google-advanced-search">Github</a> | ⭐<a
            href="https://greasyfork.org/scripts/502652">Greasy
            Fork</a></p><details><summary style="color:#FFD700">Cập nhật hồ sơ</summary><div align="right"><a href="https://github.com/ChinaGodMan/UserScripts/tree/main/google-advanced-search/CHANGELOG.md"><img src="https://img.shields.io/badge/-GitHub-3A3A3A?style=flat&logo=GitHub&logoColor=white"></a></div><h1><strong>🛠️ Google Tìm kiếm nâng cao Cập nhật nhật ký</strong></h1>
<h3><strong>📅 2024/8/5 23:18 - Ver 0.1.9.1</strong></h3>
<p><strong>Mới</strong>: Thêm biểu tượng tập lệnh</p>
<hr />
<h3><strong>📅 2024/8/5 10:26 - Ver 0.1.9</strong></h3>
<p><strong>issues</strong>: Thiết bị di động không thể hiển thị hộp tìm kiếm nâng cao。<br />
<strong>Sửa chữa</strong>: Mã sau chỉ là PC Kết thúc hiệu quả <code>searchContainer.appendChild(toggleButton)</code>。</p>
<hr /></details>
    <img src="https://raw.githubusercontent.com/ChinaGodMan/UserScriptsHistory/main/stats/502652.png">
</div></center>
...
# Google Trợ lý tìm kiếm nâng cao

Đây là một Google Tập lệnh người dùng để thêm các biểu mẫu tìm kiếm nâng cao。Nó có thể thêm một biểu mẫu tìm kiếm nâng cao ẩn ở đầu trang，Cho phép bạn tìm kiếm thông tin chính xác hơn。

<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">

## Chức năng

-   hiện hữu Google Thêm một ở đầu trang tìm kiếm “Tìm kiếm nâng cao” Cái nút，Nhấp vào nút để hiển thị biểu mẫu tìm kiếm nâng cao。
-   Biểu mẫu tìm kiếm nâng cao chứa các tùy chọn tìm kiếm sau：
    -   `Tất cả các từ sau`：Tất cả các từ khóa được chỉ định phải được đưa vào kết quả tìm kiếm。
    -   `Khớp chính xác với các từ sau`：Các kết quả tìm kiếm phải chứa các kết quả khớp chính xác với từ được chỉ định。
    -   `Bất kỳ từ nào sau đây`：Kết quả tìm kiếm phải chứa bất kỳ từ khóa nào được chỉ định。
    -   `Loại trừ các từ sau`：Kết quả tìm kiếm không chứa các từ khóa được chỉ định。
    -   `Phạm vi số bao gồm`：Kết quả tìm kiếm chứa các số trong phạm vi được chỉ định。
    -   `Thời gian cập nhật lần cuối`：Kết quả tìm kiếm chứa kết quả với thời gian cập nhật được chỉ định。
    -   `Trang web hoặc tên miền`：Kết quả tìm kiếm có chứa trang web hoặc tên miền được chỉ định。
    -   `Loại tệp`：Kết quả tìm kiếm chứa kết quả cho loại tệp được chỉ định。
-   Bạn có thể lưu các tùy chọn tìm kiếm trước đó，Điều này sẽ tự động điền vào biểu mẫu khi mở một trang mới。
-   Cung cấp nút rõ ràng，Có thể xóa dữ liệu trong biểu mẫu。

## tri ân

Tập lệnh được sửa đổi từ **[shiquda](https://greasyfork.org/users/935206)** Các kịch bản được xuất bản [Google Advanced Search Assistant](https://greasyfork.org/scripts/474178)
