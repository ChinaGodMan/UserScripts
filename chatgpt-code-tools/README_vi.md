...
<div align="right">
    <h6>
        ...
        <a href="https://github.com/ChinaGodMan/UserScripts/blob/main/chatgpt-code-tools/README.md">简体中文</a> |
        <a href="https://github.com/ChinaGodMan/UserScripts/blob/main/chatgpt-code-tools/README_en.md">English</a> |
        <a href="https://github.com/ChinaGodMan/UserScripts/blob/main/chatgpt-code-tools/README_ko.md">한국어</a> |
        <a href="https://github.com/ChinaGodMan/UserScripts/blob/main/chatgpt-code-tools/README_vi.md">Tiếng Việt</a> |
        <a href="https://github.com/ChinaGodMan/UserScripts/blob/main/chatgpt-code-tools/README_zh-TW.md">繁體中文</a>
    <br>
...
<!--HISTORY-->
<center><div align="center">
    <h1>Công cụ mã Chatgpt</h1>
    <p>「 Thêm chức năng vào các khối mã Chatgpt, bao gồm tùy chọn để lưu hoặc sao chép đoạn mã. 」</p>
    ...
    <img src="https://img.shields.io/greasyfork/dt/537646?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=S%E1%BB%91%20l%C6%B0%E1%BB%A3ng%20ng%C6%B0%E1%BB%9Di%20d%C3%B9ng">
    <img src="https://img.shields.io/badge/dynamic/json?&label=C%E1%BA%ADp%20nh%E1%BA%ADt%20ki%E1%BB%83m%20tra%20h%C3%A0ng%20ng%C3%A0y&query=$.537646&logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&url=https://github.com/ChinaGodMan/UserScriptsHistory/raw/main/daily_update_checks.json">
    <p>Download:<a href="https://github.com/ChinaGodMan/UserScripts/tree/main/chatgpt-code-tools">Github</a> | ⭐<a
            ...
            Fork</a></p>
    <img src="https://raw.githubusercontent.com/ChinaGodMan/UserScriptsHistory/main/stats/537646.png">
</div></center>

<!--HISTORY-END-->
<!--TEXT-->

# Các chức năng và triển khai kịch bản

Bổ sung khối mã“Lưu mã”Và“Sao chép mã”Cái nút，Để nhanh chóng lưu hoặc sao chép đoạn mã。

## Tổng quan về chức năng

### 1. **Phát hiện các khối mã**

- Tự động thêm các nút hành động cho mỗi khối mã（Tránh bổ sung lặp đi lặp lại）。

### 2. **Thêm nút hành động**

- **Lưu nút mã**：

    - Mã dựa trên khối ngôn ngữ（Suy luận phần mở rộng tệp theo tên lớp）。

    - Được đặt tự động theo tiện ích mở rộng MIME kiểu。

    - Tạo liên kết tải xuống và kích hoạt tải xuống。

- **Sao chép nút mã**：

    - Sao chép đoạn mã vào bảng tạm。

    - Cung cấp phản hồi trạng thái（giống“Sao chép thành công”hoặc“Sao chép không thành công”）。

### 3. **Thích ứng động**

- màn hình DOM Thay đổi，Tự động thêm các nút vào các khối mã mới được thêm。

### 4. **Kiểu nút và tương tác**

- Tùy chỉnh kiểu nút（Màu nền、khung、Hiệu ứng di chuột chuột）。

- Cơ chế phản hồi trạng thái：

    - Trạng thái bình thường：Nút màu xanh。

    - Tại nơi làm việc：Nút màu xanh lá cây hiển thị trạng thái（giống“Tiết kiệm...”hoặc“Sao chép”）。

    - Trạng thái lỗi：Nút màu đỏ hiển thị thông báo lỗi。
