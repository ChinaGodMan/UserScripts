...
<!--HISTORY-->
<center><div align="center">
    <h1>GitHub 隱藏 Copilot</h1>
    <p>「 在 GitHub 上隱藏愚蠢的 Copilot 」</p>
    ...
    <img src="https://img.shields.io/greasyfork/dt/536423?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=%E7%94%A8%E6%88%B6%E6%95%B8%E9%87%8F">
    <img src="https://img.shields.io/badge/dynamic/json?&label=%E6%AF%8F%E6%97%A5%E6%AA%A2%E6%9F%A5%E6%9B%B4%E6%96%B0%E6%AC%A1%E6%95%B8&query=$.536423&logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&url=https://github.com/ChinaGodMan/UserScriptsHistory/raw/main/daily_update_checks.json">
    <p>Download:<a href="https://github.com/ChinaGodMan/UserScripts/tree/main/github-no-copilot">Github</a> | ⭐<a
            ...
            Fork</a></p><details><summary style="color:#FFD700">更新記錄</summary><div align="right"><a href="https://github.com/ChinaGodMan/UserScripts/tree/main/github-no-copilot/CHANGELOG.md"><img src="https://img.shields.io/badge/-GitHub-3A3A3A?style=flat&logo=GitHub&logoColor=white"></a></div><h1><strong>🛠️ GitHub 隱藏 Copilot 更新日誌</strong></h1>
<h3><strong>📅 2025.5.21.1</strong></h3>
<p><strong>新增</strong>: 從該存儲庫複製了代碼,並添加屏蔽右側邊欄中的Copilot <a href="https://github.com/outslept/userscripts/blob/master/dont-wanna-see-copilot/userscript.js">outslept/userscripts</a> <br></p>
<hr /></details>
...
`GitHub No Copilot` 是一個簡單的用戶腳本，用於在 GitHub 上隱藏煩人的 Copilot 相關元素（如頂部圖標、側邊欄、文件右上角的按鈕等）。

這個腳本通過 CSS 和 DOM 操作移除不需要的 UI 元素，從而為用戶提供更加簡潔的 GitHub 使用體驗。

## 功能特性

- **隱藏 Copilot 頂部圖標**(`FUCK_HEAD_COPILOT`_可在腳本內部設置是否開啟_)
- **隱藏文件右上角的 Copilot 按鈕**(`FUCK_FILE_COPILOT`_可在腳本內部設置是否開啟_)
- **隱藏 Copilot 相關的側邊欄和對話框**
...
## 支持與反饋
- [報告問題或建議](https://github.com/ChinaGodMan/UserScripts/issues)
- [主頁](https://github.com/ChinaGodMan/UserScripts)
