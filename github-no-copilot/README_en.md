...
<center><div align="center">
    ...
    <img src="https://img.shields.io/greasyfork/dt/536423?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=Number%20of%20users">
...
`GitHub No Copilot` It’s a simple user script，Used in GitHub Hidden annoying Copilot Related elements（As top icon、Sidebar、Buttons in the upper right corner of the file, etc.）。

This script passes CSS and DOM Operation removes unwanted UI element，This provides users with a more concise GitHub User experience。

## Functional Features

- **hide Copilot Top Icon**(`FUCK_HEAD_COPILOT`_Can be set inside the script whether to enable it_)
- **Hide the file in the upper right corner Copilot Button**(`FUCK_FILE_COPILOT`_Can be set inside the script whether to enable it_)
- **hide Copilot Related sidebars and dialog boxes**
...
- [Report a question or suggestion](https://github.com/ChinaGodMan/UserScripts/issues)
