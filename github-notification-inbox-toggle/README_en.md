...
<!--HISTORY-->
<center><div align="center">
    <h1>GitHub Notification Filter Status</h1>
    <p>「 github-notification-inbox-toggle development version 」</p>
    ...
    <img src="https://img.shields.io/greasyfork/dt/537684?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=Number%20of%20users">
    <img src="https://img.shields.io/badge/dynamic/json?&label=Daily%20check%20updates&query=$.537684&logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&url=https://github.com/ChinaGodMan/UserScriptsHistory/raw/main/daily_update_checks.json">
...
GitHub Enhance the user experience of notification page，Provide buttons to quickly filter and manage notification content，Help users process notifications efficiently。


## Function

### 1. **show/Hide completed notifications**

- **Button name**：`Toggle Hidden Notifications`
- Toggle whether to hide completed notifications in the notification list（If closed Issue、Merged PR wait）。

### 2. **Show only completed notifications**

- **Button name**：`Show Only Done Notifications`
- Toggle whether to display only completed notifications in the notification list（If closed Issue、Merged PR wait）。
