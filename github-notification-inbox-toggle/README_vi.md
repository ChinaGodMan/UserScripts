...
<!--HISTORY-->
<center><div align="center">
    <h1>Trạng thái bộ lọc thông báo GitHub</h1>
    <p>「 Phiên bản phát triển github-notification-inbox-toggle 」</p>
    ...
    <img src="https://img.shields.io/greasyfork/dt/537684?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=S%E1%BB%91%20l%C6%B0%E1%BB%A3ng%20ng%C6%B0%E1%BB%9Di%20d%C3%B9ng">
    <img src="https://img.shields.io/badge/dynamic/json?&label=C%E1%BA%ADp%20nh%E1%BA%ADt%20ki%E1%BB%83m%20tra%20h%C3%A0ng%20ng%C3%A0y&query=$.537684&logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&url=https://github.com/ChinaGodMan/UserScriptsHistory/raw/main/daily_update_checks.json">
...
GitHub Nâng cao trải nghiệm người dùng của trang thông báo，Cung cấp các nút để nhanh chóng lọc và quản lý nội dung thông báo，Giúp người dùng xử lý thông báo một cách hiệu quả。


## Chức năng

### 1. **trình diễn/Ẩn thông báo hoàn thành**

- **Tên nút**：`Toggle Hidden Notifications`
- Chuyển đổi xem có ẩn thông báo hoàn thành trong danh sách thông báo（Nếu đóng Issue、Hợp nhất PR Chờ đợi）。

### 2. **Chỉ hiển thị thông báo đã hoàn thành**

- **Tên nút**：`Show Only Done Notifications`
- Chuyển đổi xem chỉ hiển thị thông báo hoàn thành trong danh sách thông báo（Nếu đóng Issue、Hợp nhất PR Chờ đợi）。
