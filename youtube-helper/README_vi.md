...
<center><div align="center">
    ...
    <p>Download:<a href="https://github.com/ChinaGodMan/UserScripts/tree/main/youtube-helper">Github</a> | ⭐<a
            ...
            Fork</a></p><details><summary>Cập nhật hồ sơ</summary><div align="right"><a href="https://github.com/ChinaGodMan/UserScripts/tree/main/youtube-helper/CHANGELOG.md"><img src="https://img.shields.io/badge/-GitHub-3A3A3A?style=flat&logo=GitHub&logoColor=white"></a></div><h1><strong>🛠️ youtube-helper Cập nhật nhật ký</strong></h1>
...
# 人民的勤务员 . Kịch bản tự sử dụng.

**YouTube Helper** ：

1.  🔁**Video vòng phát lại**：Ủng hộ YouTube Cài đặt video phát lại vòng lặp
2.  🖼️**Tải xuống ảnh chụp màn hình**：Chụp màn hình video hiện tại bằng một cú nhấp chuột và lưu dưới dạng hình ảnh。
