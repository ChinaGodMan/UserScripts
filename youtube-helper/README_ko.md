...
<center><div align="center">
    ...
    <p>「 YouTube 1. 비디오 루프 재생 2. 스크린 샷 다운로드 3. 테마 진행률 바 」</p>
    ...
    <p>Download:<a href="https://github.com/ChinaGodMan/UserScripts/tree/main/youtube-helper">Github</a> | ⭐<a
            ...
            Fork</a></p><details><summary>레코드 업데이트</summary><div align="right"><a href="https://github.com/ChinaGodMan/UserScripts/tree/main/youtube-helper/CHANGELOG.md"><img src="https://img.shields.io/badge/-GitHub-3A3A3A?style=flat&logo=GitHub&logoColor=white"></a></div><h1><strong>🛠️ youtube-helper 로그 업데이트</strong></h1>
...
1.  🔁**비디오 루프 재생**：지원하다 YouTube 비디오 설정 루프 재생
2.  🖼️**스크린 샷 다운로드**：한 번의 클릭으로 현재 비디오 화면을 스냅하고 사진으로 저장하십시오.。
