...
<center><div align="center">
    ...
    <p>Download:<a href="https://github.com/ChinaGodMan/UserScripts/tree/main/youtube-helper">Github</a> | ⭐<a
            ...
            Fork</a></p><details><summary>Update records</summary><div align="right"><a href="https://github.com/ChinaGodMan/UserScripts/tree/main/youtube-helper/CHANGELOG.md"><img src="https://img.shields.io/badge/-GitHub-3A3A3A?style=flat&logo=GitHub&logoColor=white"></a></div><h1><strong>🛠️ youtube-helper Update log</strong></h1>
...
# 人民的勤务员 . Self-used scripts.

**YouTube Helper** ：

1.  🔁**Video loop playback**：Support YouTube Video settings loop playback
2.  🖼️**Screenshot download**：Snaps the current video screen with one click and save it as a picture。
