...
<div align="right">
    <h6>
        ...
        <a href="https://github.com/ChinaGodMan/UserScripts/blob/main/youtube-better-volume-control/README.md">简体中文</a> |
        <a href="https://github.com/ChinaGodMan/UserScripts/blob/main/youtube-better-volume-control/README_en.md">English</a> |
        <a href="https://github.com/ChinaGodMan/UserScripts/blob/main/youtube-better-volume-control/README_ko.md">한국어</a> |
        <a href="https://github.com/ChinaGodMan/UserScripts/blob/main/youtube-better-volume-control/README_vi.md">Tiếng Việt</a> |
        <a href="https://github.com/ChinaGodMan/UserScripts/blob/main/youtube-better-volume-control/README_zh-TW.md">繁體中文</a>
    <br>
...
<!--HISTORY-->
<center><div align="center">
    <h1>Điều khiển âm lượng YouTube tốt hơn</h1>
    <p>「 Thêm thanh trượt vào trình phát video YouTube để làm cho thay đổi âm lượng tự nhiên hơn. 」</p>
    ...
    <img src="https://img.shields.io/greasyfork/dt/537787?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=S%E1%BB%91%20l%C6%B0%E1%BB%A3ng%20ng%C6%B0%E1%BB%9Di%20d%C3%B9ng">
    <img src="https://img.shields.io/badge/dynamic/json?&label=C%E1%BA%ADp%20nh%E1%BA%ADt%20ki%E1%BB%83m%20tra%20h%C3%A0ng%20ng%C3%A0y&query=$.537787&logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&url=https://github.com/ChinaGodMan/UserScriptsHistory/raw/main/daily_update_checks.json">
    <p>Download:<a href="https://github.com/ChinaGodMan/UserScripts/tree/main/youtube-better-volume-control">Github</a> | ⭐<a
            ...
            Fork</a></p>
    <img src="https://raw.githubusercontent.com/ChinaGodMan/UserScriptsHistory/main/stats/537787.png">
</div></center>

<!--HISTORY-END-->
<!--TEXT-->

# Tùy chỉnh YouTube Tập lệnh thanh trượt âm lượng người chơi

## Giới thiệu

YouTube Trang video và Shorts Trang cung cấp chức năng thanh trượt khối lượng tùy chỉnh，Cho phép người dùng điều chỉnh âm lượng thông qua giao diện trực quan hơn。Hỗ trợ hoạt động tắt phím bàn phím，Cải thiện hiệu quả kiểm soát khối lượng。

---

## Chức năng

### 1. **Slider âm lượng trang video**

- chống lại `/watch` Phát lại video của trang cung cấp các chức năng sau：
    - Thanh trượt khối lượng tùy chỉnh，Hỗ trợ điều chỉnh âm lượng tốt hơn。
    - Lưu điều chỉnh âm lượng vào `localStorage`，Giữ các cài đặt trước đó sau khi trang được làm mới。
    - Hỗ trợ thông qua bàn phím `ArrowUp` Và `ArrowDown` Điều chỉnh âm lượng（10% Sự gia tăng）。

### 2. **Shorts Thanh trượt khối lượng**

- chống lại `/shorts` Phát lại video của trang cung cấp các chức năng sau：
    - Thanh trượt khối lượng tùy chỉnh，Tương thích với vị trí bố cục và kiểu trang。
    - Lưu điều chỉnh âm lượng vào `localStorage`，Giữ các cài đặt trước đó sau khi trang được làm mới。
