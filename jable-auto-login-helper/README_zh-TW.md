...
<center><div align="center">
    ...
    <img src="https://img.shields.io/greasyfork/dt/506730?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=%E7%94%A8%E6%88%B6%E6%95%B8%E9%87%8F">
    <img src="https://img.shields.io/badge/dynamic/json?&label=%E6%AF%8F%E6%97%A5%E6%AA%A2%E6%9F%A5%E6%9B%B4%E6%96%B0%E6%AC%A1%E6%95%B8&query=$.506730&logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&url=https://github.com/ChinaGodMan/UserScriptsHistory/raw/main/daily_update_checks.json">
    <p>Download:<a href="https://github.com/ChinaGodMan/UserScripts/tree/main/jable-auto-login-helper">Github</a> | ⭐<a
            href="https://greasyfork.org/scripts/506730">Greasy
            Fork</a></p><details><summary style="color:#FFD700">更新記錄</summary><div align="right"><a href="https://github.com/ChinaGodMan/UserScripts/tree/main/jable-auto-login-helper/CHANGELOG.md"><img src="https://img.shields.io/badge/-GitHub-3A3A3A?style=flat&logo=GitHub&logoColor=white"></a></div><h1><strong>🛠️ JableTV自動登錄 更新日誌</strong></h1>
...
這是一個用於JableTV 管理用戶賬戶的腳本，主要功能自動登錄以及檢測用戶是否已登錄。

<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">

## 功能

-   **設置賬戶**: 通過彈出模態框允許用戶設置電子郵件和密碼。
-   **登錄功能**: 使用用戶提供的電子郵件和密碼進行登錄，並處理登錄錯誤。
-   **用戶檢測**: 檢測用戶是否已登錄，如果未登錄則嘗試自動登錄。
...
1. **安裝腳本**:
    ...
    - 將腳本複製到 Greasemonkey 或 Tampermonkey 插件中。
    - 確保腳本在你希望運行的網頁上啟用。

2. **設置賬戶**:

    - 點擊瀏覽器工具欄中的 Greasemonkey/Tampermonkey 圖示。
    - 選擇“Set Account”選項，輸入你的電子郵件和密碼，然後點擊“Save”。

3. **自動登錄**:
    - 腳本會自動檢測用戶是否已登錄。如果檢測到未登錄狀態，它將使用提供的賬戶信息嘗試登錄。
