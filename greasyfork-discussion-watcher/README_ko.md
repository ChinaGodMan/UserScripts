...
<center><div align="center">
    <h1>GreasyFork 알림 어시스턴트</h1>
    <p>「 스크립트 또는 토론에 새로운 답장이 있으면，스크립트는 웹 페이지의 모달 창에 최신 토론 내용을 표시합니다.。 」</p>
    ...
    <p>Download:<a href="https://github.com/ChinaGodMan/UserScripts/tree/main/greasyfork-discussion-watcher">Github</a> | ⭐<a
            ...
            Fork</a></p><details><summary>레코드 업데이트</summary><h1><strong>🛠️ Greasyfork 알림 어시스턴트 로그 업데이트</strong></h1>
...
<p><strong>새로운</strong>: 새로운 토론을 건너 뛰십시오,그리고에서마지막 스피커와 일치하십시오사용자 ID 실패시,마지막 스피커와 일치합니다.</p>
<hr />
...
하나 Tampermonkey 스크립트，사용 GreasyFork 강화 된 토론 목록 기능。스크립트 또는 토론에 새로운 답장이 있으면，스크립트는 웹 페이지의 모달 창에 최신 토론 내용을 표시합니다.。

<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">

## 기능

-   **맞춤형 스타일：** 깨끗하게 제공하십시오、사용자 친화적 인 모달 창，최신 토론 내용을 표시하는 데 사용됩니다，스타일을 사용자 정의 할 수 있습니다。
-   **자동 업데이트：** 스크립트는 정기적으로 토론 업데이트를 확인합니다，새로운 답장이있을 때 상기시켜줍니다。
-   **정보 추출：** 웹 페이지에서 토론 제목을 추출합니다、타임 스탬프 및 사용자 이름，모달 창으로 정리하십시오。

<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">

## 사용자 정의 점검 시간

스크립트 사용 `delay` 업데이트를 확인하기위한 간격 시간을 설정하기위한 구성 항목。시간 형식은 다음 조합입니다：
...
필요에 따라 수정할 수 있습니다 `delay` 구성 항목의 값，토론의 빈도를 조정합니다。예를 들어，당신이 모든 것을 원한다면15몇 분만 확인하십시오，할 수 있다 `delay` AS를 설정합니다 `15m`。
