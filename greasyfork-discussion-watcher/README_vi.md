...
<center><div align="center">
    <h1>GreasyFork Trợ lý thông báo</h1>
    <p>「 Khi có những câu trả lời mới về kịch bản hoặc cuộc thảo luận của bạn, bạn sẽ tham gia，Kịch bản sẽ hiển thị nội dung thảo luận mới nhất trong cửa sổ phương thức trên trang web。 」</p>
    ...
    <p>Download:<a href="https://github.com/ChinaGodMan/UserScripts/tree/main/greasyfork-discussion-watcher">Github</a> | ⭐<a
            ...
            Fork</a></p><details><summary>Cập nhật hồ sơ</summary><h1><strong>🛠️ Greasyfork Trợ lý thông báo Cập nhật nhật ký</strong></h1>
...
một Tampermonkey Kịch bản，Được sử dụng trong GreasyFork Chức năng danh sách thảo luận nâng cao。Khi có những câu trả lời mới về kịch bản hoặc cuộc thảo luận của bạn, bạn sẽ tham gia，Kịch bản sẽ hiển thị nội dung thảo luận mới nhất trong cửa sổ phương thức trên trang web。

<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">

## Chức năng

-   **Kiểu tùy chỉnh：** Cung cấp sạch sẽ、Cửa sổ phương thức thân thiện với người dùng，Được sử dụng để hiển thị nội dung thảo luận mới nhất，Kiểu có thể được tùy chỉnh。
-   **Cập nhật tự động：** Kịch bản sẽ kiểm tra các bản cập nhật thảo luận thường xuyên，Và nhắc nhở bạn khi có những câu trả lời mới。
-   **Khai thác thông tin：** Trích xuất các tiêu đề thảo luận từ trang web、Dấu thời gian và tên người dùng，Và sắp xếp nó vào cửa sổ phương thức。

<img height=6px width="100%" src="https://media.chatgptautorefresh.com/images/separators/gradient-aqua.png?latest">

## Thời gian kiểm tra tùy chỉnh

Sử dụng kịch bản `delay` Các mục cấu hình để đặt thời gian khoảng thời gian để kiểm tra các bản cập nhật。Định dạng thời gian là các kết hợp sau：
...
Bạn có thể sửa đổi nó khi cần thiết `delay` Giá trị của mục cấu hình，Để điều chỉnh tần suất cập nhật thảo luận。Ví dụ，Nếu bạn muốn mọi15Kiểm tra một lần trong phút，Có thể `delay` Đặt như `15m`。
