...
<div align="right">
    <h6>
        ...
        <a href="https://github.com/ChinaGodMan/UserScripts/blob/main/twitter(X)-plus/README.md">简体中文</a> |
        <a href="https://github.com/ChinaGodMan/UserScripts/blob/main/twitter(X)-plus/README_en.md">English</a> |
        <a href="https://github.com/ChinaGodMan/UserScripts/blob/main/twitter(X)-plus/README_ko.md">한국어</a> |
        <a href="https://github.com/ChinaGodMan/UserScripts/blob/main/twitter(X)-plus/README_vi.md">Tiếng Việt</a> |
        <a href="https://github.com/ChinaGodMan/UserScripts/blob/main/twitter(X)-plus/README_zh-TW.md">繁體中文</a>
    <br>
    <em><sub>👆️truy cập GitHub Tập tin Readme trên ứng dụng để có trải nghiệm tốt hơn。</sub></em>
    </h6>
</div>
...
<!--HISTORY-->
<center><div align="center">
    <h1>Twitter(X)-Plus</h1>
    <p>「 Bật tiếng video, hủy phát lại vòng lặp tự động của video, xóa tweet và chuyển tiếp tin nhắn, nút Grok/xem, thêm tính năng chặn bằng một cú nhấp chuột, nút sao chép URL tweet bằng một cú nhấp chuột 」</p>
    <img src="https://views.whatilearened.today/views/github/569860/hmjz100.svg" alt="Views">
    <img src="https://img.shields.io/github/size/ChinaGodMan/UserScripts/twitter(X)-plus/twitter(X)-plus.user.js?color=%23990000">
    <img src="https://img.shields.io/greasyfork/dt/569860?logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&label=s%E1%BB%91%20l%C6%B0%E1%BB%A3ng%20ng%C6%B0%E1%BB%9Di%20d%C3%B9ng">
    <img src="https://img.shields.io/badge/dynamic/json?&label=Ki%E1%BB%83m%20tra%20c%E1%BA%ADp%20nh%E1%BA%ADt%20h%C3%A0ng%20ng%C3%A0y&query=$.569860&logo=greasyfork&logoColor=white&labelColor=%23670000&color=blue&url=https://github.com/ChinaGodMan/UserScriptsHistory/raw/main/daily_update_checks.json">
    <p>Download:<a href="https://github.com/ChinaGodMan/UserScripts/tree/main/twitter(X)-plus">Github</a> | ⭐<a
            ...
            Fork</a></p><details><summary style="color:#FFD700">Cập nhật bản ghi</summary><div align="right"><a href="https://github.com/ChinaGodMan/UserScripts/tree/main/twitter(X)-plus/CHANGELOG.md"><img src="https://img.shields.io/badge/-GitHub-3A3A3A?style=flat&logo=GitHub&logoColor=white"></a></div><h1><strong>🛠️ twitter(X)-plus Nhật ký thay đổi</strong></h1>
<h3><strong>📅 2026.3.20.1</strong></h3>
<p><strong>Mới</strong>: Dọn dẹp nhiều nút hơn và hiển thị ảnh ở kích thước đầy đủ<br></p>
<hr />
<h3><strong>📅 2026.3.16.1</strong></h3>
<p><strong>Mới</strong>: •phiên bản đầu tiên</p>
<hr /></details>
    <img src="https://raw.githubusercontent.com/ChinaGodMan/UserScriptsHistory/main/stats/569860.png">
</div></center>
...
Cung cấp một số cải tiến hữu ích：

- Ẩn một số nút
- Chặn người dùng bằng một cú nhấp chuột
- Sao chép liên kết tweet bằng một cú nhấp chuột
- Tự động dừng vòng lặp video
- Tự động bật tiếng video

**Tiện ích thuận tiện cho bạn sử dụng，Tất cả các mã đều được sao chép**
<!--AUTHORS-->
